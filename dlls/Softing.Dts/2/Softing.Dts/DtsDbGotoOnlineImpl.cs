...
internal class DtsDbGotoOnlineImpl : MappedObject, DtsDbGotoOnline, DtsDbControlPrimitive, MCDDbControlPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public DtsDbGotoOnlineImpl(IntPtr handle)
	{
		Handle = handle;
