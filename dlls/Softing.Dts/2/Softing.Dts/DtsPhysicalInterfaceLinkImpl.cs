...
internal class DtsPhysicalInterfaceLinkImpl : MappedObject, DtsPhysicalInterfaceLink, DtsObject, MCDObject, IDisposable
{
	...
	public MCDInterface Interface
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsPhysicalInterfaceLink_getInterface(Handle, out returnValue);
