...
internal class DtsDbPhysicalSegmentImpl : MappedObject, DtsDbPhysicalSegment, MCDDbPhysicalSegment, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public uint BlockSize
	{
		get
		{
			GC.KeepAlive(this);
			uint returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbPhysicalSegment_getBlockSize(Handle, out returnValue);
	...
	public uint EndAddress
	{
		get
		{
			GC.KeepAlive(this);
			uint returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbPhysicalSegment_getEndAddress(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public byte[] FillByte
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbPhysicalSegment_getFillByte(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public uint StartAddress
	{
		get
		{
			GC.KeepAlive(this);
			uint returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbPhysicalSegment_getStartAddress(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public DtsDbPhysicalSegmentImpl(IntPtr handle)
	{
		Handle = handle;
