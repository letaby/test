...
internal class DtsDbFlashSessionClassImpl : MappedObject, DtsDbFlashSessionClass, MCDDbFlashSessionClass, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbFlashSessions DbFlashSessions
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashSessionClass_getDbFlashSessions(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbFlashSessions;
		}
	}
	...
	public DtsDbFlashSessionClassImpl(IntPtr handle)
	{
		Handle = handle;
