...
internal class DtsDbDynIdClearComPrimitiveImpl : MappedObject, DtsDbDynIdClearComPrimitive, MCDDbDynIdClearComPrimitive, MCDDbDiagService, MCDDbDataPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbDiagService, DtsDbDataPrimitive, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public string[] DefinitionModes
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbDynIdClearComPrimitive_getDefinitionModes(Handle, out returnValue);
	...
	~DtsDbDynIdClearComPrimitiveImpl()
	{
