...
internal class DtsDbEcuStateChartImpl : MappedObject, DtsDbEcuStateChart, MCDDbEcuStateChart, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbEcuStates DbEcuStates
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbEcuStates(Handle, out returnValue);
	...
	public MCDDbEcuStateTransitions DbEcuStateTransitions
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbEcuStateTransitions(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbDiagComPrimitives DbPreConditionStateDiagComPrimitives
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbPreConditionStateDiagComPrimitives(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbEcuState DbStartState
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbStartState(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbDiagComPrimitives DbStateTransitionDiagComPrimitives
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbStateTransitionDiagComPrimitives(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public string Semantic
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateChart_getSemantic(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
