...
internal class DtsGotoOnlineImpl : MappedObject, DtsGotoOnline, DtsControlPrimitive, MCDControlPrimitive, MCDDiagComPrimitive, MCDObject, IDisposable, DtsDiagComPrimitive, DtsObject
{
	...
	public DtsGotoOnlineImpl(IntPtr handle)
	{
		Handle = handle;
