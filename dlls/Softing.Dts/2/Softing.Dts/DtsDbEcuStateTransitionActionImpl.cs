...
internal class DtsDbEcuStateTransitionActionImpl : MappedObject, DtsDbEcuStateTransitionAction, MCDDbEcuStateTransitionAction, MCDObject, IDisposable, DtsObject
{
	...
	public MCDDbDiagComPrimitive DbDiagComPrimitive
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateTransitionAction_getDbDiagComPrimitive(Handle, out returnValue);
	...
	public MCDDbRequestParameter DbRequestParameter
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateTransitionAction_getDbRequestParameter(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDValue Value
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuStateTransitionAction_getValue(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	~DtsDbEcuStateTransitionActionImpl()
	{
