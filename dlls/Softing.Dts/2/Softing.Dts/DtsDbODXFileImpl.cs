...
internal class DtsDbODXFileImpl : MappedObject, DtsDbODXFile, DtsDbObject, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsNamedObject, DtsObject
{
	...
	public string FileName
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbODXFile_getFileName(Handle, out returnValue);
	...
	public string FileVersion
	{
		get
		{
			GC.KeepAlive(this);
			String_Struct returnValue = default(String_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbODXFile_getFileVersion(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDVersion ODXVersion
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbODXFile_getODXVersion(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
