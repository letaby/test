...
internal class DtsErrorImpl : MappedObject, DtsError, MCDError, MCDObject, IDisposable, DtsObject
{
	...
	public MCDSeverity Severity
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsError_getSeverity(Handle, out returnValue);
	...
	public MCDErrorCodes Code
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsError_getCode(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public ushort VendorCode
	{
		get
		{
			GC.KeepAlive(this);
			ushort returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsError_getVendorCode(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public string VendorCodeDescription
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsError_getVendorCodeDescription(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public string CodeDescription
	{
		get
		{
			GC.KeepAlive(this);
			String_Struct returnValue = default(String_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsError_getCodeDescription(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDObject Parent
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsError_getParent(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
