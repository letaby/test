...
internal class DtsDbSubComponentParamConnectorImpl : MappedObject, DtsDbSubComponentParamConnector, MCDDbSubComponentParamConnector, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbDiagComPrimitive DbDiagComPrimitive
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbSubComponentParamConnector_getDbDiagComPrimitive(Handle, out returnValue);
	...
	public MCDDbRequestParameters DbSubComponentInParams
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbSubComponentParamConnector_getDbSubComponentInParams(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbRequestParameters;
		}
	}

	public MCDDbResponseParameters DbSubComponentOutParams
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbSubComponentParamConnector_getDbSubComponentOutParams(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbResponseParameters;
		}
	}
	...
	public DtsDbSubComponentParamConnectorImpl(IntPtr handle)
	{
		Handle = handle;
	...
	~DtsDbSubComponentParamConnectorImpl()
	{
