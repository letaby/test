...
internal class DtsDbGotoOfflineImpl : MappedObject, DtsDbGotoOffline, DtsDbControlPrimitive, MCDDbControlPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public DtsDbGotoOfflineImpl(IntPtr handle)
	{
		Handle = handle;
