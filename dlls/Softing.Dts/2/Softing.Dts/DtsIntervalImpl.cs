...
internal class DtsIntervalImpl : MappedObject, DtsInterval, MCDInterval, MCDObject, IDisposable, DtsObject
{
	...
	public MCDValue LowerLimit
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsInterval_getLowerLimit(Handle, out returnValue);
	...
	public MCDLimitType LowerLimitIntervalType
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsInterval_getLowerLimitIntervalType(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDValue UpperLimit
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsInterval_getUpperLimit(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDLimitType UpperLimitIntervalType
	{
		get
		{
			GC.KeepAlive(this);
			MCDLimitType returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsInterval_getUpperLimitIntervalType(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
