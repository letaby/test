...
internal class DtsDbEcuBaseVariantImpl : MappedObject, DtsDbEcuBaseVariant, MCDDbEcuBaseVariant, MCDDbEcu, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbEcu, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbEcuVariants DbEcuVariants
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuBaseVariant_getDbEcuVariants(Handle, out returnValue);
	...
	public MCDDbMatchingPatterns DbBaseVariantPatterns
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuBaseVariant_getDbBaseVariantPatterns(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbLocations DbLocations
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcu_getDbLocations(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public DtsDbEcuBaseVariantImpl(IntPtr handle)
	{
		Handle = handle;
