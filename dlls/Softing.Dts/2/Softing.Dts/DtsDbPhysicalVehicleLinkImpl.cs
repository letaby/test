...
internal class DtsDbPhysicalVehicleLinkImpl : MappedObject, DtsDbPhysicalVehicleLink, MCDDbPhysicalVehicleLink, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbVehicleConnectorPins DbVehicleConnectorPins
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbPhysicalVehicleLink_getDbVehicleConnectorPins(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbVehicleConnectorPins;
		}
	}
	...
	public string Type
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbPhysicalVehicleLink_getType(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
