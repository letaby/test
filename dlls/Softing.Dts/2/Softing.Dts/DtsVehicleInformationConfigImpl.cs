...
internal class DtsVehicleInformationConfigImpl : MappedObject, DtsVehicleInformationConfig, DtsNamedObjectConfig, DtsObject, MCDObject, IDisposable
{
	...
	public DtsLinkMappings LinkMappings
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsVehicleInformationConfig_getLinkMappings(Handle, out returnValue);
	...
	public DtsLogicalLinkConfigs LogicalLinkConfigs
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsVehicleInformationConfig_getLogicalLinkConfigs(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	~DtsVehicleInformationConfigImpl()
	{
