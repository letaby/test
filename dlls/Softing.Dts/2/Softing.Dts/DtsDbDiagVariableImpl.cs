...
internal class DtsDbDiagVariableImpl : MappedObject, DtsDbDiagVariable, DtsDbObject, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsNamedObject, DtsObject
{
	...
	public MCDDiagVarType ValueType
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbDiagVariable_getValueType(Handle, out returnValue);
	...
	public bool IsReadBeforeWrite
	{
		get
		{
			GC.KeepAlive(this);
			bool returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbDiagVariable_isReadBeforeWrite(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public string[] DbRelationTypes
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbDiagVariable_getDbRelationTypes(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
