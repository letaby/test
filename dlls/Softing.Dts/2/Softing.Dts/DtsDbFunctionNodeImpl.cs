...
internal class DtsDbFunctionNodeImpl : MappedObject, DtsDbFunctionNode, MCDDbFunctionNode, MCDDbBaseFunctionNode, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbBaseFunctionNode, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbFunctionNodes DbFunctionNodes
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionNode_getDbFunctionNodes(Handle, out returnValue);
	...
	public MCDDbSpecialDataGroups DbSDGs
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionNode_getDbSDGs(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbAdditionalAudiences DbEnabledAdditionalAudiences
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionNode_getDbEnabledAdditionalAudiences(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbAdditionalAudiences DbDisabledAdditionalAudiences
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionNode_getDbDisabledAdditionalAudiences(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
