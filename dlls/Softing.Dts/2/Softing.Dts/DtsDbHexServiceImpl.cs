...
internal class DtsDbHexServiceImpl : MappedObject, DtsDbHexService, MCDDbHexService, MCDDbDiagService, MCDDbDataPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbDiagService, DtsDbDataPrimitive, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public DtsDbHexServiceImpl(IntPtr handle)
	{
		Handle = handle;
