...
internal class DtsDbFunctionOutParameterImpl : MappedObject, DtsDbFunctionOutParameter, MCDDbFunctionOutParameter, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDataType DataType
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionOutParameter_getDataType(Handle, out returnValue);
	...
	public MCDDbFunctionDiagComConnector DbFunctionDiagComConnector
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionOutParameter_getDbFunctionDiagComConnector(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbResponseParameter DbResponseParameter
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionOutParameter_getDbResponseParameter(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbUnit DbUnit
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionOutParameter_getDbUnit(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
