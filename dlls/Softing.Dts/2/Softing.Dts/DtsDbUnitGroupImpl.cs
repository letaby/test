...
internal class DtsDbUnitGroupImpl : MappedObject, DtsDbUnitGroup, MCDDbUnitGroup, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDUnitGroupCategory Category
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbUnitGroup_getCategory(Handle, out returnValue);
	...
	public MCDDbUnits Units
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbUnitGroup_getUnits(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbUnits;
		}
	}
