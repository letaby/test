...
internal class DtsDbFunctionDiagComConnectorImpl : MappedObject, DtsDbFunctionDiagComConnector, MCDDbFunctionDiagComConnector, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbDiagComPrimitive DbDiagComPrimitive
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionDiagComConnector_getDbDiagComPrimitive(Handle, out returnValue);
	...
	public MCDDbLogicalLink DbLogicalLink
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionDiagComConnector_getDbLogicalLink(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	~DtsDbFunctionDiagComConnectorImpl()
	{
