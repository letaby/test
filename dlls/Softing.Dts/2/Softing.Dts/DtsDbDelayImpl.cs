...
internal class DtsDbDelayImpl : MappedObject, DtsDbDelay, DtsDbControlPrimitive, MCDDbControlPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public DtsDbDelayImpl(IntPtr handle)
	{
		Handle = handle;
