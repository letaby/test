...
internal class DtsDbFunctionDictionaryImpl : MappedObject, DtsDbFunctionDictionary, MCDDbFunctionDictionary, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbFunctionNodeGroups DbFunctionNodeGroups
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionDictionary_getDbFunctionNodeGroups(Handle, out returnValue);
	...
	public MCDDbFunctionNodes DbFunctionNodes
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionDictionary_getDbFunctionNodes(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbAdditionalAudiences DbAdditionalAudiences
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionDictionary_getDbAdditionalAudiences(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbSpecialDataGroups DbSDGs
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionDictionary_getDbSDGs(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
