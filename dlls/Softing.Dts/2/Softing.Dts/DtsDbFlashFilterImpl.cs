...
internal class DtsDbFlashFilterImpl : MappedObject, DtsDbFlashFilter, MCDDbFlashFilter, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public uint FilterStart
	{
		get
		{
			GC.KeepAlive(this);
			uint returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashFilter_getFilterStart(Handle, out returnValue);
	...
	public uint FilterEnd
	{
		get
		{
			GC.KeepAlive(this);
			uint returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashFilter_getFilterEnd(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public uint FilterSize
	{
		get
		{
			GC.KeepAlive(this);
			uint returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashFilter_getFilterSize(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public ulong FilterEnd64
	{
		get
		{
			GC.KeepAlive(this);
			ulong returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashFilter_getFilterEnd64(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public ulong FilterSize64
	{
		get
		{
			GC.KeepAlive(this);
			ulong returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashFilter_getFilterSize64(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public ulong FilterStart64
	{
		get
		{
			GC.KeepAlive(this);
			ulong returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashFilter_getFilterStart64(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
