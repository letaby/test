...
internal class DtsDbStopCommunicationImpl : MappedObject, DtsDbStopCommunication, MCDDbStopCommunication, MCDDbControlPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbControlPrimitive, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public DtsDbStopCommunicationImpl(IntPtr handle)
	{
		Handle = handle;
