...
internal class DtsLogicalLinkEventImpl : MappedObject, DtsLogicalLinkEvent, DtsEvent, DtsObject, MCDObject, IDisposable
{
	...
	public DtsLogicalLinkEventImpl(IntPtr handle)
	{
		Handle = handle;
