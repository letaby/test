...
internal class DtsMultipleEcuJobImpl : MappedObject, DtsMultipleEcuJob, MCDMultipleEcuJob, MCDJob, MCDDataPrimitive, MCDDiagComPrimitive, MCDObject, IDisposable, DtsJob, DtsDataPrimitive, DtsDiagComPrimitive, DtsObject
{
	...
	public DtsMultipleEcuJobImpl(IntPtr handle)
	{
		Handle = handle;
