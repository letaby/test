...
internal class DtsMonitoringLinkImpl : MappedObject, DtsMonitoringLink, MCDMonitoringLink, MCDNamedObject, MCDObject, IDisposable, DtsNamedObject, DtsObject
{
	...
	public DtsMonitoringLinkImpl(IntPtr handle)
	{
		Handle = handle;
