...
internal class DtsDbProtocolParameterSetImpl : MappedObject, DtsDbProtocolParameterSet, MCDDbProtocolParameterSet, MCDDbControlPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbControlPrimitive, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public DtsDbProtocolParameterSetImpl(IntPtr handle)
	{
		Handle = handle;
