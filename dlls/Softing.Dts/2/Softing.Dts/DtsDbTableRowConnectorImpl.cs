...
internal class DtsDbTableRowConnectorImpl : MappedObject, DtsDbTableRowConnector, MCDDbTableRowConnector, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbTable DbTable
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbTableRowConnector_getDbTable(Handle, out returnValue);
	...
	public MCDDbTableParameter DbTableRow
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbTableRowConnector_getDbTableRow(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public DtsDbTableRowConnectorImpl(IntPtr handle)
	{
		Handle = handle;
