...
internal class DtsDbExternalAccessMethodImpl : MappedObject, DtsDbExternalAccessMethod, MCDDbExternalAccessMethod, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public string Method
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbExternalAccessMethod_getMethod(Handle, out returnValue);
	...
	public DtsDbExternalAccessMethodImpl(IntPtr handle)
	{
		Handle = handle;
