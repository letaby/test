...
internal class DtsDbCodingDataImpl : MappedObject, DtsDbCodingData, MCDDbCodingData, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public string FileName
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbCodingData_getFileName(Handle, out returnValue);
	...
	public bool IsLateBound
	{
		get
		{
			GC.KeepAlive(this);
			bool returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbCodingData_isLateBound(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public DtsDbCodingDataImpl(IntPtr handle)
	{
		Handle = handle;
