...
internal class DtsStartCommunicationImpl : MappedObject, DtsStartCommunication, MCDStartCommunication, MCDControlPrimitive, MCDDiagComPrimitive, MCDObject, IDisposable, DtsControlPrimitive, DtsDiagComPrimitive, DtsObject
{
	...
	public bool HasSuppressPositiveResponseCapability
	{
		get
		{
			GC.KeepAlive(this);
			bool returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsStartCommunication_hasSuppressPositiveResponseCapability(Handle, out returnValue);
	...
	public bool IsSuppressPositiveResponse
	{
		get
		{
			GC.KeepAlive(this);
			bool returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsStartCommunication_isSuppressPositiveResponse(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public bool SuppressPositiveResponse
	{
		...
		{
			GC.KeepAlive(this);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsStartCommunication_setSuppressPositiveResponse(Handle, value);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public DtsStartCommunicationImpl(IntPtr handle)
	{
		Handle = handle;
