...
internal class DtsDbDynIdReadComPrimitiveImpl : MappedObject, DtsDbDynIdReadComPrimitive, MCDDbDynIdReadComPrimitive, MCDDbDiagService, MCDDbDataPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbDiagService, DtsDbDataPrimitive, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public string[] DefinitionModes
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbDynIdReadComPrimitive_getDefinitionModes(Handle, out returnValue);
	...
	~DtsDbDynIdReadComPrimitiveImpl()
	{
