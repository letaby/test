...
internal class DtsDbDynIdDefineComPrimitiveImpl : MappedObject, DtsDbDynIdDefineComPrimitive, MCDDbDynIdDefineComPrimitive, MCDDbDiagService, MCDDbDataPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbDiagService, DtsDbDataPrimitive, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public string[] DefinitionModes
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbDynIdDefineComPrimitive_getDefinitionModes(Handle, out returnValue);
	...
	~DtsDbDynIdDefineComPrimitiveImpl()
	{
