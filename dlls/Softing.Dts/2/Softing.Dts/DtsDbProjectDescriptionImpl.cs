...
internal class DtsDbProjectDescriptionImpl : MappedObject, DtsDbProjectDescription, MCDDbProjectDescription, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public DtsDbProjectDescriptionImpl(IntPtr handle)
	{
		Handle = handle;
