...
internal class DtsDbRequestImpl : MappedObject, DtsDbRequest, MCDDbRequest, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDValue DefaultPDU
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbRequest_getDefaultPDU(Handle, out returnValue);
	...
	public ushort PDUMinLength
	{
		get
		{
			GC.KeepAlive(this);
			ushort returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbRequest_getPDUMinLength(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public ushort PDUMaxLength
	{
		get
		{
			GC.KeepAlive(this);
			ushort returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbRequest_getPDUMaxLength(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbRequestParameters DbRequestParameters
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbRequest_getDbRequestParameters(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbSpecialDataGroups DbSDGs
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbRequest_getDbSDGs(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
