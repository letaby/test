...
internal class DtsDbEnvDataConnectorImpl : MappedObject, DtsDbEnvDataConnector, MCDDbEnvDataConnector, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbResponseParameter DbEnvData
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEnvDataConnector_getDbEnvData(Handle, out returnValue);
	...
	public MCDDbEnvDataDesc DbEnvDataDesc
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEnvDataConnector_getDbEnvDataDesc(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
