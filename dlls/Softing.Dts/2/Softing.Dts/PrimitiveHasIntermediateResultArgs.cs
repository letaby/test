...
public class PrimitiveHasIntermediateResultArgs : EventArgs
{
	...
	public PrimitiveHasIntermediateResultArgs(MCDDiagComPrimitive primitive, MCDLogicalLink link, MCDResultState resultstate)
	{
