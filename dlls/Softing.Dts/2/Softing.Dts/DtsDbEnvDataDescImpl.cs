...
internal class DtsDbEnvDataDescImpl : MappedObject, DtsDbEnvDataDesc, MCDDbEnvDataDesc, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbResponseParameters CommonDbEnvDatas
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEnvDataDesc_getCommonDbEnvDatas(Handle, out returnValue);
	...
	public MCDDbResponseParameters GetCompleteDbEnvDatasByDiagTroubleCode(uint troublecode)
	{
		GC.KeepAlive(this);
		ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
		IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEnvDataDesc_getCompleteDbEnvDatasByDiagTroubleCode(Handle, troublecode, out returnValue);
		if (intPtr != IntPtr.Zero)
		{
			throw DTS_ObjectMapper.createException(intPtr);
		}
	...
	public MCDDbResponseParameters GetSpecificDbEnvDatasForDiagTroubleCode(uint troublecode)
	{
		GC.KeepAlive(this);
		ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
		IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEnvDataDesc_getSpecificDbEnvDatasForDiagTroubleCode(Handle, troublecode, out returnValue);
		if (intPtr != IntPtr.Zero)
		{
			throw DTS_ObjectMapper.createException(intPtr);
		}
