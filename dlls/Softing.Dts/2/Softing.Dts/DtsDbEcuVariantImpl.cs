...
internal class DtsDbEcuVariantImpl : MappedObject, DtsDbEcuVariant, MCDDbEcuVariant, MCDDbEcu, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbEcu, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbEcuBaseVariant DbEcuBaseVariant
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuVariant_getDbEcuBaseVariant(Handle, out returnValue);
	...
	public DtsDbEcuVariantImpl(IntPtr handle)
	{
		Handle = handle;
