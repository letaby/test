...
internal class DtsDbFunctionalGroupImpl : MappedObject, DtsDbFunctionalGroup, MCDDbFunctionalGroup, MCDDbEcu, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbEcu, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbEcuBaseVariants GroupMembers
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionalGroup_getGroupMembers(Handle, out returnValue);
	...
	public DtsDbFunctionalGroupImpl(IntPtr handle)
	{
		Handle = handle;
