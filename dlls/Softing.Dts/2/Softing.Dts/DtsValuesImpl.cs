...
internal class DtsValuesImpl : MappedObject, DtsValues, MCDValues, MCDCollection, MCDObject, IDisposable, IEnumerable, DtsCollection, DtsObject
{
	...
	{
		return new DtsValuesEnumerator(this);
	}
}
