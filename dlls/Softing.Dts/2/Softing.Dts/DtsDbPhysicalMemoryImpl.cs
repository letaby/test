...
internal class DtsDbPhysicalMemoryImpl : MappedObject, DtsDbPhysicalMemory, MCDDbPhysicalMemory, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbPhysicalSegments PhysicalSegments
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbPhysicalMemory_getPhysicalSegments(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbPhysicalSegments;
		}
	}
