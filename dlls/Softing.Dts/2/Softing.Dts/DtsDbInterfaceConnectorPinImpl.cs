...
internal class DtsDbInterfaceConnectorPinImpl : MappedObject, DtsDbInterfaceConnectorPin, MCDDbInterfaceConnectorPin, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public uint PinNumber
	{
		get
		{
			GC.KeepAlive(this);
			uint returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbInterfaceConnectorPin_getPinNumber(Handle, out returnValue);
	...
	public uint PinNumberOnVCI
	{
		get
		{
			GC.KeepAlive(this);
			uint returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbInterfaceConnectorPin_getPinNumberOnVCI(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDConnectorPinType PinType
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbInterfaceConnectorPin_getPinType(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	~DtsDbInterfaceConnectorPinImpl()
	{
