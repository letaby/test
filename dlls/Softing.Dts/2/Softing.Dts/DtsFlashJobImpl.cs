...
internal class DtsFlashJobImpl : MappedObject, DtsFlashJob, MCDFlashJob, MCDJob, MCDDataPrimitive, MCDDiagComPrimitive, MCDObject, IDisposable, DtsJob, DtsDataPrimitive, DtsDiagComPrimitive, DtsObject
{
	...
	public string SessionByFlashKey
	{
		...
		{
			GC.KeepAlive(this);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsFlashJob_setSessionByFlashKey(Handle, value);
	...
	public string SessionByName
	{
		...
		{
			GC.KeepAlive(this);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsFlashJob_setSessionByName(Handle, value);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDDbFlashSession Session
	{
		...
		{
			GC.KeepAlive(this);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsFlashJob_setSession(Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public byte Progress
	{
		get
		{
			GC.KeepAlive(this);
			byte returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsJob_getProgress(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public string JobInfo
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsJob_getJobInfo(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDResult CreateResult(MCDResultType resultType, MCDErrorCodes code, string codeDescription, ushort vendorCode, string vendorCodeDescription, MCDSeverity severity)
	{
		GC.KeepAlive(this);
		ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
		IntPtr intPtr = CSWrap.CSNIDTS_DtsJob_createResult(Handle, resultType, code, codeDescription, vendorCode, vendorCodeDescription, severity, out returnValue);
		if (intPtr != IntPtr.Zero)
		{
			throw DTS_ObjectMapper.createException(intPtr);
		}
	...
	{
		GC.KeepAlive(this);
		IntPtr intPtr = CSWrap.CSNIDTS_DtsJob_releaseResult(Handle, DTS_ObjectMapper.getHandle(result as MappedObject));
		if (intPtr != IntPtr.Zero)
		{
			throw DTS_ObjectMapper.createException(intPtr);
		}
	...
	public MCDResults CreateResultCollection()
	{
		GC.KeepAlive(this);
		ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
		IntPtr intPtr = CSWrap.CSNIDTS_DtsJob_createResultCollection(Handle, out returnValue);
		if (intPtr != IntPtr.Zero)
		{
			throw DTS_ObjectMapper.createException(intPtr);
		}
