...
internal class DtsDbFlashIdentImpl : MappedObject, DtsDbFlashIdent, MCDDbFlashIdent, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDValues IdentValues
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashIdent_getIdentValues(Handle, out returnValue);
	...
	public MCDDbIdentDescription ReadDbIdentDescription
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFlashIdent_getReadDbIdentDescription(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbIdentDescription;
		}
	}
