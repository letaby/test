...
internal class DtsDataIdItemImpl : MappedObject, DtsDataIdItem, MCDDataIdItem, MCDConfigurationItem, MCDNamedObject, MCDObject, IDisposable, DtsConfigurationItem, DtsNamedObject, DtsObject
{
	...
	public MCDDbConfigurationItem DbObject
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsConfigurationItem_getDbObject(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbConfigurationItem;
		}
	}
	...
	public MCDValue ItemValue
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsConfigurationItem_getItemValue(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public bool HasError
	{
		get
		{
			GC.KeepAlive(this);
			bool returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsConfigurationItem_hasError(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public MCDError Error
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsConfigurationItem_getError(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public DtsDataIdItemImpl(IntPtr handle)
	{
		Handle = handle;
