...
internal class DtsDbVariantIdentificationImpl : MappedObject, DtsDbVariantIdentification, MCDDbVariantIdentification, MCDDbControlPrimitive, MCDDbDiagComPrimitive, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbControlPrimitive, DtsDbDiagComPrimitive, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public DtsDbVariantIdentificationImpl(IntPtr handle)
	{
		Handle = handle;
	...
	~DtsDbVariantIdentificationImpl()
	{
