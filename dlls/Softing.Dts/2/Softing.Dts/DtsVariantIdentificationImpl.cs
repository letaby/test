...
internal class DtsVariantIdentificationImpl : MappedObject, DtsVariantIdentification, MCDVariantIdentification, MCDControlPrimitive, MCDDiagComPrimitive, MCDObject, IDisposable, DtsControlPrimitive, DtsDiagComPrimitive, DtsObject
{
	...
	public DtsVariantIdentificationImpl(IntPtr handle)
	{
		Handle = handle;
