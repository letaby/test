...
internal class DtsDynIdClearComPrimitiveImpl : MappedObject, DtsDynIdClearComPrimitive, MCDDynIdClearComPrimitive, MCDDiagService, MCDDataPrimitive, MCDDiagComPrimitive, MCDObject, IDisposable, DtsDiagService, DtsDataPrimitive, DtsDiagComPrimitive, DtsObject
{
	...
	public MCDValue DynId
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDynIdClearComPrimitive_getDynId(Handle, out returnValue);
		...
		{
			GC.KeepAlive(this);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDynIdClearComPrimitive_setDynId(Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public string DefinitionMode
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDynIdClearComPrimitive_getDefinitionMode(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
		...
		{
			GC.KeepAlive(this);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDynIdClearComPrimitive_setDefinitionMode(Handle, value);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
