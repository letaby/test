...
internal class DtsDbDiagTroubleCodeConnectorImpl : MappedObject, DtsDbDiagTroubleCodeConnector, MCDDbDiagTroubleCodeConnector, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbDiagTroubleCode DbDiagTroubleCode
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbDiagTroubleCodeConnector_getDbDiagTroubleCode(Handle, out returnValue);
	...
	public MCDDbFaultMemory DbFaultMemory
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbDiagTroubleCodeConnector_getDbFaultMemory(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	~DtsDbDiagTroubleCodeConnectorImpl()
	{
