...
internal class DtsGotoOfflineImpl : MappedObject, DtsGotoOffline, DtsControlPrimitive, MCDControlPrimitive, MCDDiagComPrimitive, MCDObject, IDisposable, DtsDiagComPrimitive, DtsObject
{
	...
	public DtsGotoOfflineImpl(IntPtr handle)
	{
		Handle = handle;
