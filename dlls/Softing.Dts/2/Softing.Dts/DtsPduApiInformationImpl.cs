...
internal class DtsPduApiInformationImpl : MappedObject, DtsPduApiInformation, DtsNamedObject, MCDNamedObject, MCDObject, IDisposable, DtsObject
{
	...
	public string PDUAPIVersion
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsPduApiInformation_getPDUAPIVersion(Handle, out returnValue);
	...
	public bool Enabled
	{
		get
		{
			GC.KeepAlive(this);
			bool returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsPduApiInformation_getEnabled(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
		...
		{
			GC.KeepAlive(this);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsPduApiInformation_setEnabled(Handle, value);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public string LibraryFile
	{
		get
		{
			GC.KeepAlive(this);
			String_Struct returnValue = default(String_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsPduApiInformation_getLibraryFile(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
