...
internal class DtsDbEcuStateImpl : MappedObject, DtsDbEcuState, MCDDbEcuState, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbEcuStateTransitions DbEcuStateTransitions
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuState_getDbEcuStateTransitions(Handle, out returnValue);
	...
	public MCDDbPreconditionDefinitions DbRestrictedDiagComPrimitives
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbEcuState_getDbRestrictedDiagComPrimitives(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbPreconditionDefinitions;
		}
	}
