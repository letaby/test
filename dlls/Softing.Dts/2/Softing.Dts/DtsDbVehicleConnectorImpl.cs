...
internal class DtsDbVehicleConnectorImpl : MappedObject, DtsDbVehicleConnector, MCDDbVehicleConnector, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbVehicleConnectorPins DbVehicleConnectorPins
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbVehicleConnector_getDbVehicleConnectorPins(Handle, out returnValue);
