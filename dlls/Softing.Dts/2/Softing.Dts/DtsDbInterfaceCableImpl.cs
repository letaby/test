...
internal class DtsDbInterfaceCableImpl : MappedObject, DtsDbInterfaceCable, MCDDbInterfaceCable, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbInterfaceConnectorPins DbInterfaceConnectorPins
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbInterfaceCable_getDbInterfaceConnectorPins(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
			return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbInterfaceConnectorPins;
		}
	}
	...
	public string InterfaceConnectorType
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbInterfaceCable_getInterfaceConnectorType(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
