...
internal class DtsDbVehicleConnectorPinImpl : MappedObject, DtsDbVehicleConnectorPin, MCDDbVehicleConnectorPin, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbVehicleConnector DbVehicleConnector
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbVehicleConnectorPin_getDbVehicleConnector(Handle, out returnValue);
	...
	public ushort PinNumber
	{
		get
		{
			GC.KeepAlive(this);
			ushort returnValue;
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbVehicleConnectorPin_getPinNumber(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
