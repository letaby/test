...
internal class DtsDbFunctionalClassImpl : MappedObject, DtsDbFunctionalClass, MCDDbFunctionalClass, MCDDbObject, MCDNamedObject, MCDObject, IDisposable, DtsDbObject, DtsNamedObject, DtsObject
{
	...
	public MCDDbLocation DbLocation
	{
		get
		{
			...
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionalClass_getDbLocation(Handle, out returnValue);
	...
	public MCDDbDataPrimitives DbDataPrimitives
	{
		get
		{
			GC.KeepAlive(this);
			ObjectInfo_Struct returnValue = default(ObjectInfo_Struct);
			IntPtr intPtr = CSWrap.CSNIDTS_DtsDbFunctionalClass_getDbDataPrimitives(Handle, out returnValue);
			if (intPtr != IntPtr.Zero)
			{
				throw DTS_ObjectMapper.createException(intPtr);
			}
	...
	public DtsDbFunctionalClassImpl(IntPtr handle)
	{
		Handle = handle;
