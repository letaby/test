...
// Type: Softing.Dts.DtsDbEcuStateTransitionActionImpl
...
internal class DtsDbEcuStateTransitionActionImpl : 
  MappedObject,
  DtsDbEcuStateTransitionAction,
  ...
  DtsObject
{
  ...
  public DtsDbEcuStateTransitionActionImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbEcuStateTransitionActionImpl() => this.Dispose(false);
  ...
  public MCDDbDiagComPrimitive DbDiagComPrimitive
  {
    get
    {
      ...
      IntPtr diagComPrimitive = CSWrap.CSNIDTS_DtsDbEcuStateTransitionAction_getDbDiagComPrimitive(this.Handle, out returnValue);
  ...
  public MCDDbRequestParameter DbRequestParameter
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr requestParameter = CSWrap.CSNIDTS_DtsDbEcuStateTransitionAction_getDbRequestParameter(this.Handle, out returnValue);
  ...
  public MCDValue Value
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDbEcuStateTransitionAction_getValue(this.Handle, out returnValue);
