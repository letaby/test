...
// Type: Softing.Dts.DtsHexServiceImpl
...
internal class DtsHexServiceImpl : 
  MappedObject,
  DtsHexService,
  MCDHexService,
  MCDDiagService,
  ...
  DtsObject
{
  ...
  ~DtsHexServiceImpl() => this.Dispose(false);
  ...
  public uint ServiceID
  {
    get
    {
      ...
      uint returnValue;
      IntPtr serviceId = CSWrap.CSNIDTS_DtsHexService_getServiceID(this.Handle, out returnValue);
      if (serviceId != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(serviceId);
      return returnValue;
    }
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsHexService_setServiceID(this.Handle, value);
