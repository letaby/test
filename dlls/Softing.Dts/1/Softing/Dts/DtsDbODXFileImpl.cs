...
// Type: Softing.Dts.DtsDbODXFileImpl
...
internal class DtsDbODXFileImpl : 
  MappedObject,
  DtsDbODXFile,
  DtsDbObject,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbODXFileImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbODXFileImpl() => this.Dispose(false);
  ...
  public string FileName
  {
    get
    {
      ...
      IntPtr fileName = CSWrap.CSNIDTS_DtsDbODXFile_getFileName(this.Handle, out returnValue);
  ...
  public string FileVersion
  {
    get
    {
      GC.KeepAlive((object) this);
      String_Struct returnValue = new String_Struct();
      IntPtr fileVersion = CSWrap.CSNIDTS_DtsDbODXFile_getFileVersion(this.Handle, out returnValue);
      if (fileVersion != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(fileVersion);
      return returnValue.makeString();
    }
  }

  public MCDVersion ODXVersion
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr odxVersion = CSWrap.CSNIDTS_DtsDbODXFile_getODXVersion(this.Handle, out returnValue);
      if (odxVersion != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(odxVersion);
