...
// Type: Softing.Dts.DtsDbProjectDescriptionImpl
...
internal class DtsDbProjectDescriptionImpl : 
  MappedObject,
  DtsDbProjectDescription,
  MCDDbProjectDescription,
  MCDDbObject,
  MCDNamedObject,
  MCDObject,
  IDisposable,
  ...
  DtsObject
{
  ...
  ~DtsDbProjectDescriptionImpl() => this.Dispose(false);
