...
// Type: Softing.Dts.DtsDbProtocolParameterImpl
...
internal class DtsDbProtocolParameterImpl : 
  MappedObject,
  DtsDbProtocolParameter,
  ...
  DtsObject
{
  ...
  ~DtsDbProtocolParameterImpl() => this.Dispose(false);
