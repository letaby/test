...
// Type: Softing.Dts.DtsDbFlashSecuritiesImpl
...
internal class DtsDbFlashSecuritiesImpl : 
  MappedObject,
  DtsDbFlashSecurities,
  ...
  DtsObject
{
  ...
  ~DtsDbFlashSecuritiesImpl() => this.Dispose(false);
  ...
  public MCDDbFlashSecurity GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbFlashSecurities_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDDbFlashSecurity) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbFlashSecurity);
  }
  ...
  public MCDDbFlashSecurity GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbFlashSecurities_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbFlashSecurity[] array = new MCDDbFlashSecurity[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbFlashSecuritiesImpl.DtsDbFlashSecuritiesEnumerator(this);
  }
