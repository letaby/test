...
// Type: Softing.Dts.DtsDbDiagComPrimitivesImpl
...
internal class DtsDbDiagComPrimitivesImpl : 
  MappedObject,
  DtsDbDiagComPrimitives,
  ...
  DtsObject
{
  ...
  ~DtsDbDiagComPrimitivesImpl() => this.Dispose(false);
  ...
  public MCDDbDiagComPrimitive GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbDiagComPrimitives_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbDiagComPrimitive GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbDiagComPrimitives_getItemByName(this.Handle, name, out returnValue);
  ...
  public MCDDbDiagComPrimitive GetItemByType(MCDObjectType type)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByType = CSWrap.CSNIDTS_DtsDbDiagComPrimitives_getItemByType(this.Handle, type, out returnValue);
  ...
  {
    MCDDbDiagComPrimitive[] array = new MCDDbDiagComPrimitive[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbDiagComPrimitivesImpl.DtsDbDiagComPrimitivesEnumerator(this);
  }
