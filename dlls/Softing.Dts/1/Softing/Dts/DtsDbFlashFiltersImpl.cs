...
// Type: Softing.Dts.DtsDbFlashFiltersImpl
...
internal class DtsDbFlashFiltersImpl : 
  MappedObject,
  DtsDbFlashFilters,
  MCDDbFlashFilters,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbFlashFiltersImpl() => this.Dispose(false);
  ...
  public MCDDbFlashFilter GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbFlashFilters_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDDbFlashFilter) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbFlashFilter);
  }
  ...
  public MCDDbFlashFilter GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbFlashFilters_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbFlashFilter[] array = new MCDDbFlashFilter[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbFlashFiltersImpl.DtsDbFlashFiltersEnumerator(this);
  }
