...
// Type: Softing.Dts.DtsIdentifierInfosImpl
...
internal class DtsIdentifierInfosImpl : 
  MappedObject,
  DtsIdentifierInfos,
  DtsCollection,
  MCDCollection,
  ...
  DtsObject
{
  ...
  ~DtsIdentifierInfosImpl() => this.Dispose(false);
  ...
  public DtsIdentifierInfo GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsIdentifierInfos_getItemByIndex(this.Handle, index, out returnValue);
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsIdentifierInfos_loadDatabase(this.Handle, fileName);
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsIdentifierInfos_unloadAll(this.Handle);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsIdentifierInfos_unloadDatabase(this.Handle, fileName);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  public DtsIdentifierInfo GetItemByIdentifier(uint identifier, bool extended, int extendedAddress)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByIdentifier = CSWrap.CSNIDTS_DtsIdentifierInfos_getItemByIdentifier(this.Handle, identifier, extended, extendedAddress, out returnValue);
    if (itemByIdentifier != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIdentifier);
    return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsIdentifierInfo;
  }
  ...
  {
    DtsIdentifierInfo[] array = new DtsIdentifierInfo[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsIdentifierInfosImpl.DtsIdentifierInfosEnumerator(this);
  }
