...
// Type: Softing.Dts.DtsDiagComPrimitivesImpl
...
internal class DtsDiagComPrimitivesImpl : 
  MappedObject,
  DtsDiagComPrimitives,
  ...
  DtsObject
{
  ...
  public DtsDiagComPrimitivesImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDiagComPrimitivesImpl() => this.Dispose(false);
  ...
  public MCDDiagComPrimitive GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDiagComPrimitives_getItemByIndex(this.Handle, index, out returnValue);
  ...
  {
    return (IEnumerator) new DtsDiagComPrimitivesImpl.DtsDiagComPrimitivesEnumerator(this);
  }

  private class DtsDiagComPrimitivesEnumerator : IEnumerator
  {
    private DtsDiagComPrimitivesImpl m_classList;
    private int m_index;

    public DtsDiagComPrimitivesEnumerator(DtsDiagComPrimitivesImpl classList)
    {
