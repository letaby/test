...
// Type: Softing.Dts.DtsInterfaceResourceImpl
...
internal class DtsInterfaceResourceImpl : 
  MappedObject,
  DtsInterfaceResource,
  ...
  DtsObject
{
  ...
  public DtsInterfaceResourceImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsInterfaceResourceImpl() => this.Dispose(false);
  ...
  public MCDDbPhysicalVehicleLinkOrInterface DbPhysicalInterfaceLink
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr physicalInterfaceLink = CSWrap.CSNIDTS_DtsInterfaceResource_getDbPhysicalInterfaceLink(this.Handle, out returnValue);
  ...
  public MCDInterface Interface
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsInterfaceResource_getInterface(this.Handle, out returnValue);
  ...
  public string ProtocolType
  {
    get
    {
      ...
      IntPtr protocolType = CSWrap.CSNIDTS_DtsInterfaceResource_getProtocolType(this.Handle, out returnValue);
  ...
  public bool IsAvailable
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsInterfaceResource_isAvailable(this.Handle, out returnValue);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
      return returnValue;
    }
  ...
  public bool IsInUse
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsInterfaceResource_isInUse(this.Handle, out returnValue);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
      return returnValue;
    }
