...
// Type: Softing.Dts.DtsDbResponseParametersImpl
...
internal class DtsDbResponseParametersImpl : 
  MappedObject,
  DtsDbResponseParameters,
  ...
  DtsObject
{
  ...
  ~DtsDbResponseParametersImpl() => this.Dispose(false);
  ...
  public MCDDbResponseParameter GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbResponseParameters_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbResponseParameter GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbResponseParameters_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbResponseParameter[] array = new MCDDbResponseParameter[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbResponseParametersImpl.DtsDbResponseParametersEnumerator(this);
  }
