...
// Type: Softing.Dts.DtsDbFlashIdentImpl
...
internal class DtsDbFlashIdentImpl : 
  MappedObject,
  DtsDbFlashIdent,
  MCDDbFlashIdent,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbFlashIdentImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFlashIdentImpl() => this.Dispose(false);
  ...
  public MCDValues IdentValues
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr identValues = CSWrap.CSNIDTS_DtsDbFlashIdent_getIdentValues(this.Handle, out returnValue);
      if (identValues != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(identValues);
      return (MCDValues) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValues);
    }
  }

  public MCDDbIdentDescription ReadDbIdentDescription
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr identDescription = CSWrap.CSNIDTS_DtsDbFlashIdent_getReadDbIdentDescription(this.Handle, out returnValue);
      if (identDescription != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(identDescription);
      return (MCDDbIdentDescription) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbIdentDescription);
    }
  }
