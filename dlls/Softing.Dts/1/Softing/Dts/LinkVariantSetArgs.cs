...
// Type: Softing.Dts.LinkVariantSetArgs
...
public class LinkVariantSetArgs : EventArgs
{
  private MCDLogicalLink m_link;
  private MCDLogicalLinkState m_linkstate;

  public LinkVariantSetArgs(MCDLogicalLink link, MCDLogicalLinkState linkstate)
  {
    this.m_link = link;
