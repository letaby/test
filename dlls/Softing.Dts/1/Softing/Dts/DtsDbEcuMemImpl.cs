...
// Type: Softing.Dts.DtsDbEcuMemImpl
...
internal class DtsDbEcuMemImpl : 
  MappedObject,
  DtsDbEcuMem,
  MCDDbEcuMem,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbEcuMemImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbEcuMemImpl() => this.Dispose(false);
  ...
  public MCDDbEcuBaseVariants BaseVariants
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr baseVariants = CSWrap.CSNIDTS_DtsDbEcuMem_getBaseVariants(this.Handle, out returnValue);
      if (baseVariants != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(baseVariants);
  ...
  public MCDDbFlashSessions FlashSessions
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr flashSessions = CSWrap.CSNIDTS_DtsDbEcuMem_getFlashSessions(this.Handle, out returnValue);
      if (flashSessions != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(flashSessions);
      return (MCDDbFlashSessions) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbFlashSessions);
    }
  }

  public MCDDbEcuVariants Variants
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr variants = CSWrap.CSNIDTS_DtsDbEcuMem_getVariants(this.Handle, out returnValue);
      if (variants != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(variants);
  ...
  public MCDDbAdditionalAudiences DbAdditionalAudiences
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr additionalAudiences = CSWrap.CSNIDTS_DtsDbEcuMem_getDbAdditionalAudiences(this.Handle, out returnValue);
  ...
  public MCDDbSpecialDataGroups DbSDGs
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbSdGs = CSWrap.CSNIDTS_DtsDbEcuMem_getDbSDGs(this.Handle, out returnValue);
