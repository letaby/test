...
// Type: Softing.Dts.DtsDbRequestParametersImpl
...
internal class DtsDbRequestParametersImpl : 
  MappedObject,
  DtsDbRequestParameters,
  ...
  DtsObject
{
  ...
  ~DtsDbRequestParametersImpl() => this.Dispose(false);
  ...
  public MCDDbRequestParameter GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbRequestParameters_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbRequestParameter GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbRequestParameters_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbRequestParameter[] array = new MCDDbRequestParameter[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbRequestParametersImpl.DtsDbRequestParametersEnumerator(this);
  }
