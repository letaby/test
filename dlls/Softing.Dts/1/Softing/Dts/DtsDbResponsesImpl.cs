...
// Type: Softing.Dts.DtsDbResponsesImpl
...
internal class DtsDbResponsesImpl : 
  MappedObject,
  DtsDbResponses,
  MCDDbResponses,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbResponsesImpl() => this.Dispose(false);
  ...
  public MCDDbResponse GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbResponses_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbResponse GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbResponses_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbResponse[] array = new MCDDbResponse[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbResponsesImpl.DtsDbResponsesEnumerator(this);
  }
