...
// Type: Softing.Dts.DtsDbResponseParameterImpl
...
internal class DtsDbResponseParameterImpl : 
  MappedObject,
  DtsDbResponseParameter,
  ...
  DtsObject
{
  ...
  public DtsDbResponseParameterImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbResponseParameterImpl() => this.Dispose(false);
  ...
  public MCDValues NrcConstValues
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr nrcConstValues = CSWrap.CSNIDTS_DtsDbResponseParameter_getNrcConstValues(this.Handle, out returnValue);
      if (nrcConstValues != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(nrcConstValues);
      return (MCDValues) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValues);
    }
  }

  public uint RequestBytePos
  {
    get
    {
      GC.KeepAlive((object) this);
      uint returnValue;
      IntPtr requestBytePos = CSWrap.CSNIDTS_DtsDbResponseParameter_getRequestBytePos(this.Handle, out returnValue);
      if (requestBytePos != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(requestBytePos);
      return returnValue;
    }
  }
