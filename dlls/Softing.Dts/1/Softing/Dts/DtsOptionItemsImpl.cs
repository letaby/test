...
// Type: Softing.Dts.DtsOptionItemsImpl
...
internal class DtsOptionItemsImpl : 
  MappedObject,
  DtsOptionItems,
  MCDOptionItems,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsOptionItemsImpl() => this.Dispose(false);
  ...
  public MCDOptionItem GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsOptionItems_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDOptionItem) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsOptionItem);
  }
  ...
  public MCDOptionItem GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsOptionItems_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDOptionItem[] array = new MCDOptionItem[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsOptionItemsImpl.DtsOptionItemsEnumerator(this);
  }
