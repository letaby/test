...
// Type: Softing.Dts.DtsDbMatchingPatternsImpl
...
internal class DtsDbMatchingPatternsImpl : 
  MappedObject,
  DtsDbMatchingPatterns,
  ...
  DtsObject
{
  ...
  public DtsDbMatchingPatternsImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbMatchingPatternsImpl() => this.Dispose(false);
  ...
  public MCDDbMatchingPattern GetItemByIndex(uint index)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbMatchingPatterns_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public List<MCDDbMatchingPattern> ToList()
  {
    List<MCDDbMatchingPattern> list = new List<MCDDbMatchingPattern>();
    for (uint index = 0; index < this.Count; ++index)
      list.Add(this.GetItemByIndex(index));
    return list;
  }

  public MCDDbMatchingPattern[] ToArray()
  {
    MCDDbMatchingPattern[] array = new MCDDbMatchingPattern[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbMatchingPatternsImpl.DtsDbMatchingPatternsEnumerator(this);
  }

  private class DtsDbMatchingPatternsEnumerator : IEnumerator
  {
    private DtsDbMatchingPatternsImpl m_classList;
    private int m_index;

    public DtsDbMatchingPatternsEnumerator(DtsDbMatchingPatternsImpl classList)
    {
