...
// Type: Softing.Dts.DtsScaleConstraintsImpl
...
internal class DtsScaleConstraintsImpl : 
  MappedObject,
  DtsScaleConstraints,
  MCDScaleConstraints,
  MCDCollection,
  ...
  DtsObject
{
  ...
  ~DtsScaleConstraintsImpl() => this.Dispose(false);
  ...
  public MCDScaleConstraint GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsScaleConstraints_getItemByIndex(this.Handle, index, out returnValue);
  ...
  {
    MCDScaleConstraint[] array = new MCDScaleConstraint[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsScaleConstraintsImpl.DtsScaleConstraintsEnumerator(this);
  }
