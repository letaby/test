...
// Type: Softing.Dts.DtsDbLogicalLinksImpl
...
internal class DtsDbLogicalLinksImpl : 
  MappedObject,
  DtsDbLogicalLinks,
  MCDDbLogicalLinks,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbLogicalLinksImpl() => this.Dispose(false);
  ...
  public MCDDbLogicalLink GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbLogicalLinks_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbLogicalLink GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbLogicalLinks_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbLogicalLink[] array = new MCDDbLogicalLink[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbLogicalLinksImpl.DtsDbLogicalLinksEnumerator(this);
  }
