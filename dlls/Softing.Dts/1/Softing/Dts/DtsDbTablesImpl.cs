...
// Type: Softing.Dts.DtsDbTablesImpl
...
internal class DtsDbTablesImpl : 
  MappedObject,
  DtsDbTables,
  MCDDbTables,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbTablesImpl() => this.Dispose(false);
  ...
  public MCDDbTable GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbTables_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbTable GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbTables_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbTable[] array = new MCDDbTable[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbTablesImpl.DtsDbTablesEnumerator(this);
  }
