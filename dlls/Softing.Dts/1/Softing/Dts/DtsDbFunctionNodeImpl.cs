...
// Type: Softing.Dts.DtsDbFunctionNodeImpl
...
internal class DtsDbFunctionNodeImpl : 
  MappedObject,
  DtsDbFunctionNode,
  MCDDbFunctionNode,
  ...
  DtsObject
{
  ...
  public DtsDbFunctionNodeImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFunctionNodeImpl() => this.Dispose(false);
  ...
  public MCDDbFunctionNodes DbFunctionNodes
  {
    get
    {
      ...
      IntPtr dbFunctionNodes = CSWrap.CSNIDTS_DtsDbFunctionNode_getDbFunctionNodes(this.Handle, out returnValue);
  ...
  public MCDDbSpecialDataGroups DbSDGs
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbSdGs = CSWrap.CSNIDTS_DtsDbFunctionNode_getDbSDGs(this.Handle, out returnValue);
  ...
  public MCDDbAdditionalAudiences DbEnabledAdditionalAudiences
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr additionalAudiences = CSWrap.CSNIDTS_DtsDbFunctionNode_getDbEnabledAdditionalAudiences(this.Handle, out returnValue);
  ...
  public MCDDbAdditionalAudiences DbDisabledAdditionalAudiences
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr additionalAudiences = CSWrap.CSNIDTS_DtsDbFunctionNode_getDbDisabledAdditionalAudiences(this.Handle, out returnValue);
      if (additionalAudiences != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(additionalAudiences);
      return (MCDDbAdditionalAudiences) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbAdditionalAudiences);
    }
