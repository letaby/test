...
// Type: Softing.Dts.DtsDbFaultMemoryImpl
...
internal class DtsDbFaultMemoryImpl : 
  MappedObject,
  DtsDbFaultMemory,
  MCDDbFaultMemory,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbFaultMemoryImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFaultMemoryImpl() => this.Dispose(false);
  ...
  public MCDDbDiagTroubleCode GetDbDiagTroubleCodeByTroubleCode(uint troublecode)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr codeByTroubleCode = CSWrap.CSNIDTS_DtsDbFaultMemory_getDbDiagTroubleCodeByTroubleCode(this.Handle, troublecode, out returnValue);
    if (codeByTroubleCode != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(codeByTroubleCode);
  ...
  public MCDDbDiagTroubleCodes GetDbDiagTroubleCodes(ushort levelLowerLimit, ushort levelUpperLimit)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr diagTroubleCodes = CSWrap.CSNIDTS_DtsDbFaultMemory_getDbDiagTroubleCodes(this.Handle, levelLowerLimit, levelUpperLimit, out returnValue);
    if (diagTroubleCodes != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(diagTroubleCodes);
