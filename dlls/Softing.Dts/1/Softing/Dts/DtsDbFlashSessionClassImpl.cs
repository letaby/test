...
// Type: Softing.Dts.DtsDbFlashSessionClassImpl
...
internal class DtsDbFlashSessionClassImpl : 
  MappedObject,
  DtsDbFlashSessionClass,
  MCDDbFlashSessionClass,
  MCDDbObject,
  MCDNamedObject,
  MCDObject,
  IDisposable,
  ...
  DtsObject
{
  ...
  ~DtsDbFlashSessionClassImpl() => this.Dispose(false);
  ...
  public MCDDbFlashSessions DbFlashSessions
  {
    get
    {
      ...
      IntPtr dbFlashSessions = CSWrap.CSNIDTS_DtsDbFlashSessionClass_getDbFlashSessions(this.Handle, out returnValue);
