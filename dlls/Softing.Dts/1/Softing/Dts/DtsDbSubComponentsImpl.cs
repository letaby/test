...
// Type: Softing.Dts.DtsDbSubComponentsImpl
...
internal class DtsDbSubComponentsImpl : 
  MappedObject,
  DtsDbSubComponents,
  MCDDbSubComponents,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbSubComponentsImpl() => this.Dispose(false);
  ...
  public MCDDbSubComponent GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbSubComponents_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDDbSubComponent) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbSubComponent);
  }
  ...
  public MCDDbSubComponent GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbSubComponents_getItemByName(this.Handle, name, out returnValue);
  ...
  public string[] Semantics
  {
    get
    {
      ...
      IntPtr semantics = CSWrap.CSNIDTS_DtsDbSubComponents_getSemantics(this.Handle, out returnValue);
  ...
  public MCDDbSubComponents GetItemsBySemanticAttribute(string semantic)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr semanticAttribute = CSWrap.CSNIDTS_DtsDbSubComponents_getItemsBySemanticAttribute(this.Handle, semantic, out returnValue);
  ...
  {
    MCDDbSubComponent[] array = new MCDDbSubComponent[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbSubComponentsImpl.DtsDbSubComponentsEnumerator(this);
  }
