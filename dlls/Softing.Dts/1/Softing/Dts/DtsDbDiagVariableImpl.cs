...
// Type: Softing.Dts.DtsDbDiagVariableImpl
...
internal class DtsDbDiagVariableImpl : 
  MappedObject,
  DtsDbDiagVariable,
  DtsDbObject,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbDiagVariableImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbDiagVariableImpl() => this.Dispose(false);
  ...
  public MCDDiagVarType ValueType
  {
    get
    {
      GC.KeepAlive((object) this);
      MCDDiagVarType returnValue;
      IntPtr valueType = CSWrap.CSNIDTS_DtsDbDiagVariable_getValueType(this.Handle, out returnValue);
      if (valueType != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(valueType);
      return returnValue;
    }
  }
  ...
  public bool IsReadBeforeWrite
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDbDiagVariable_isReadBeforeWrite(this.Handle, out returnValue);
  ...
  public string[] DbRelationTypes
  {
    get
    {
      GC.KeepAlive((object) this);
      StringArray_Struct returnValue = new StringArray_Struct();
      IntPtr dbRelationTypes = CSWrap.CSNIDTS_DtsDbDiagVariable_getDbRelationTypes(this.Handle, out returnValue);
      if (dbRelationTypes != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbRelationTypes);
