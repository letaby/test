...
// Type: Softing.Dts.DtsVariantIdentificationImpl
...
internal class DtsVariantIdentificationImpl : 
  MappedObject,
  DtsVariantIdentification,
  ...
  DtsObject
{
  ...
  ~DtsVariantIdentificationImpl() => this.Dispose(false);
