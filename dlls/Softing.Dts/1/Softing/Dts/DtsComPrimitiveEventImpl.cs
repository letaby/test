...
// Type: Softing.Dts.DtsComPrimitiveEventImpl
...
internal class DtsComPrimitiveEventImpl : 
  MappedObject,
  DtsComPrimitiveEvent,
  DtsEvent,
  DtsObject,
  MCDObject,
  IDisposable
{
  ...
  public DtsComPrimitiveEventImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsComPrimitiveEventImpl() => this.Dispose(false);
