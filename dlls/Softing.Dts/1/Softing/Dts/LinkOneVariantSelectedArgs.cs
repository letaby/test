...
// Type: Softing.Dts.LinkOneVariantSelectedArgs
...
public class LinkOneVariantSelectedArgs : EventArgs
{
  private MCDLogicalLink m_link;
  private MCDLogicalLinkState m_linkstate;

  public LinkOneVariantSelectedArgs(MCDLogicalLink link, MCDLogicalLinkState linkstate)
  {
    this.m_link = link;
