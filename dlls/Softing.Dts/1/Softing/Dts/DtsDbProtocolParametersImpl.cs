...
// Type: Softing.Dts.DtsDbProtocolParametersImpl
...
internal class DtsDbProtocolParametersImpl : 
  MappedObject,
  DtsDbProtocolParameters,
  DtsNamedCollection,
  MCDNamedCollection,
  MCDCollection,
  MCDObject,
  ...
  DtsObject
{
  ...
  public DtsDbProtocolParametersImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbProtocolParametersImpl() => this.Dispose(false);
  ...
  public DtsDbProtocolParameter GetItemByIndex(uint index)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbProtocolParameters_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbProtocolParameter;
  }

  public DtsDbProtocolParameter GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbProtocolParameters_getItemByName(this.Handle, name, out returnValue);
  ...
  public List<DtsDbProtocolParameter> ToList()
  {
    List<DtsDbProtocolParameter> list = new List<DtsDbProtocolParameter>();
    for (uint index = 0; index < this.Count; ++index)
      list.Add(this.GetItemByIndex(index));
    return list;
  }

  public DtsDbProtocolParameter[] ToArray()
  {
    DtsDbProtocolParameter[] array = new DtsDbProtocolParameter[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbProtocolParametersImpl.DtsDbProtocolParametersEnumerator(this);
  }

  private class DtsDbProtocolParametersEnumerator : IEnumerator
  {
    private DtsDbProtocolParametersImpl m_classList;
    private int m_index;

    public DtsDbProtocolParametersEnumerator(DtsDbProtocolParametersImpl classList)
    {
