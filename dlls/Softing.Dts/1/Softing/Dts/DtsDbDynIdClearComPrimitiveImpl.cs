...
// Type: Softing.Dts.DtsDbDynIdClearComPrimitiveImpl
...
internal class DtsDbDynIdClearComPrimitiveImpl : 
  MappedObject,
  DtsDbDynIdClearComPrimitive,
  ...
  DtsObject
{
  ...
  public DtsDbDynIdClearComPrimitiveImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbDynIdClearComPrimitiveImpl() => this.Dispose(false);
  ...
  public string[] DefinitionModes
  {
    get
    {
      ...
      IntPtr definitionModes = CSWrap.CSNIDTS_DtsDbDynIdClearComPrimitive_getDefinitionModes(this.Handle, out returnValue);
