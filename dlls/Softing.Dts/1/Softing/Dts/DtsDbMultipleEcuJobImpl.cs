...
// Type: Softing.Dts.DtsDbMultipleEcuJobImpl
...
internal class DtsDbMultipleEcuJobImpl : 
  MappedObject,
  DtsDbMultipleEcuJob,
  MCDDbMultipleEcuJob,
  MCDDbJob,
  ...
  DtsObject
{
  ...
  ~DtsDbMultipleEcuJobImpl() => this.Dispose(false);
  ...
  public MCDDbLocations DbLocations
  {
    get
    {
      ...
      IntPtr dbLocations = CSWrap.CSNIDTS_DtsDbMultipleEcuJob_getDbLocations(this.Handle, out returnValue);
