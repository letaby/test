...
// Type: Softing.Dts.DtsDbDataPrimitivesImpl
...
internal class DtsDbDataPrimitivesImpl : 
  MappedObject,
  DtsDbDataPrimitives,
  MCDDbDataPrimitives,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbDataPrimitivesImpl() => this.Dispose(false);
  ...
  public MCDDbDataPrimitive GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbDataPrimitives_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbDataPrimitive GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbDataPrimitives_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbDataPrimitive[] array = new MCDDbDataPrimitive[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbDataPrimitivesImpl.DtsDbDataPrimitivesEnumerator(this);
  }
