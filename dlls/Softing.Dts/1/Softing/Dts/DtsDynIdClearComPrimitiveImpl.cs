...
// Type: Softing.Dts.DtsDynIdClearComPrimitiveImpl
...
internal class DtsDynIdClearComPrimitiveImpl : 
  MappedObject,
  DtsDynIdClearComPrimitive,
  ...
  DtsObject
{
  ...
  public DtsDynIdClearComPrimitiveImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDynIdClearComPrimitiveImpl() => this.Dispose(false);
  ...
  public MCDValue DynId
  {
    get
    {
      ...
      IntPtr dynId = CSWrap.CSNIDTS_DtsDynIdClearComPrimitive_getDynId(this.Handle, out returnValue);
    ...
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDynIdClearComPrimitive_setDynId(this.Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
  ...
  public string DefinitionMode
  {
    get
    {
      ...
      IntPtr definitionMode = CSWrap.CSNIDTS_DtsDynIdClearComPrimitive_getDefinitionMode(this.Handle, out returnValue);
    ...
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDynIdClearComPrimitive_setDefinitionMode(this.Handle, value);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
