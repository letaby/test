...
// Type: Softing.Dts.DtsDbEnvDataDescImpl
...
internal class DtsDbEnvDataDescImpl : 
  MappedObject,
  DtsDbEnvDataDesc,
  MCDDbEnvDataDesc,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbEnvDataDescImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbEnvDataDescImpl() => this.Dispose(false);
  ...
  public MCDDbResponseParameters CommonDbEnvDatas
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr commonDbEnvDatas = CSWrap.CSNIDTS_DtsDbEnvDataDesc_getCommonDbEnvDatas(this.Handle, out returnValue);
      if (commonDbEnvDatas != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(commonDbEnvDatas);
  ...
  public MCDDbResponseParameters GetCompleteDbEnvDatasByDiagTroubleCode(uint troublecode)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr byDiagTroubleCode = CSWrap.CSNIDTS_DtsDbEnvDataDesc_getCompleteDbEnvDatasByDiagTroubleCode(this.Handle, troublecode, out returnValue);
    if (byDiagTroubleCode != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(byDiagTroubleCode);
    return (MCDDbResponseParameters) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbResponseParameters);
  }

  public MCDDbResponseParameters GetSpecificDbEnvDatasForDiagTroubleCode(uint troublecode)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr forDiagTroubleCode = CSWrap.CSNIDTS_DtsDbEnvDataDesc_getSpecificDbEnvDatasForDiagTroubleCode(this.Handle, troublecode, out returnValue);
    if (forDiagTroubleCode != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(forDiagTroubleCode);
    return (MCDDbResponseParameters) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbResponseParameters);
  }
