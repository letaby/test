...
// Type: Softing.Dts.DtsDbVariantCodingStringsImpl
...
internal class DtsDbVariantCodingStringsImpl : 
  MappedObject,
  DtsDbVariantCodingStrings,
  DtsNamedCollection,
  MCDNamedCollection,
  MCDCollection,
  MCDObject,
  ...
  DtsObject
{
  ...
  public DtsDbVariantCodingStringsImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbVariantCodingStringsImpl() => this.Dispose(false);
  ...
  public DtsDbVariantCodingString GetItemByIndex(uint index)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbVariantCodingStrings_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbVariantCodingString;
  }

  public DtsDbVariantCodingString GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbVariantCodingStrings_getItemByName(this.Handle, name, out returnValue);
  ...
  public List<DtsDbVariantCodingString> ToList()
  {
    List<DtsDbVariantCodingString> list = new List<DtsDbVariantCodingString>();
    for (uint index = 0; index < this.Count; ++index)
      list.Add(this.GetItemByIndex(index));
    return list;
  }

  public DtsDbVariantCodingString[] ToArray()
  {
    DtsDbVariantCodingString[] array = new DtsDbVariantCodingString[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbVariantCodingStringsImpl.DtsDbVariantCodingStringsEnumerator(this);
  }

  private class DtsDbVariantCodingStringsEnumerator : IEnumerator
  {
    private DtsDbVariantCodingStringsImpl m_classList;
    private int m_index;

    public DtsDbVariantCodingStringsEnumerator(DtsDbVariantCodingStringsImpl classList)
    {
