...
// Type: Softing.Dts.DtsDbFlashDataBlocksImpl
...
internal class DtsDbFlashDataBlocksImpl : 
  MappedObject,
  DtsDbFlashDataBlocks,
  ...
  DtsObject
{
  ...
  ~DtsDbFlashDataBlocksImpl() => this.Dispose(false);
  ...
  public MCDDbFlashDataBlock GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbFlashDataBlocks_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDDbFlashDataBlock) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbFlashDataBlock);
  }
  ...
  public MCDDbFlashDataBlock GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbFlashDataBlocks_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbFlashDataBlock[] array = new MCDDbFlashDataBlock[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbFlashDataBlocksImpl.DtsDbFlashDataBlocksEnumerator(this);
  }
