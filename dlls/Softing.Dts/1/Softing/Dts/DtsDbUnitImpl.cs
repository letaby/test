...
// Type: Softing.Dts.DtsDbUnitImpl
  ...
  DtsObject
{
  ...
  public DtsDbUnitImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbUnitImpl() => this.Dispose(false);
  ...
  public MCDDbPhysicalDimension DbPhysicalDimension
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr physicalDimension = CSWrap.CSNIDTS_DtsDbUnit_getDbPhysicalDimension(this.Handle, out returnValue);
      if (physicalDimension != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(physicalDimension);
      return (MCDDbPhysicalDimension) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbPhysicalDimension);
    }
  }

  public MCDDbUnitGroups DbUnitGroups
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbUnitGroups = CSWrap.CSNIDTS_DtsDbUnit_getDbUnitGroups(this.Handle, out returnValue);
      if (dbUnitGroups != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbUnitGroups);
  ...
  public string DisplayName
  {
    get
    {
      ...
      IntPtr displayName = CSWrap.CSNIDTS_DtsDbUnit_getDisplayName(this.Handle, out returnValue);
      if (displayName != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(displayName);
      return returnValue.makeString();
    }
  }

  public double FactorSItoUnit
  {
    get
    {
      GC.KeepAlive((object) this);
      double returnValue;
      IntPtr factorSitoUnit = CSWrap.CSNIDTS_DtsDbUnit_getFactorSItoUnit(this.Handle, out returnValue);
      if (factorSitoUnit != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(factorSitoUnit);
      return returnValue;
    }
  }

  public double OffsetSItoUnit
  {
    get
    {
      GC.KeepAlive((object) this);
      double returnValue;
      IntPtr offsetSitoUnit = CSWrap.CSNIDTS_DtsDbUnit_getOffsetSItoUnit(this.Handle, out returnValue);
      if (offsetSitoUnit != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(offsetSitoUnit);
      return returnValue;
    }
  }

  public bool HasDbPhysicalDimension
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDbUnit_hasDbPhysicalDimension(this.Handle, out returnValue);
