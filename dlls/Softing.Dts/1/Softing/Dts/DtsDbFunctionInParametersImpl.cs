...
// Type: Softing.Dts.DtsDbFunctionInParametersImpl
...
internal class DtsDbFunctionInParametersImpl : 
  MappedObject,
  DtsDbFunctionInParameters,
  ...
  DtsObject
{
  ...
  public DtsDbFunctionInParametersImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFunctionInParametersImpl() => this.Dispose(false);
  ...
  public MCDDbLocations GetDbLocationsForItemByIndex(uint index)
  {
    ...
    IntPtr locationsForItemByIndex = CSWrap.CSNIDTS_DtsDbFunctionInParameters_getDbLocationsForItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbLocations GetDbLocationsForItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr locationsForItemByName = CSWrap.CSNIDTS_DtsDbFunctionInParameters_getDbLocationsForItemByName(this.Handle, name, out returnValue);
    if (locationsForItemByName != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(locationsForItemByName);
    return (MCDDbLocations) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbLocations);
  }

  public MCDDbFunctionInParameter GetItemByIndex(uint index, MCDDbLocation locationContext)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbFunctionInParameters_getItemByIndex(this.Handle, index, DTS_ObjectMapper.getHandle(locationContext as MappedObject), out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDDbFunctionInParameter) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbFunctionInParameter);
  }

  public MCDDbFunctionInParameter GetItemByName(string name, MCDDbLocation locationContext)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbFunctionInParameters_getItemByName(this.Handle, name, DTS_ObjectMapper.getHandle(locationContext as MappedObject), out returnValue);
  ...
  {
    return (IEnumerator) new DtsDbFunctionInParametersImpl.DtsDbFunctionInParametersEnumerator(this);
  }

  private class DtsDbFunctionInParametersEnumerator : IEnumerator
  {
    private DtsDbFunctionInParametersImpl m_classList;
    private int m_index;

    public DtsDbFunctionInParametersEnumerator(DtsDbFunctionInParametersImpl classList)
    {
