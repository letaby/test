...
// Type: Softing.Dts.DtsDbInterfaceCableImpl
...
internal class DtsDbInterfaceCableImpl : 
  MappedObject,
  DtsDbInterfaceCable,
  MCDDbInterfaceCable,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbInterfaceCableImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbInterfaceCableImpl() => this.Dispose(false);
  ...
  public MCDDbInterfaceConnectorPins DbInterfaceConnectorPins
  {
    get
    {
      ...
      IntPtr interfaceConnectorPins = CSWrap.CSNIDTS_DtsDbInterfaceCable_getDbInterfaceConnectorPins(this.Handle, out returnValue);
  ...
  public string InterfaceConnectorType
  {
    get
    {
      GC.KeepAlive((object) this);
      String_Struct returnValue = new String_Struct();
      IntPtr interfaceConnectorType = CSWrap.CSNIDTS_DtsDbInterfaceCable_getInterfaceConnectorType(this.Handle, out returnValue);
      if (interfaceConnectorType != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(interfaceConnectorType);
