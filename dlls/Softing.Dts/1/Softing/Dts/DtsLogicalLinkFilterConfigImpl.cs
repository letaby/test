...
// Type: Softing.Dts.DtsLogicalLinkFilterConfigImpl
...
internal class DtsLogicalLinkFilterConfigImpl : 
  MappedObject,
  DtsLogicalLinkFilterConfig,
  ...
  IDisposable
{
  ...
  ~DtsLogicalLinkFilterConfigImpl() => this.Dispose(false);
  ...
  public void AddAccessKey(string accessKey)
  {
    ...
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsLogicalLinkFilterConfig_addAccessKey(this.Handle, accessKey);
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsLogicalLinkFilterConfig_removeAccessKey(this.Handle, accessKey);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  public bool FilteringFlag
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr filteringFlag = CSWrap.CSNIDTS_DtsLogicalLinkFilterConfig_getFilteringFlag(this.Handle, out returnValue);
      if (filteringFlag != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(filteringFlag);
      return returnValue;
    }
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsLogicalLinkFilterConfig_setFilteringFlag(this.Handle, value);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
  ...
  public string[] AccessKeys
  {
    get
    {
      ...
      IntPtr accessKeys = CSWrap.CSNIDTS_DtsLogicalLinkFilterConfig_getAccessKeys(this.Handle, out returnValue);
