...
// Type: Softing.Dts.DtsGlobalProtocolParameterSetImpl
...
internal class DtsGlobalProtocolParameterSetImpl : 
  MappedObject,
  DtsGlobalProtocolParameterSet,
  DtsNamedObject,
  MCDNamedObject,
  MCDObject,
  IDisposable,
  DtsObject
{
  ...
  public DtsGlobalProtocolParameterSetImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsGlobalProtocolParameterSetImpl() => this.Dispose(false);
  ...
  public void Update()
  {
    ...
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsGlobalProtocolParameterSet_update(this.Handle);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }

  public DtsGlobalProtocolParameters Parameters
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr parameters = CSWrap.CSNIDTS_DtsGlobalProtocolParameterSet_getParameters(this.Handle, out returnValue);
      if (parameters != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(parameters);
      return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsGlobalProtocolParameters;
    }
  }
