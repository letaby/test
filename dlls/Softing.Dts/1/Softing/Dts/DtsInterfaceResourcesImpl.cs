...
// Type: Softing.Dts.DtsInterfaceResourcesImpl
...
internal class DtsInterfaceResourcesImpl : 
  MappedObject,
  DtsInterfaceResources,
  ...
  DtsObject
{
  ...
  ~DtsInterfaceResourcesImpl() => this.Dispose(false);
  ...
  public MCDInterfaceResource GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsInterfaceResources_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDInterfaceResource GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsInterfaceResources_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDInterfaceResource[] array = new MCDInterfaceResource[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsInterfaceResourcesImpl.DtsInterfaceResourcesEnumerator(this);
  }
