...
// Type: Softing.Dts.DtsDbDiagTroubleCodesImpl
...
internal class DtsDbDiagTroubleCodesImpl : 
  MappedObject,
  DtsDbDiagTroubleCodes,
  ...
  DtsObject
{
  ...
  ~DtsDbDiagTroubleCodesImpl() => this.Dispose(false);
  ...
  public MCDDbDiagTroubleCode GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbDiagTroubleCodes_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbDiagTroubleCode GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbDiagTroubleCodes_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbDiagTroubleCode[] array = new MCDDbDiagTroubleCode[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbDiagTroubleCodesImpl.DtsDbDiagTroubleCodesEnumerator(this);
  }
