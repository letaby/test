...
// Type: Softing.Dts.DtsCommunicationExceptionImpl
...
internal class DtsCommunicationExceptionImpl : DtsCommunicationException
{
  protected IntPtr m_dtsHandle = IntPtr.Zero;

  public DtsCommunicationExceptionImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsCommunicationExceptionImpl() => this.Dispose(false);
