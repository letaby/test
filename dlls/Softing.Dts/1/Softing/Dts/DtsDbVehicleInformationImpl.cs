...
// Type: Softing.Dts.DtsDbVehicleInformationImpl
...
internal class DtsDbVehicleInformationImpl : 
  MappedObject,
  DtsDbVehicleInformation,
  ...
  DtsObject
{
  ...
  public DtsDbVehicleInformationImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbVehicleInformationImpl() => this.Dispose(false);
  ...
  public MCDDbLogicalLinks DbLogicalLinks
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbLogicalLinks = CSWrap.CSNIDTS_DtsDbVehicleInformation_getDbLogicalLinks(this.Handle, out returnValue);
      if (dbLogicalLinks != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbLogicalLinks);
  ...
  public MCDDbPhysicalVehicleLinkOrInterfaces DbPhysicalVehicleLinkOrInterfaces
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr linkOrInterfaces = CSWrap.CSNIDTS_DtsDbVehicleInformation_getDbPhysicalVehicleLinkOrInterfaces(this.Handle, out returnValue);
  ...
  public MCDDbVehicleConnectors DbVehicleConnectors
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr vehicleConnectors = CSWrap.CSNIDTS_DtsDbVehicleInformation_getDbVehicleConnectors(this.Handle, out returnValue);
      if (vehicleConnectors != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(vehicleConnectors);
      return (MCDDbVehicleConnectors) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbVehicleConnectors);
    }
  }
