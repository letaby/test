...
// Type: Softing.Dts.DtsDbStopCommunicationImpl
...
internal class DtsDbStopCommunicationImpl : 
  MappedObject,
  DtsDbStopCommunication,
  ...
  DtsObject
{
  ...
  ~DtsDbStopCommunicationImpl() => this.Dispose(false);
