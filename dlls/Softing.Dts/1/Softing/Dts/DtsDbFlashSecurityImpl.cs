...
// Type: Softing.Dts.DtsDbFlashSecurityImpl
...
internal class DtsDbFlashSecurityImpl : 
  MappedObject,
  DtsDbFlashSecurity,
  MCDDbFlashSecurity,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbFlashSecurityImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFlashSecurityImpl() => this.Dispose(false);
  ...
  public MCDValue SecurityMethod
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr securityMethod = CSWrap.CSNIDTS_DtsDbFlashSecurity_getSecurityMethod(this.Handle, out returnValue);
      if (securityMethod != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(securityMethod);
      return (MCDValue) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValue);
    }
  }

  public MCDValue Validity
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr validity = CSWrap.CSNIDTS_DtsDbFlashSecurity_getValidity(this.Handle, out returnValue);
      if (validity != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(validity);
      return (MCDValue) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValue);
    }
  }

  public MCDValue FlashwareSignature
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr flashwareSignature = CSWrap.CSNIDTS_DtsDbFlashSecurity_getFlashwareSignature(this.Handle, out returnValue);
      if (flashwareSignature != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(flashwareSignature);
      return (MCDValue) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValue);
    }
  }

  public MCDValue FlashwareChecksum
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr flashwareChecksum = CSWrap.CSNIDTS_DtsDbFlashSecurity_getFlashwareChecksum(this.Handle, out returnValue);
      if (flashwareChecksum != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(flashwareChecksum);
      return (MCDValue) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValue);
    }
  }
