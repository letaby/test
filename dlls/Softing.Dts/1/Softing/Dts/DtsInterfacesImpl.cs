...
// Type: Softing.Dts.DtsInterfacesImpl
...
internal class DtsInterfacesImpl : 
  MappedObject,
  DtsInterfaces,
  MCDInterfaces,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsInterfacesImpl() => this.Dispose(false);
  ...
  public MCDInterface GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsInterfaces_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDInterface GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsInterfaces_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDInterface[] array = new MCDInterface[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsInterfacesImpl.DtsInterfacesEnumerator(this);
  }
