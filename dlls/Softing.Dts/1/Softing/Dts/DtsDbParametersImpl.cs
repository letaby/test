...
// Type: Softing.Dts.DtsDbParametersImpl
...
internal class DtsDbParametersImpl : 
  MappedObject,
  DtsDbParameters,
  MCDDbParameters,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbParametersImpl() => this.Dispose(false);
  ...
  public MCDDbParameter GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbParameters_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbParameter GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbParameters_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbParameter[] array = new MCDDbParameter[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbParametersImpl.DtsDbParametersEnumerator(this);
  }
