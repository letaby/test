...
// Type: Softing.Dts.DtsDbEcuVariantImpl
...
internal class DtsDbEcuVariantImpl : 
  MappedObject,
  DtsDbEcuVariant,
  MCDDbEcuVariant,
  MCDDbEcu,
  ...
  DtsObject
{
  ...
  ~DtsDbEcuVariantImpl() => this.Dispose(false);
  ...
  public MCDDbEcuBaseVariant DbEcuBaseVariant
  {
    get
    {
      ...
      IntPtr dbEcuBaseVariant = CSWrap.CSNIDTS_DtsDbEcuVariant_getDbEcuBaseVariant(this.Handle, out returnValue);
