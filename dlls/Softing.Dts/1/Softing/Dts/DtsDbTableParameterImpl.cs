...
// Type: Softing.Dts.DtsDbTableParameterImpl
...
internal class DtsDbTableParameterImpl : 
  MappedObject,
  DtsDbTableParameter,
  MCDDbTableParameter,
  MCDDbParameter,
  ...
  DtsObject
{
  ...
  ~DtsDbTableParameterImpl() => this.Dispose(false);
  ...
  public MCDValue Key
  {
    get
    {
      ...
      IntPtr key = CSWrap.CSNIDTS_DtsDbTableParameter_getKey(this.Handle, out returnValue);
      if (key != IntPtr.Zero)
  ...
  public MCDAudience AudienceState
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr audienceState = CSWrap.CSNIDTS_DtsDbTableParameter_getAudienceState(this.Handle, out returnValue);
  ...
  public MCDDbAdditionalAudiences DbDisabledAdditionalAudiences
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr additionalAudiences = CSWrap.CSNIDTS_DtsDbTableParameter_getDbDisabledAdditionalAudiences(this.Handle, out returnValue);
  ...
  public MCDDbAdditionalAudiences DbEnabledAdditionalAudiences
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr additionalAudiences = CSWrap.CSNIDTS_DtsDbTableParameter_getDbEnabledAdditionalAudiences(this.Handle, out returnValue);
      if (additionalAudiences != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(additionalAudiences);
      return (MCDDbAdditionalAudiences) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbAdditionalAudiences);
    }
  ...
  public bool IsApiExecutable
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDbTableParameter_isApiExecutable(this.Handle, out returnValue);
