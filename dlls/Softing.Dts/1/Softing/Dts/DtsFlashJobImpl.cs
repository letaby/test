...
// Type: Softing.Dts.DtsFlashJobImpl
...
internal class DtsFlashJobImpl : 
  MappedObject,
  DtsFlashJob,
  MCDFlashJob,
  MCDJob,
  ...
  DtsObject
{
  ...
  public DtsFlashJobImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsFlashJobImpl() => this.Dispose(false);
  ...
  public string SessionByFlashKey
  {
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsFlashJob_setSessionByFlashKey(this.Handle, value);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }

  public string SessionByName
  {
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsFlashJob_setSessionByName(this.Handle, value);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }

  public MCDDbFlashSession Session
  {
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsFlashJob_setSession(this.Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }

  public MCDResult CreateResult(
    MCDResultType resultType,
    MCDErrorCodes code,
    string codeDescription,
    ushort vendorCode,
    string vendorCodeDescription,
    MCDSeverity severity)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr result = CSWrap.CSNIDTS_DtsJob_createResult(this.Handle, resultType, code, codeDescription, vendorCode, vendorCodeDescription, severity, out returnValue);
    if (result != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(result);
    return (MCDResult) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsResult);
  }

  public void ReleaseResult(MCDResult result)
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsJob_releaseResult(this.Handle, DTS_ObjectMapper.getHandle(result as MappedObject));
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  public byte Progress
  {
    get
    {
      GC.KeepAlive((object) this);
      byte returnValue;
      IntPtr progress = CSWrap.CSNIDTS_DtsJob_getProgress(this.Handle, out returnValue);
  ...
  public string JobInfo
  {
    get
    {
      ...
      IntPtr jobInfo = CSWrap.CSNIDTS_DtsJob_getJobInfo(this.Handle, out returnValue);
  ...
  public MCDResults CreateResultCollection()
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr resultCollection = CSWrap.CSNIDTS_DtsJob_createResultCollection(this.Handle, out returnValue);
    if (resultCollection != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(resultCollection);
