...
// Type: Softing.Dts.DtsDynIdReadComPrimitiveImpl
...
internal class DtsDynIdReadComPrimitiveImpl : 
  MappedObject,
  DtsDynIdReadComPrimitive,
  ...
  DtsObject
{
  ...
  public DtsDynIdReadComPrimitiveImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDynIdReadComPrimitiveImpl() => this.Dispose(false);
  ...
  public MCDValue DynId
  {
    get
    {
      ...
      IntPtr dynId = CSWrap.CSNIDTS_DtsDynIdReadComPrimitive_getDynId(this.Handle, out returnValue);
    ...
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDynIdReadComPrimitive_setDynId(this.Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
  ...
  public string DefinitionMode
  {
    get
    {
      ...
      IntPtr definitionMode = CSWrap.CSNIDTS_DtsDynIdReadComPrimitive_getDefinitionMode(this.Handle, out returnValue);
    ...
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDynIdReadComPrimitive_setDefinitionMode(this.Handle, value);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
