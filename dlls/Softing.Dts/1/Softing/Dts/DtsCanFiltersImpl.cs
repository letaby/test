...
// Type: Softing.Dts.DtsCanFiltersImpl
...
internal class DtsCanFiltersImpl : 
  MappedObject,
  DtsCanFilters,
  DtsNamedCollection,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  public DtsCanFiltersImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsCanFiltersImpl() => this.Dispose(false);
  ...
  public DtsCanFilter GetItemByIndex(uint index)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsCanFilters_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsCanFilter;
  }

  public DtsCanFilter GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsCanFilters_getItemByName(this.Handle, name, out returnValue);
    if (itemByName != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByName);
    return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsCanFilter;
  }

  public DtsCanFilter CreateItem(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsCanFilters_createItem(this.Handle, name, out returnValue);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
    return DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsCanFilter;
  }

  public void RemoveItem(DtsCanFilter item)
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsCanFilters_removeItem(this.Handle, DTS_ObjectMapper.getHandle(item as MappedObject));
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  public List<DtsCanFilter> ToList()
  {
    List<DtsCanFilter> list = new List<DtsCanFilter>();
    for (uint index = 0; index < this.Count; ++index)
      list.Add(this.GetItemByIndex(index));
    return list;
  }

  public DtsCanFilter[] ToArray()
  {
    DtsCanFilter[] array = new DtsCanFilter[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsCanFiltersImpl.DtsCanFiltersEnumerator(this);
  }

  private class DtsCanFiltersEnumerator : IEnumerator
  {
    private DtsCanFiltersImpl m_classList;
    private int m_index;

    public DtsCanFiltersEnumerator(DtsCanFiltersImpl classList)
    {
