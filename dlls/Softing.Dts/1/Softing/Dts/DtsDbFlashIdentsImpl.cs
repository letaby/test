...
// Type: Softing.Dts.DtsDbFlashIdentsImpl
...
internal class DtsDbFlashIdentsImpl : 
  MappedObject,
  DtsDbFlashIdents,
  MCDDbFlashIdents,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  public DtsDbFlashIdentsImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFlashIdentsImpl() => this.Dispose(false);
  ...
  public MCDDbFlashIdent GetItemByIndex(uint index)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbFlashIdents_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDDbFlashIdent) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbFlashIdent);
  }

  public MCDDbFlashIdent GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbFlashIdents_getItemByName(this.Handle, name, out returnValue);
  ...
  public List<MCDDbFlashIdent> ToList()
  {
    List<MCDDbFlashIdent> list = new List<MCDDbFlashIdent>();
    for (uint index = 0; index < this.Count; ++index)
      list.Add(this.GetItemByIndex(index));
    return list;
  }

  public MCDDbFlashIdent[] ToArray()
  {
    MCDDbFlashIdent[] array = new MCDDbFlashIdent[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbFlashIdentsImpl.DtsDbFlashIdentsEnumerator(this);
  }

  private class DtsDbFlashIdentsEnumerator : IEnumerator
  {
    private DtsDbFlashIdentsImpl m_classList;
    private int m_index;

    public DtsDbFlashIdentsEnumerator(DtsDbFlashIdentsImpl classList)
    {
