...
// Type: Softing.Dts.DtsDbServiceImpl
...
internal class DtsDbServiceImpl : 
  MappedObject,
  DtsDbService,
  MCDDbService,
  MCDDbDiagService,
  ...
  DtsObject
{
  ...
  ~DtsDbServiceImpl() => this.Dispose(false);
  ...
  public MCDAddressingMode AddressingMode
  {
    get
    {
      ...
      IntPtr addressingMode = CSWrap.CSNIDTS_DtsDbService_getAddressingMode(this.Handle, out returnValue);
      if (addressingMode != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(addressingMode);
      return returnValue;
    }
  }
  ...
  public bool HasSuppressPositiveResponseCapability
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDbService_hasSuppressPositiveResponseCapability(this.Handle, out returnValue);
  ...
  public MCDResult GenerateResult(byte[] pRequest, byte[] pResponse)
  {
    ...
    IntPtr result = CSWrap.CSNIDTS_DtsDbService_generateResult(this.Handle, ref _pRequest, ref _pResponse, out returnValue);
  ...
  public MCDRuntimeMode RuntimeMode
  {
    get
    {
      ...
      IntPtr runtimeMode = CSWrap.CSNIDTS_DtsDbDiagService_getRuntimeMode(this.Handle, out returnValue);
      if (runtimeMode != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(runtimeMode);
      return returnValue;
    }
  }
