...
// Type: Softing.Dts.DtsDbFunctionalGroupImpl
...
internal class DtsDbFunctionalGroupImpl : 
  MappedObject,
  DtsDbFunctionalGroup,
  ...
  DtsObject
{
  ...
  ~DtsDbFunctionalGroupImpl() => this.Dispose(false);
  ...
  public MCDDbEcuBaseVariants GroupMembers
  {
    get
    {
      ...
      IntPtr groupMembers = CSWrap.CSNIDTS_DtsDbFunctionalGroup_getGroupMembers(this.Handle, out returnValue);
      if (groupMembers != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(groupMembers);
