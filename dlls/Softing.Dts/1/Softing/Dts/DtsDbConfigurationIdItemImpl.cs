...
// Type: Softing.Dts.DtsDbConfigurationIdItemImpl
...
internal class DtsDbConfigurationIdItemImpl : 
  MappedObject,
  DtsDbConfigurationIdItem,
  ...
  DtsObject
{
  ...
  ~DtsDbConfigurationIdItemImpl() => this.Dispose(false);
