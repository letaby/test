...
// Type: Softing.Dts.DtsDbInterfaceConnectorPinImpl
...
internal class DtsDbInterfaceConnectorPinImpl : 
  MappedObject,
  DtsDbInterfaceConnectorPin,
  ...
  DtsObject
{
  ...
  public DtsDbInterfaceConnectorPinImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbInterfaceConnectorPinImpl() => this.Dispose(false);
  ...
  public uint PinNumber
  {
    get
    {
      ...
      uint returnValue;
      IntPtr pinNumber = CSWrap.CSNIDTS_DtsDbInterfaceConnectorPin_getPinNumber(this.Handle, out returnValue);
  ...
  public uint PinNumberOnVCI
  {
    get
    {
      GC.KeepAlive((object) this);
      uint returnValue;
      IntPtr pinNumberOnVci = CSWrap.CSNIDTS_DtsDbInterfaceConnectorPin_getPinNumberOnVCI(this.Handle, out returnValue);
      if (pinNumberOnVci != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(pinNumberOnVci);
      return returnValue;
    }
  }

  public MCDConnectorPinType PinType
  {
    get
    {
      GC.KeepAlive((object) this);
      MCDConnectorPinType returnValue;
      IntPtr pinType = CSWrap.CSNIDTS_DtsDbInterfaceConnectorPin_getPinType(this.Handle, out returnValue);
