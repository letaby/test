...
// Type: Softing.Dts.DtsDbVehicleConnectorPinImpl
...
internal class DtsDbVehicleConnectorPinImpl : 
  MappedObject,
  DtsDbVehicleConnectorPin,
  ...
  DtsObject
{
  ...
  public DtsDbVehicleConnectorPinImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbVehicleConnectorPinImpl() => this.Dispose(false);
  ...
  public MCDDbVehicleConnector DbVehicleConnector
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr vehicleConnector = CSWrap.CSNIDTS_DtsDbVehicleConnectorPin_getDbVehicleConnector(this.Handle, out returnValue);
      if (vehicleConnector != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(vehicleConnector);
  ...
  public ushort PinNumber
  {
    get
    {
      GC.KeepAlive((object) this);
      ushort returnValue;
      IntPtr pinNumber = CSWrap.CSNIDTS_DtsDbVehicleConnectorPin_getPinNumber(this.Handle, out returnValue);
      if (pinNumber != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(pinNumber);
      return returnValue;
    }
  }
