...
// Type: Softing.Dts.DtsDbFunctionDictionaryImpl
...
internal class DtsDbFunctionDictionaryImpl : 
  MappedObject,
  DtsDbFunctionDictionary,
  ...
  DtsObject
{
  ...
  public DtsDbFunctionDictionaryImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFunctionDictionaryImpl() => this.Dispose(false);
  ...
  public MCDDbFunctionNodeGroups DbFunctionNodeGroups
  {
    get
    {
      ...
      IntPtr functionNodeGroups = CSWrap.CSNIDTS_DtsDbFunctionDictionary_getDbFunctionNodeGroups(this.Handle, out returnValue);
  ...
  public MCDDbFunctionNodes DbFunctionNodes
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbFunctionNodes = CSWrap.CSNIDTS_DtsDbFunctionDictionary_getDbFunctionNodes(this.Handle, out returnValue);
  ...
  public MCDDbAdditionalAudiences DbAdditionalAudiences
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr additionalAudiences = CSWrap.CSNIDTS_DtsDbFunctionDictionary_getDbAdditionalAudiences(this.Handle, out returnValue);
  ...
  public MCDDbSpecialDataGroups DbSDGs
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbSdGs = CSWrap.CSNIDTS_DtsDbFunctionDictionary_getDbSDGs(this.Handle, out returnValue);
