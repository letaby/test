...
// Type: Softing.Dts.DtsDbEcuStateImpl
...
internal class DtsDbEcuStateImpl : 
  MappedObject,
  DtsDbEcuState,
  MCDDbEcuState,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbEcuStateImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbEcuStateImpl() => this.Dispose(false);
  ...
  public MCDDbEcuStateTransitions DbEcuStateTransitions
  {
    get
    {
      ...
      IntPtr stateTransitions = CSWrap.CSNIDTS_DtsDbEcuState_getDbEcuStateTransitions(this.Handle, out returnValue);
  ...
  public MCDDbPreconditionDefinitions DbRestrictedDiagComPrimitives
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr diagComPrimitives = CSWrap.CSNIDTS_DtsDbEcuState_getDbRestrictedDiagComPrimitives(this.Handle, out returnValue);
      if (diagComPrimitives != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(diagComPrimitives);
      return (MCDDbPreconditionDefinitions) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbPreconditionDefinitions);
    }
  }
