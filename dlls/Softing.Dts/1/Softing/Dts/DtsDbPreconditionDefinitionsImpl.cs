...
// Type: Softing.Dts.DtsDbPreconditionDefinitionsImpl
...
internal class DtsDbPreconditionDefinitionsImpl : 
  MappedObject,
  DtsDbPreconditionDefinitions,
  ...
  DtsObject
{
  ...
  ~DtsDbPreconditionDefinitionsImpl() => this.Dispose(false);
  ...
  public MCDDbPreconditionDefinition GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbPreconditionDefinitions_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDDbPreconditionDefinition) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbPreconditionDefinition);
  }
  ...
  {
    MCDDbPreconditionDefinition[] array = new MCDDbPreconditionDefinition[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbPreconditionDefinitionsImpl.DtsDbPreconditionDefinitionsEnumerator(this);
  }
