...
// Type: Softing.Dts.DtsMessageFiltersImpl
...
internal class DtsMessageFiltersImpl : 
  MappedObject,
  DtsMessageFilters,
  MCDMessageFilters,
  MCDCollection,
  ...
  DtsObject
{
  ...
  ~DtsMessageFiltersImpl() => this.Dispose(false);
  ...
  public MCDMessageFilter AddByFilterType(MCDMessageFilterType messageFilterType)
  {
    ...
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsMessageFilters_addByFilterType(this.Handle, messageFilterType, out returnValue);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
    return (MCDMessageFilter) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsMessageFilter);
  }
  ...
  public MCDMessageFilter GetItemByIndex(uint index)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsMessageFilters_getItemByIndex(this.Handle, index, out returnValue);
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsMessageFilters_remove(this.Handle, DTS_ObjectMapper.getHandle(messageFilter as MappedObject));
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsMessageFilters_removeAll(this.Handle);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsMessageFilters_removeByIndex(this.Handle, index);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  {
    MCDMessageFilter[] array = new MCDMessageFilter[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsMessageFiltersImpl.DtsMessageFiltersEnumerator(this);
  }
