...
// Type: Softing.Dts.DtsDbStartCommunicationImpl
...
internal class DtsDbStartCommunicationImpl : 
  MappedObject,
  DtsDbStartCommunication,
  ...
  DtsObject
{
  ...
  public DtsDbStartCommunicationImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbStartCommunicationImpl() => this.Dispose(false);
