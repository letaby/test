...
// Type: Softing.Dts.DtsDbCodingDataImpl
...
internal class DtsDbCodingDataImpl : 
  MappedObject,
  DtsDbCodingData,
  MCDDbCodingData,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  ~DtsDbCodingDataImpl() => this.Dispose(false);
  ...
  public string FileName
  {
    get
    {
      ...
      IntPtr fileName = CSWrap.CSNIDTS_DtsDbCodingData_getFileName(this.Handle, out returnValue);
  ...
  public bool IsLateBound
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDbCodingData_isLateBound(this.Handle, out returnValue);
