...
// Type: Softing.Dts.DtsConfigurationIdItemImpl
...
internal class DtsConfigurationIdItemImpl : 
  MappedObject,
  DtsConfigurationIdItem,
  ...
  DtsObject
{
  ...
  public DtsConfigurationIdItemImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsConfigurationIdItemImpl() => this.Dispose(false);
