...
// Type: Softing.Dts.DtsDbFunctionOutParameterImpl
...
internal class DtsDbFunctionOutParameterImpl : 
  MappedObject,
  DtsDbFunctionOutParameter,
  ...
  DtsObject
{
  ...
  public DtsDbFunctionOutParameterImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFunctionOutParameterImpl() => this.Dispose(false);
  ...
  public MCDDataType DataType
  {
    get
    {
      ...
      IntPtr dataType = CSWrap.CSNIDTS_DtsDbFunctionOutParameter_getDataType(this.Handle, out returnValue);
  ...
  public MCDDbFunctionDiagComConnector DbFunctionDiagComConnector
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr diagComConnector = CSWrap.CSNIDTS_DtsDbFunctionOutParameter_getDbFunctionDiagComConnector(this.Handle, out returnValue);
      if (diagComConnector != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(diagComConnector);
  ...
  public MCDDbResponseParameter DbResponseParameter
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr responseParameter = CSWrap.CSNIDTS_DtsDbFunctionOutParameter_getDbResponseParameter(this.Handle, out returnValue);
  ...
  public MCDDbUnit DbUnit
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbUnit = CSWrap.CSNIDTS_DtsDbFunctionOutParameter_getDbUnit(this.Handle, out returnValue);
