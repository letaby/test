...
// Type: Softing.Dts.DtsProtocolParameterSetImpl
...
internal class DtsProtocolParameterSetImpl : 
  MappedObject,
  DtsProtocolParameterSet,
  ...
  DtsObject
{
  ...
  public DtsProtocolParameterSetImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsProtocolParameterSetImpl() => this.Dispose(false);
  ...
  public DtsProtocolParameterLevel GetParameterLevel(string shortName)
  {
    GC.KeepAlive((object) this);
    DtsProtocolParameterLevel returnValue;
    IntPtr parameterLevel = CSWrap.CSNIDTS_DtsProtocolParameterSet_getParameterLevel(this.Handle, shortName, out returnValue);
    if (parameterLevel != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(parameterLevel);
    return returnValue;
  }

  public void FetchValueFromInterface(string shortName)
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsProtocolParameterSet_fetchValueFromInterface(this.Handle, shortName);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }

  public void FetchValuesFromInterface()
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsProtocolParameterSet_fetchValuesFromInterface(this.Handle);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsDiagComPrimitive_executeAsync(this.Handle);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  public MCDResults FetchResults(int numReq)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsDiagComPrimitive_fetchResults(this.Handle, numReq, out returnValue);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
    return (MCDResults) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsResults);
  }
  ...
  public MCDResultState ResultState
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr resultState = CSWrap.CSNIDTS_DtsDiagComPrimitive_getResultState(this.Handle, out returnValue);
