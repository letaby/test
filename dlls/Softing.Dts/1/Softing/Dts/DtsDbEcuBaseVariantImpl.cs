...
// Type: Softing.Dts.DtsDbEcuBaseVariantImpl
...
internal class DtsDbEcuBaseVariantImpl : 
  MappedObject,
  DtsDbEcuBaseVariant,
  MCDDbEcuBaseVariant,
  MCDDbEcu,
  ...
  DtsObject
{
  ...
  ~DtsDbEcuBaseVariantImpl() => this.Dispose(false);
  ...
  public MCDDbEcuVariants DbEcuVariants
  {
    get
    {
      ...
      IntPtr dbEcuVariants = CSWrap.CSNIDTS_DtsDbEcuBaseVariant_getDbEcuVariants(this.Handle, out returnValue);
  ...
  public MCDDbMatchingPatterns DbBaseVariantPatterns
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr baseVariantPatterns = CSWrap.CSNIDTS_DtsDbEcuBaseVariant_getDbBaseVariantPatterns(this.Handle, out returnValue);
      if (baseVariantPatterns != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(baseVariantPatterns);
  ...
  public MCDDbLocations DbLocations
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbLocations = CSWrap.CSNIDTS_DtsDbEcu_getDbLocations(this.Handle, out returnValue);
      if (dbLocations != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbLocations);
