...
// Type: Softing.Dts.DtsDbPhysicalSegmentImpl
...
internal class DtsDbPhysicalSegmentImpl : 
  MappedObject,
  DtsDbPhysicalSegment,
  ...
  DtsObject
{
  ...
  ~DtsDbPhysicalSegmentImpl() => this.Dispose(false);
  ...
  public uint BlockSize
  {
    get
    {
      ...
      uint returnValue;
      IntPtr blockSize = CSWrap.CSNIDTS_DtsDbPhysicalSegment_getBlockSize(this.Handle, out returnValue);
      if (blockSize != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(blockSize);
      return returnValue;
    }
  }
  ...
  public uint EndAddress
  {
    get
    {
      GC.KeepAlive((object) this);
      uint returnValue;
      IntPtr endAddress = CSWrap.CSNIDTS_DtsDbPhysicalSegment_getEndAddress(this.Handle, out returnValue);
      if (endAddress != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(endAddress);
      return returnValue;
    }
  }
  ...
  public byte[] FillByte
  {
    get
    {
      ...
      IntPtr fillByte = CSWrap.CSNIDTS_DtsDbPhysicalSegment_getFillByte(this.Handle, out returnValue);
  ...
  public uint StartAddress
  {
    get
    {
      GC.KeepAlive((object) this);
      uint returnValue;
      IntPtr startAddress = CSWrap.CSNIDTS_DtsDbPhysicalSegment_getStartAddress(this.Handle, out returnValue);
      if (startAddress != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(startAddress);
      return returnValue;
    }
  }
