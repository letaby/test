...
// Type: Softing.Dts.DtsRequestParameterImpl
...
internal class DtsRequestParameterImpl : 
  MappedObject,
  DtsRequestParameter,
  MCDRequestParameter,
  MCDParameter,
  ...
  DtsObject
{
  ...
  public DtsRequestParameterImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsRequestParameterImpl() => this.Dispose(false);
