...
// Type: Softing.Dts.DtsDbPhysicalVehicleLinkOrInterfacesImpl
...
internal class DtsDbPhysicalVehicleLinkOrInterfacesImpl : 
  MappedObject,
  DtsDbPhysicalVehicleLinkOrInterfaces,
  MCDDbPhysicalVehicleLinkOrInterfaces,
  MCDNamedCollection,
  MCDCollection,
  MCDObject,
  IDisposable,
  ...
  DtsObject
{
  ...
  ~DtsDbPhysicalVehicleLinkOrInterfacesImpl() => this.Dispose(false);
  ...
  public MCDDbPhysicalVehicleLinkOrInterface GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbPhysicalVehicleLinkOrInterfaces_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbPhysicalVehicleLinkOrInterface GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbPhysicalVehicleLinkOrInterfaces_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbPhysicalVehicleLinkOrInterface[] array = new MCDDbPhysicalVehicleLinkOrInterface[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbPhysicalVehicleLinkOrInterfacesImpl.DtsDbPhysicalVehicleLinkOrInterfacesEnumerator(this);
  }
  ...
  private class DtsDbPhysicalVehicleLinkOrInterfacesEnumerator : IEnumerator
  {
    ...
    public DtsDbPhysicalVehicleLinkOrInterfacesEnumerator(
      DtsDbPhysicalVehicleLinkOrInterfacesImpl classList)
    {
