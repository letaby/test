...
// Type: Softing.Dts.DtsSystemExceptionImpl
...
internal class DtsSystemExceptionImpl : DtsSystemException
{
  protected IntPtr m_dtsHandle = IntPtr.Zero;

  public DtsSystemExceptionImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsSystemExceptionImpl() => this.Dispose(false);
