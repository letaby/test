...
// Type: Softing.Dts.DtsDbAccessLevelImpl
...
internal class DtsDbAccessLevelImpl : 
  MappedObject,
  DtsDbAccessLevel,
  MCDDbAccessLevel,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbAccessLevelImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbAccessLevelImpl() => this.Dispose(false);
  ...
  public MCDDbDiagComPrimitive AccessDiagComPrimitive
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr diagComPrimitive = CSWrap.CSNIDTS_DtsDbAccessLevel_getAccessDiagComPrimitive(this.Handle, out returnValue);
  ...
  public uint AccessLevelValue
  {
    get
    {
      GC.KeepAlive((object) this);
      uint returnValue;
      IntPtr accessLevelValue = CSWrap.CSNIDTS_DtsDbAccessLevel_getAccessLevelValue(this.Handle, out returnValue);
      if (accessLevelValue != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(accessLevelValue);
      return returnValue;
    }
  }

  public string ExternalAccessMethod
  {
    get
    {
      GC.KeepAlive((object) this);
      String_Struct returnValue = new String_Struct();
      IntPtr externalAccessMethod = CSWrap.CSNIDTS_DtsDbAccessLevel_getExternalAccessMethod(this.Handle, out returnValue);
  ...
  public bool HasExternalAccessMethod
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDbAccessLevel_hasExternalAccessMethod(this.Handle, out returnValue);
