...
// Type: Softing.Dts.DtsDbUnitGroupsImpl
...
internal class DtsDbUnitGroupsImpl : 
  MappedObject,
  DtsDbUnitGroups,
  MCDDbUnitGroups,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbUnitGroupsImpl() => this.Dispose(false);
  ...
  public MCDDbUnitGroup GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbUnitGroups_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbUnitGroup GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbUnitGroups_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbUnitGroup[] array = new MCDDbUnitGroup[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbUnitGroupsImpl.DtsDbUnitGroupsEnumerator(this);
  }
