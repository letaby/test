...
// Type: Softing.Dts.DtsDbEcuStateChartImpl
...
internal class DtsDbEcuStateChartImpl : 
  MappedObject,
  DtsDbEcuStateChart,
  MCDDbEcuStateChart,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbEcuStateChartImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbEcuStateChartImpl() => this.Dispose(false);
  ...
  public MCDDbEcuStates DbEcuStates
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbEcuStates = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbEcuStates(this.Handle, out returnValue);
      if (dbEcuStates != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbEcuStates);
      return (MCDDbEcuStates) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbEcuStates);
    }
  }

  public MCDDbEcuStateTransitions DbEcuStateTransitions
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr stateTransitions = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbEcuStateTransitions(this.Handle, out returnValue);
      if (stateTransitions != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(stateTransitions);
  ...
  public MCDDbDiagComPrimitives DbPreConditionStateDiagComPrimitives
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr diagComPrimitives = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbPreConditionStateDiagComPrimitives(this.Handle, out returnValue);
  ...
  public MCDDbEcuState DbStartState
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbStartState = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbStartState(this.Handle, out returnValue);
      if (dbStartState != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbStartState);
      return (MCDDbEcuState) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbEcuState);
    }
  }

  public MCDDbDiagComPrimitives DbStateTransitionDiagComPrimitives
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr diagComPrimitives = CSWrap.CSNIDTS_DtsDbEcuStateChart_getDbStateTransitionDiagComPrimitives(this.Handle, out returnValue);
      if (diagComPrimitives != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(diagComPrimitives);
      return (MCDDbDiagComPrimitives) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbDiagComPrimitives);
    }
  ...
  public string Semantic
  {
    get
    {
      ...
      IntPtr semantic = CSWrap.CSNIDTS_DtsDbEcuStateChart_getSemantic(this.Handle, out returnValue);
