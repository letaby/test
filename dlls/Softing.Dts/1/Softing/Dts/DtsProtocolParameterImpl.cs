...
// Type: Softing.Dts.DtsProtocolParameterImpl
...
internal class DtsProtocolParameterImpl : 
  MappedObject,
  DtsProtocolParameter,
  DtsRequestParameter,
  MCDRequestParameter,
  MCDParameter,
  MCDNamedObject,
  ...
  DtsObject
{
  ...
  public DtsProtocolParameterImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsProtocolParameterImpl() => this.Dispose(false);
