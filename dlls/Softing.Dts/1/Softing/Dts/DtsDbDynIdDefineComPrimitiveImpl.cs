...
// Type: Softing.Dts.DtsDbDynIdDefineComPrimitiveImpl
...
internal class DtsDbDynIdDefineComPrimitiveImpl : 
  MappedObject,
  DtsDbDynIdDefineComPrimitive,
  ...
  DtsObject
{
  ...
  public DtsDbDynIdDefineComPrimitiveImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbDynIdDefineComPrimitiveImpl() => this.Dispose(false);
  ...
  public string[] DefinitionModes
  {
    get
    {
      GC.KeepAlive((object) this);
      StringArray_Struct returnValue = new StringArray_Struct();
      IntPtr definitionModes = CSWrap.CSNIDTS_DtsDbDynIdDefineComPrimitive_getDefinitionModes(this.Handle, out returnValue);
      if (definitionModes != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(definitionModes);
