...
// Type: Softing.Dts.DtsDbVehicleInformationsImpl
...
internal class DtsDbVehicleInformationsImpl : 
  MappedObject,
  DtsDbVehicleInformations,
  ...
  DtsObject
{
  ...
  ~DtsDbVehicleInformationsImpl() => this.Dispose(false);
  ...
  public MCDDbVehicleInformation GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbVehicleInformations_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbVehicleInformation GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbVehicleInformations_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbVehicleInformation[] array = new MCDDbVehicleInformation[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbVehicleInformationsImpl.DtsDbVehicleInformationsEnumerator(this);
  }
