...
// Type: Softing.Dts.DtsDbFunctionInParameterImpl
...
internal class DtsDbFunctionInParameterImpl : 
  MappedObject,
  DtsDbFunctionInParameter,
  ...
  DtsObject
{
  ...
  public DtsDbFunctionInParameterImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFunctionInParameterImpl() => this.Dispose(false);
  ...
  public MCDDataType DataType
  {
    get
    {
      ...
      IntPtr dataType = CSWrap.CSNIDTS_DtsDbFunctionInParameter_getDataType(this.Handle, out returnValue);
  ...
  public MCDDbFunctionDiagComConnector DbFunctionDiagComConnector
  {
    get
    {
      ...
      IntPtr diagComConnector = CSWrap.CSNIDTS_DtsDbFunctionInParameter_getDbFunctionDiagComConnector(this.Handle, out returnValue);
  ...
  public MCDDbRequestParameter DbRequestParameter
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr requestParameter = CSWrap.CSNIDTS_DtsDbFunctionInParameter_getDbRequestParameter(this.Handle, out returnValue);
  ...
  public MCDDbUnit DbUnit
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbUnit = CSWrap.CSNIDTS_DtsDbFunctionInParameter_getDbUnit(this.Handle, out returnValue);
