...
// Type: Softing.Dts.DtsDbDynIdReadComPrimitiveImpl
...
internal class DtsDbDynIdReadComPrimitiveImpl : 
  MappedObject,
  DtsDbDynIdReadComPrimitive,
  ...
  DtsObject
{
  ...
  public DtsDbDynIdReadComPrimitiveImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbDynIdReadComPrimitiveImpl() => this.Dispose(false);
  ...
  public string[] DefinitionModes
  {
    get
    {
      ...
      IntPtr definitionModes = CSWrap.CSNIDTS_DtsDbDynIdReadComPrimitive_getDefinitionModes(this.Handle, out returnValue);
