...
// Type: Softing.Dts.DtsDbEcuStateChartsImpl
...
internal class DtsDbEcuStateChartsImpl : 
  MappedObject,
  DtsDbEcuStateCharts,
  MCDDbEcuStateCharts,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbEcuStateChartsImpl() => this.Dispose(false);
  ...
  public MCDDbEcuStateChart GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbEcuStateCharts_getItemByIndex(this.Handle, index, out returnValue);
    if (itemByIndex != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(itemByIndex);
    return (MCDDbEcuStateChart) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbEcuStateChart);
  }
  ...
  public MCDDbEcuStateChart GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbEcuStateCharts_getItemByName(this.Handle, name, out returnValue);
  ...
  public MCDDbEcuStateChart GetItemBySemanticAttribute(string semantic)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr semanticAttribute = CSWrap.CSNIDTS_DtsDbEcuStateCharts_getItemBySemanticAttribute(this.Handle, semantic, out returnValue);
  ...
  public string[] Semantics
  {
    get
    {
      ...
      IntPtr semantics = CSWrap.CSNIDTS_DtsDbEcuStateCharts_getSemantics(this.Handle, out returnValue);
      if (semantics != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(semantics);
  ...
  {
    MCDDbEcuStateChart[] array = new MCDDbEcuStateChart[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbEcuStateChartsImpl.DtsDbEcuStateChartsEnumerator(this);
  }
