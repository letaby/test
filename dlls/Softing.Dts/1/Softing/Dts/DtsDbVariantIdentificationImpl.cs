...
// Type: Softing.Dts.DtsDbVariantIdentificationImpl
...
internal class DtsDbVariantIdentificationImpl : 
  MappedObject,
  DtsDbVariantIdentification,
  ...
  DtsObject
{
  ...
  ~DtsDbVariantIdentificationImpl() => this.Dispose(false);
