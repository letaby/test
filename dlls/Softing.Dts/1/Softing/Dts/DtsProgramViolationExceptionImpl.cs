...
// Type: Softing.Dts.DtsProgramViolationExceptionImpl
...
internal class DtsProgramViolationExceptionImpl : DtsProgramViolationException
{
  protected IntPtr m_dtsHandle = IntPtr.Zero;

  public DtsProgramViolationExceptionImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsProgramViolationExceptionImpl() => this.Dispose(false);
