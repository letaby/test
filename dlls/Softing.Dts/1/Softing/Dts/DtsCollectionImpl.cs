...
// Type: Softing.Dts.DtsCollectionImpl
...
internal class DtsCollectionImpl : 
  MappedObject,
  DtsCollection,
  MCDCollection,
  MCDObject,
  ...
  DtsObject
{
  ...
  ~DtsCollectionImpl() => this.Dispose(false);
  ...
  {
    return (IEnumerator) new DtsCollectionImpl.DtsCollectionEnumerator(this);
  }
  ...
  private class DtsCollectionEnumerator : IEnumerator
  {
    ...
    public object Current => (object) this.m_classList.GetObjectItemByIndex((uint) this.m_index);
