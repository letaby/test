...
// Type: Softing.Dts.DtsDbPhysicalMemoryImpl
...
internal class DtsDbPhysicalMemoryImpl : 
  MappedObject,
  DtsDbPhysicalMemory,
  MCDDbPhysicalMemory,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbPhysicalMemoryImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbPhysicalMemoryImpl() => this.Dispose(false);
  ...
  public MCDDbPhysicalSegments PhysicalSegments
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr physicalSegments = CSWrap.CSNIDTS_DtsDbPhysicalMemory_getPhysicalSegments(this.Handle, out returnValue);
      if (physicalSegments != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(physicalSegments);
      return (MCDDbPhysicalSegments) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbPhysicalSegments);
    }
  }
