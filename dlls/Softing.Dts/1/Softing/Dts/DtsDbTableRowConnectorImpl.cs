...
// Type: Softing.Dts.DtsDbTableRowConnectorImpl
...
internal class DtsDbTableRowConnectorImpl : 
  MappedObject,
  DtsDbTableRowConnector,
  ...
  DtsObject
{
  ...
  ~DtsDbTableRowConnectorImpl() => this.Dispose(false);
  ...
  public MCDDbTable DbTable
  {
    get
    {
      ...
      IntPtr dbTable = CSWrap.CSNIDTS_DtsDbTableRowConnector_getDbTable(this.Handle, out returnValue);
  ...
  public MCDDbTableParameter DbTableRow
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbTableRow = CSWrap.CSNIDTS_DtsDbTableRowConnector_getDbTableRow(this.Handle, out returnValue);
      if (dbTableRow != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbTableRow);
