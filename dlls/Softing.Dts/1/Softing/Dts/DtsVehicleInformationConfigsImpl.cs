...
// Type: Softing.Dts.DtsVehicleInformationConfigsImpl
...
internal class DtsVehicleInformationConfigsImpl : 
  MappedObject,
  DtsVehicleInformationConfigs,
  DtsCollection,
  MCDCollection,
  MCDObject,
  IDisposable,
  ...
  DtsObject
{
  ...
  ~DtsVehicleInformationConfigsImpl() => this.Dispose(false);
  ...
  public DtsVehicleInformationConfig GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsVehicleInformationConfigs_getItemByIndex(this.Handle, index, out returnValue);
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsVehicleInformationConfigs_removeItem(this.Handle, DTS_ObjectMapper.getHandle(vehicleInfoConfig as MappedObject));
  ...
  {
    DtsVehicleInformationConfig[] array = new DtsVehicleInformationConfig[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsVehicleInformationConfigsImpl.DtsVehicleInformationConfigsEnumerator(this);
  }
