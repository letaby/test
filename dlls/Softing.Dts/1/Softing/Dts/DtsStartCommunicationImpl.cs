...
// Type: Softing.Dts.DtsStartCommunicationImpl
...
internal class DtsStartCommunicationImpl : 
  MappedObject,
  ...
  DtsObject
{
  ...
  ~DtsStartCommunicationImpl() => this.Dispose(false);
  ...
  public bool HasSuppressPositiveResponseCapability
  {
    get
    {
      ...
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsStartCommunication_hasSuppressPositiveResponseCapability(this.Handle, out returnValue);
  ...
  public bool IsSuppressPositiveResponse
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsStartCommunication_isSuppressPositiveResponse(this.Handle, out returnValue);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
      return returnValue;
    }
  ...
  public bool SuppressPositiveResponse
  {
    ...
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsStartCommunication_setSuppressPositiveResponse(this.Handle, value);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
