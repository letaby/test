...
// Type: Softing.Dts.DtsDbExternalAccessMethodImpl
...
internal class DtsDbExternalAccessMethodImpl : 
  MappedObject,
  DtsDbExternalAccessMethod,
  ...
  DtsObject
{
  ...
  ~DtsDbExternalAccessMethodImpl() => this.Dispose(false);
  ...
  public string Method
  {
    get
    {
      ...
      IntPtr method = CSWrap.CSNIDTS_DtsDbExternalAccessMethod_getMethod(this.Handle, out returnValue);
      if (method != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(method);
