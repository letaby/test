...
// Type: Softing.Dts.DtsDbDiagTroubleCodeConnectorImpl
...
internal class DtsDbDiagTroubleCodeConnectorImpl : 
  MappedObject,
  DtsDbDiagTroubleCodeConnector,
  ...
  DtsObject
{
  ...
  public DtsDbDiagTroubleCodeConnectorImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbDiagTroubleCodeConnectorImpl() => this.Dispose(false);
  ...
  public MCDDbDiagTroubleCode DbDiagTroubleCode
  {
    get
    {
      ...
      IntPtr dbDiagTroubleCode = CSWrap.CSNIDTS_DtsDbDiagTroubleCodeConnector_getDbDiagTroubleCode(this.Handle, out returnValue);
      if (dbDiagTroubleCode != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbDiagTroubleCode);
  ...
  public MCDDbFaultMemory DbFaultMemory
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbFaultMemory = CSWrap.CSNIDTS_DtsDbDiagTroubleCodeConnector_getDbFaultMemory(this.Handle, out returnValue);
      if (dbFaultMemory != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbFaultMemory);
