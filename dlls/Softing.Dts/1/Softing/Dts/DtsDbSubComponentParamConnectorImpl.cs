...
// Type: Softing.Dts.DtsDbSubComponentParamConnectorImpl
...
internal class DtsDbSubComponentParamConnectorImpl : 
  MappedObject,
  DtsDbSubComponentParamConnector,
  ...
  DtsObject
{
  ...
  ~DtsDbSubComponentParamConnectorImpl() => this.Dispose(false);
  ...
  public MCDDbDiagComPrimitive DbDiagComPrimitive
  {
    get
    {
      ...
      IntPtr diagComPrimitive = CSWrap.CSNIDTS_DtsDbSubComponentParamConnector_getDbDiagComPrimitive(this.Handle, out returnValue);
  ...
  public MCDDbRequestParameters DbSubComponentInParams
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr componentInParams = CSWrap.CSNIDTS_DtsDbSubComponentParamConnector_getDbSubComponentInParams(this.Handle, out returnValue);
      if (componentInParams != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(componentInParams);
  ...
  public MCDDbResponseParameters DbSubComponentOutParams
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr componentOutParams = CSWrap.CSNIDTS_DtsDbSubComponentParamConnector_getDbSubComponentOutParams(this.Handle, out returnValue);
      if (componentOutParams != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(componentOutParams);
