...
// Type: Softing.Dts.DtsDbAdditionalAudienceImpl
...
internal class DtsDbAdditionalAudienceImpl : 
  MappedObject,
  DtsDbAdditionalAudience,
  ...
  DtsObject
{
  ...
  ~DtsDbAdditionalAudienceImpl() => this.Dispose(false);
