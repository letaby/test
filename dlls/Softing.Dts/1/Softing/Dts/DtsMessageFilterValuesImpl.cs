...
// Type: Softing.Dts.DtsMessageFilterValuesImpl
...
internal class DtsMessageFilterValuesImpl : 
  MappedObject,
  DtsMessageFilterValues,
  ...
  DtsObject
{
  ...
  ~DtsMessageFilterValuesImpl() => this.Dispose(false);
  ...
  public void Remove(MCDValue filterValue)
  {
    ...
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsMessageFilterValues_remove(this.Handle, DTS_ObjectMapper.getHandle(filterValue as MappedObject));
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsMessageFilterValues_removeAll(this.Handle);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsMessageFilterValues_removeByIndex(this.Handle, index);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsMessageFilterValues_add(this.Handle, DTS_ObjectMapper.getHandle(filterValue as MappedObject));
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  {
    return (IEnumerator) new DtsMessageFilterValuesImpl.DtsMessageFilterValuesEnumerator(this);
  }
