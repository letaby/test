...
// Type: Softing.Dts.DtsDbFunctionalClassImpl
...
internal class DtsDbFunctionalClassImpl : 
  MappedObject,
  DtsDbFunctionalClass,
  ...
  DtsObject
{
  ...
  ~DtsDbFunctionalClassImpl() => this.Dispose(false);
  ...
  public MCDDbLocation DbLocation
  {
    get
    {
      ...
      IntPtr dbLocation = CSWrap.CSNIDTS_DtsDbFunctionalClass_getDbLocation(this.Handle, out returnValue);
  ...
  public MCDDbDataPrimitives DbDataPrimitives
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbDataPrimitives = CSWrap.CSNIDTS_DtsDbFunctionalClass_getDbDataPrimitives(this.Handle, out returnValue);
