...
// Type: Softing.Dts.DtsShareExceptionImpl
...
internal class DtsShareExceptionImpl : DtsShareException
{
  protected IntPtr m_dtsHandle = IntPtr.Zero;

  public DtsShareExceptionImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsShareExceptionImpl() => this.Dispose(false);
