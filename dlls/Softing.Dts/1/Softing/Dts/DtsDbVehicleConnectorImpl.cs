...
// Type: Softing.Dts.DtsDbVehicleConnectorImpl
...
internal class DtsDbVehicleConnectorImpl : 
  MappedObject,
  DtsDbVehicleConnector,
  ...
  DtsObject
{
  ...
  public DtsDbVehicleConnectorImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbVehicleConnectorImpl() => this.Dispose(false);
  ...
  public MCDDbVehicleConnectorPins DbVehicleConnectorPins
  {
    get
    {
      ...
      IntPtr vehicleConnectorPins = CSWrap.CSNIDTS_DtsDbVehicleConnector_getDbVehicleConnectorPins(this.Handle, out returnValue);
