...
// Type: Softing.Dts.DtsDbPhysicalVehicleLinkImpl
...
internal class DtsDbPhysicalVehicleLinkImpl : 
  MappedObject,
  DtsDbPhysicalVehicleLink,
  ...
  DtsObject
{
  ...
  public DtsDbPhysicalVehicleLinkImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbPhysicalVehicleLinkImpl() => this.Dispose(false);
  ...
  public MCDDbVehicleConnectorPins DbVehicleConnectorPins
  {
    get
    {
      ...
      IntPtr vehicleConnectorPins = CSWrap.CSNIDTS_DtsDbPhysicalVehicleLink_getDbVehicleConnectorPins(this.Handle, out returnValue);
  ...
  public string Type
  {
    get
    {
      ...
      IntPtr type = CSWrap.CSNIDTS_DtsDbPhysicalVehicleLink_getType(this.Handle, out returnValue);
      if (type != IntPtr.Zero)
