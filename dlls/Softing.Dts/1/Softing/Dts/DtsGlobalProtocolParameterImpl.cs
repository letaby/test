...
// Type: Softing.Dts.DtsGlobalProtocolParameterImpl
...
internal class DtsGlobalProtocolParameterImpl : 
  MappedObject,
  DtsGlobalProtocolParameter,
  DtsRequestParameter,
  MCDRequestParameter,
  MCDParameter,
  MCDNamedObject,
  ...
  DtsObject
{
  ...
  ~DtsGlobalProtocolParameterImpl() => this.Dispose(false);
  ...
  public bool Active
  {
    get
    {
      ...
      bool returnValue;
      IntPtr active = CSWrap.CSNIDTS_DtsGlobalProtocolParameter_getActive(this.Handle, out returnValue);
      if (active != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(active);
      return returnValue;
    }
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsGlobalProtocolParameter_setActive(this.Handle, value);
  ...
  public MCDRequestParameters Parameters
  {
    get
    {
      ...
      IntPtr parameters = CSWrap.CSNIDTS_DtsRequestParameter_getParameters(this.Handle, out returnValue);
  ...
  public MCDValue CreateValue()
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsRequestParameter_createValue(this.Handle, out returnValue);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  ...
  {
    GC.KeepAlive((object) this);
    IntPtr objectHandle = CSWrap.CSNIDTS_DtsRequestParameter_addParameters(this.Handle, count);
    if (objectHandle != IntPtr.Zero)
      throw DTS_ObjectMapper.createException(objectHandle);
  }
  ...
  public MCDValue ValueUnchecked
  {
    ...
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsRequestParameter_setValueUnchecked(this.Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
  ...
  public MCDRequestParameter LengthKey
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr lengthKey = CSWrap.CSNIDTS_DtsRequestParameter_getLengthKey(this.Handle, out returnValue);
      if (lengthKey != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(lengthKey);
      return (MCDRequestParameter) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsRequestParameter);
    }
  }
  ...
  public bool IsVariableLength
  {
    get
    {
      GC.KeepAlive((object) this);
      bool returnValue;
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsRequestParameter_isVariableLength(this.Handle, out returnValue);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
      return returnValue;
    }
  ...
  public MCDValue ValuePDUConform
  {
    ...
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsRequestParameter_setValuePDUConform(this.Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
