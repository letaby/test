...
// Type: Softing.Dts.DtsReadDiagComPrimitivesImpl
...
internal class DtsReadDiagComPrimitivesImpl : 
  MappedObject,
  DtsReadDiagComPrimitives,
  ...
  DtsObject
{
  ...
  public DtsReadDiagComPrimitivesImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsReadDiagComPrimitivesImpl() => this.Dispose(false);
  ...
  public MCDDiagComPrimitive GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsReadDiagComPrimitives_getItemByIndex(this.Handle, index, out returnValue);
  ...
  {
    return (IEnumerator) new DtsReadDiagComPrimitivesImpl.DtsReadDiagComPrimitivesEnumerator(this);
  }

  private class DtsReadDiagComPrimitivesEnumerator : IEnumerator
  {
    private DtsReadDiagComPrimitivesImpl m_classList;
    private int m_index;

    public DtsReadDiagComPrimitivesEnumerator(DtsReadDiagComPrimitivesImpl classList)
    {
