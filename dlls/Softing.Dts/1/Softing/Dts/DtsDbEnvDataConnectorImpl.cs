...
// Type: Softing.Dts.DtsDbEnvDataConnectorImpl
...
internal class DtsDbEnvDataConnectorImpl : 
  MappedObject,
  DtsDbEnvDataConnector,
  ...
  DtsObject
{
  ...
  public DtsDbEnvDataConnectorImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbEnvDataConnectorImpl() => this.Dispose(false);
  ...
  public MCDDbResponseParameter DbEnvData
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbEnvData = CSWrap.CSNIDTS_DtsDbEnvDataConnector_getDbEnvData(this.Handle, out returnValue);
      if (dbEnvData != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbEnvData);
  ...
  public MCDDbEnvDataDesc DbEnvDataDesc
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbEnvDataDesc = CSWrap.CSNIDTS_DtsDbEnvDataConnector_getDbEnvDataDesc(this.Handle, out returnValue);
      if (dbEnvDataDesc != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbEnvDataDesc);
