...
// Type: Softing.Dts.DtsDbSystemItemImpl
...
internal class DtsDbSystemItemImpl : 
  MappedObject,
  DtsDbSystemItem,
  MCDDbSystemItem,
  ...
  DtsObject
{
  ...
  ~DtsDbSystemItemImpl() => this.Dispose(false);
  ...
  public string SystemParameterName
  {
    get
    {
      ...
      IntPtr systemParameterName = CSWrap.CSNIDTS_DtsDbSystemItem_getSystemParameterName(this.Handle, out returnValue);
      if (systemParameterName != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(systemParameterName);
