  ...
  DtsObject
{
  ...
  public DtsDelayImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDelayImpl() => this.Dispose(false);
  ...
  public uint TimeDelay
  {
    get
    {
      ...
      uint returnValue;
      IntPtr timeDelay = CSWrap.CSNIDTS_DtsDelay_getTimeDelay(this.Handle, out returnValue);
      if (timeDelay != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(timeDelay);
      return returnValue;
    }
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDelay_setTimeDelay(this.Handle, value);
