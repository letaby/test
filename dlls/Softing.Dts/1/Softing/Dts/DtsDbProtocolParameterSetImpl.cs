...
// Type: Softing.Dts.DtsDbProtocolParameterSetImpl
...
internal class DtsDbProtocolParameterSetImpl : 
  MappedObject,
  DtsDbProtocolParameterSet,
  ...
  DtsObject
{
  ...
  ~DtsDbProtocolParameterSetImpl() => this.Dispose(false);
