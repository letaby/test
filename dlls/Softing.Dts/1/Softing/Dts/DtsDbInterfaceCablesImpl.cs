...
// Type: Softing.Dts.DtsDbInterfaceCablesImpl
...
internal class DtsDbInterfaceCablesImpl : 
  MappedObject,
  DtsDbInterfaceCables,
  ...
  DtsObject
{
  ...
  ~DtsDbInterfaceCablesImpl() => this.Dispose(false);
  ...
  public MCDDbInterfaceCable GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbInterfaceCables_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbInterfaceCable GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbInterfaceCables_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbInterfaceCable[] array = new MCDDbInterfaceCable[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbInterfaceCablesImpl.DtsDbInterfaceCablesEnumerator(this);
  }
