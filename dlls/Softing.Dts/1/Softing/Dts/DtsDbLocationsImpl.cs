...
// Type: Softing.Dts.DtsDbLocationsImpl
...
internal class DtsDbLocationsImpl : 
  MappedObject,
  DtsDbLocations,
  MCDDbLocations,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbLocationsImpl() => this.Dispose(false);
  ...
  public MCDDbLocation GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbLocations_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbLocation GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbLocations_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbLocation[] array = new MCDDbLocation[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbLocationsImpl.DtsDbLocationsEnumerator(this);
  }
