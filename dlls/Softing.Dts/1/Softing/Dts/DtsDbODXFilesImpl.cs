...
// Type: Softing.Dts.DtsDbODXFilesImpl
...
internal class DtsDbODXFilesImpl : 
  MappedObject,
  DtsDbODXFiles,
  DtsNamedCollection,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbODXFilesImpl() => this.Dispose(false);
  ...
  public DtsDbODXFile GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbODXFiles_getItemByIndex(this.Handle, index, out returnValue);
  ...
  {
    DtsDbODXFile[] array = new DtsDbODXFile[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbODXFilesImpl.DtsDbODXFilesEnumerator(this);
  }
