...
// Type: Softing.Dts.ConfigurationRecordLoadedArgs
...
public class ConfigurationRecordLoadedArgs : EventArgs
{
  ...
  {
    this.m_configurationRecord = configurationRecord;
  }

  public MCDConfigurationRecord ConfigurationRecord => this.m_configurationRecord;
}
