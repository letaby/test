...
// Type: Softing.Dts.DtsDbDiagVariablesImpl
...
internal class DtsDbDiagVariablesImpl : 
  MappedObject,
  DtsDbDiagVariables,
  DtsNamedCollection,
  MCDNamedCollection,
  ...
  DtsObject
{
  ...
  ~DtsDbDiagVariablesImpl() => this.Dispose(false);
  ...
  public DtsDbDiagVariable GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbDiagVariables_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public DtsDbDiagVariable GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbDiagVariables_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    DtsDbDiagVariable[] array = new DtsDbDiagVariable[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbDiagVariablesImpl.DtsDbDiagVariablesEnumerator(this);
  }
