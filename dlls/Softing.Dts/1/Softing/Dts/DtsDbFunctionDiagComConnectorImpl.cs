...
// Type: Softing.Dts.DtsDbFunctionDiagComConnectorImpl
...
internal class DtsDbFunctionDiagComConnectorImpl : 
  MappedObject,
  DtsDbFunctionDiagComConnector,
  ...
  DtsObject
{
  ...
  public DtsDbFunctionDiagComConnectorImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbFunctionDiagComConnectorImpl() => this.Dispose(false);
  ...
  public MCDDbDiagComPrimitive DbDiagComPrimitive
  {
    get
    {
      ...
      IntPtr diagComPrimitive = CSWrap.CSNIDTS_DtsDbFunctionDiagComConnector_getDbDiagComPrimitive(this.Handle, out returnValue);
  ...
  public MCDDbLogicalLink DbLogicalLink
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbLogicalLink = CSWrap.CSNIDTS_DtsDbFunctionDiagComConnector_getDbLogicalLink(this.Handle, out returnValue);
      if (dbLogicalLink != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dbLogicalLink);
