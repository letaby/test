...
// Type: Softing.Dts.DtsDynIdDefineComPrimitiveImpl
...
internal class DtsDynIdDefineComPrimitiveImpl : 
  MappedObject,
  DtsDynIdDefineComPrimitive,
  ...
  DtsObject
{
  ...
  ~DtsDynIdDefineComPrimitiveImpl() => this.Dispose(false);
  ...
  public string[] DynIdParams
  {
    set
    {
      ...
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDynIdDefineComPrimitive_setDynIdParams(this.Handle, ref _paramnames);
  ...
  public MCDValue DynId
  {
    get
    {
      ...
      IntPtr dynId = CSWrap.CSNIDTS_DtsDynIdDefineComPrimitive_getDynId(this.Handle, out returnValue);
      if (dynId != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(dynId);
      return (MCDValue) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValue);
    }
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDynIdDefineComPrimitive_setDynId(this.Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
  ...
  public string DefinitionMode
  {
    get
    {
      ...
      IntPtr definitionMode = CSWrap.CSNIDTS_DtsDynIdDefineComPrimitive_getDefinitionMode(this.Handle, out returnValue);
      if (definitionMode != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(definitionMode);
      return returnValue.makeString();
    }
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsDynIdDefineComPrimitive_setDefinitionMode(this.Handle, value);
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
