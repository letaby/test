...
// Type: Softing.Dts.LinkActivityStateIdleArgs
...
public class LinkActivityStateIdleArgs : EventArgs
{
  private MCDLogicalLink m_link;
  private MCDLogicalLinkState m_linkstate;

  public LinkActivityStateIdleArgs(MCDLogicalLink link, MCDLogicalLinkState linkstate)
  {
    this.m_link = link;
