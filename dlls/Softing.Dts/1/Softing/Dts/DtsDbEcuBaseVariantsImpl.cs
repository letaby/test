...
// Type: Softing.Dts.DtsDbEcuBaseVariantsImpl
...
internal class DtsDbEcuBaseVariantsImpl : 
  MappedObject,
  DtsDbEcuBaseVariants,
  ...
  DtsObject
{
  ...
  ~DtsDbEcuBaseVariantsImpl() => this.Dispose(false);
  ...
  public MCDDbEcuBaseVariant GetItemByIndex(uint index)
  {
    ...
    IntPtr itemByIndex = CSWrap.CSNIDTS_DtsDbEcuBaseVariants_getItemByIndex(this.Handle, index, out returnValue);
  ...
  public MCDDbEcuBaseVariant GetItemByName(string name)
  {
    GC.KeepAlive((object) this);
    ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
    IntPtr itemByName = CSWrap.CSNIDTS_DtsDbEcuBaseVariants_getItemByName(this.Handle, name, out returnValue);
  ...
  {
    MCDDbEcuBaseVariant[] array = new MCDDbEcuBaseVariant[(int) this.Count];
    for (uint index = 0; index < this.Count; ++index)
  ...
  {
    return (IEnumerator) new DtsDbEcuBaseVariantsImpl.DtsDbEcuBaseVariantsEnumerator(this);
  }
