...
// Type: Softing.Dts.DtsDbRequestImpl
...
internal class DtsDbRequestImpl : 
  MappedObject,
  DtsDbRequest,
  MCDDbRequest,
  MCDDbObject,
  ...
  DtsObject
{
  ...
  public DtsDbRequestImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsDbRequestImpl() => this.Dispose(false);
  ...
  public MCDValue DefaultPDU
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr defaultPdu = CSWrap.CSNIDTS_DtsDbRequest_getDefaultPDU(this.Handle, out returnValue);
      if (defaultPdu != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(defaultPdu);
      return (MCDValue) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValue);
    }
  }

  public ushort PDUMinLength
  {
    get
    {
      GC.KeepAlive((object) this);
      ushort returnValue;
      IntPtr pduMinLength = CSWrap.CSNIDTS_DtsDbRequest_getPDUMinLength(this.Handle, out returnValue);
      if (pduMinLength != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(pduMinLength);
      return returnValue;
    }
  }

  public ushort PDUMaxLength
  {
    get
    {
      GC.KeepAlive((object) this);
      ushort returnValue;
      IntPtr pduMaxLength = CSWrap.CSNIDTS_DtsDbRequest_getPDUMaxLength(this.Handle, out returnValue);
      if (pduMaxLength != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(pduMaxLength);
      return returnValue;
    }
  }

  public MCDDbRequestParameters DbRequestParameters
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr requestParameters = CSWrap.CSNIDTS_DtsDbRequest_getDbRequestParameters(this.Handle, out returnValue);
  ...
  public MCDDbSpecialDataGroups DbSDGs
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr dbSdGs = CSWrap.CSNIDTS_DtsDbRequest_getDbSDGs(this.Handle, out returnValue);
