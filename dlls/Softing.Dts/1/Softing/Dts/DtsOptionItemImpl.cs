...
// Type: Softing.Dts.DtsOptionItemImpl
...
internal class DtsOptionItemImpl : 
  MappedObject,
  DtsOptionItem,
  MCDOptionItem,
  ...
  DtsObject
{
  ...
  public DtsOptionItemImpl(IntPtr handle)
  {
    this.Handle = handle;
  ...
  ~DtsOptionItemImpl() => this.Dispose(false);
  ...
  public ushort DecimalPlaces
  {
    get
    {
      ...
      ushort returnValue;
      IntPtr decimalPlaces = CSWrap.CSNIDTS_DtsOptionItem_getDecimalPlaces(this.Handle, out returnValue);
  ...
  public MCDDbItemValue MatchingDbItemValue
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr matchingDbItemValue = CSWrap.CSNIDTS_DtsOptionItem_getMatchingDbItemValue(this.Handle, out returnValue);
      if (matchingDbItemValue != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(matchingDbItemValue);
      return (MCDDbItemValue) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsDbItemValue);
    }
  }

  public MCDDbItemValue ItemValueByDbObject
  {
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsOptionItem_setItemValueByDbObject(this.Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }

  public MCDValue ItemValueDts
  {
    get
    {
      GC.KeepAlive((object) this);
      ObjectInfo_Struct returnValue = new ObjectInfo_Struct();
      IntPtr itemValueDts = CSWrap.CSNIDTS_DtsOptionItem_getItemValueDts(this.Handle, out returnValue);
      if (itemValueDts != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(itemValueDts);
      return (MCDValue) (DTS_ObjectMapper.createObject(returnValue.m_handle, returnValue.m_type) as DtsValue);
    }
    set
    {
      GC.KeepAlive((object) this);
      IntPtr objectHandle = CSWrap.CSNIDTS_DtsOptionItem_setItemValueDts(this.Handle, DTS_ObjectMapper.getHandle(value as MappedObject));
      if (objectHandle != IntPtr.Zero)
        throw DTS_ObjectMapper.createException(objectHandle);
    }
  }
