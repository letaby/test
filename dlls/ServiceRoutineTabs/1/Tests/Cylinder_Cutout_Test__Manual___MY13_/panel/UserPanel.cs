...
// Type: DetroitDiesel.ServiceRoutineTabs.Tests.Cylinder_Cutout_Test__Manual___MY13_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void UpdateUserInterface()
  {
    ...
    {
      ((Control) this.tableLayoutPanelTMMode).Visible = false;
    }
    else
    {
  ...
  private void OnStopTM5ModeClick(object sender, EventArgs e) => this.SetTmModeFunction(0);
  ...
  {
    if (!this.CanSetTmMode || !WarningManager.RequestContinue())
      return;
    if (this.setTmMode != (Service) null)
    {
  ...
  private bool CanSetTmMode => this.Online && this.setTmMode != (Service) null;
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.tableLayoutPanelTMMode, 0, 3);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.digitalReadoutInstrument5, 4, 1);
    ...
    ((TableLayoutPanel) this.tableLayoutPanelTMMode).Controls.Add((Control) this.buttonSetTM5Mode, 1, 0);
    ((TableLayoutPanel) this.tableLayoutPanelTMMode).Controls.Add((Control) this.buttonStopTM5Mode, 2, 0);
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS190_Thermomanagement_status");
