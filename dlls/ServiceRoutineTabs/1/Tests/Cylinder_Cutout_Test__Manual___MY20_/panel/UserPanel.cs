...
// Type: DetroitDiesel.ServiceRoutineTabs.Tests.Cylinder_Cutout_Test__Manual___MY20_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private Service setTmMode = (Service) null;
  private bool setTm5Mode = true;
  private bool stopTm5Mode = false;
  private int OriginalTmMode = 0;
  ...
  private DigitalReadoutInstrument digitalReadoutInstrumentTmMode;
  ...
  public UserPanel()
  {
    ...
    this.buttonSetTM5Mode.Click += new EventHandler(this.OnSetTM5ModeClick);
    this.buttonStopTM5Mode.Click += new EventHandler(this.OnStopTM5ModeClick);
  ...
  private int MinIdleSpeed
  {
    get
    {
      ...
      switch (((EquipmentType) ref equipmentType).Name)
      {
        case "DD5":
          return 800;
        case "DD8":
  ...
  public virtual void OnChannelsChanged()
  {
    ...
    this.idleSpeedSetRoutine = SapiManager.GetSetEngineSpeedService(SapiManager.GlobalInstance.ActiveChannels, new string[0]);
    this.idleSpeedResetRoutine = SapiManager.GetCancelSetEngineSpeedService(SapiManager.GlobalInstance.ActiveChannels);
  }
  ...
  private void SetMCM(Channel mcm)
  {
    ...
    if (this.mcm != null)
    {
      ...
      this.setTmMode = this.mcm.Services["RT_SR09A_Force_TMC_to_TMx_Mode_Start"];
    }
  }

  private void UpdateUserInterface()
  {
    this.buttonSetTM5Mode.Enabled = this.CanSetTm5Mode;
    this.buttonStopTM5Mode.Enabled = this.CanStopTm5Mode;
    foreach (Control onButton in this.onButtons)
      onButton.Enabled = this.CanTurnCylinderOnOrOff;
    foreach (Control offButton in this.offButtons)
      offButton.Enabled = this.CanTurnCylinderOnOrOff;
  ...
  {
    this.SwitchCylinder(Convert.ToInt32((sender as Button).Tag, (IFormatProvider) CultureInfo.InvariantCulture), true);
  }

  private void OnCylinderOffClick(object sender, EventArgs e)
  {
    this.SwitchCylinder(Convert.ToInt32((sender as Button).Tag, (IFormatProvider) CultureInfo.InvariantCulture), false);
  }
  ...
  private void OnSetTM5ModeClick(object sender, EventArgs e) => this.SetTmModeFunction(5);

  private void OnStopTM5ModeClick(object sender, EventArgs e)
  {
    this.SetTmModeFunction(this.OriginalTmMode);
  }

  private void digitalReadoutInstrumentTmMode_RepresentedStateChanged(object sender, EventArgs e)
  {
    this.UpdateUserInterface();
  }
  ...
  private void SwitchCylinder(int number, bool on)
  {
    ...
    if (service != (Service) null)
    {
      ...
      if (on)
        this.ReportResult(string.Format((IFormatProvider) CultureInfo.CurrentCulture, Resources.MessageFormat_EnablingCylinder0, (object) number), false);
      else
        this.ReportResult(string.Format((IFormatProvider) CultureInfo.CurrentCulture, Resources.MessageFormat_CuttingCylinder0, (object) number), false);
  ...
  private void SetIdleSpeed()
  {
    if (!this.CanApply || !WarningManager.RequestContinue())
      return;
    Service service = ((ServiceCall) ref this.idleSpeedSetRoutine).GetService();
    if (service != (Service) null)
    {
  ...
  private void ResetIdleSpeed()
  {
    if (!this.CanReset || !WarningManager.RequestContinue())
      return;
    Service service = ((ServiceCall) ref this.idleSpeedResetRoutine).GetService();
    if (service != (Service) null)
    {
      service.ServiceCompleteEvent += new ServiceCompleteEventHandler(this.OnServiceCompleteEvent);
      this.ReportResult(Resources.Message_ResettingIdleSpeed, false);
      service.Execute(false);
      this.IdleSpeed = this.MinIdleSpeed;
    }
    else
      this.ReportResult(Resources.Message_ErrorCouldNotFindService, true);
  }
  ...
  private void SetTmModeFunction(int mode)
  {
    if (!this.Online)
      return;
    if (this.setTmMode != (Service) null)
    {
      this.setTmMode.ServiceCompleteEvent += new ServiceCompleteEventHandler(this.OnServiceCompleteEvent);
      this.setTmMode.InputValues[0].Value = (object) this.setTmMode.InputValues[0].Choices.GetItemFromRawValue((object) mode);
      if (mode == 5)
      {
        this.OriginalTmMode = Convert.ToInt32(this.mcm.Instruments["DT_AS190_Thermomanagement_status"].InstrumentValues.Current.Value);
        this.ReportResult(Resources.MessgeFormat_SettingTmModeActive, false);
        this.stopTm5Mode = true;
        this.setTm5Mode = false;
      }
      else
      {
        this.ReportResult(Resources.MessageFormat_StoppingTmMode, false);
        this.setTm5Mode = true;
        this.stopTm5Mode = false;
      }
      this.setTmMode.Execute(false);
    }
    else
      this.ReportResult(Resources.Message_ErrorCouldNotFindService, true);
  }
  ...
  private bool ValidIdleSpeed
  {
    get
    {
      ...
      int idleSpeed = this.IdleSpeed;
      if (idleSpeed >= this.MinIdleSpeed && idleSpeed <= 1000)
        validIdleSpeed = true;
  ...
  private int IdleSpeed
  {
    ...
    set
    {
      if (value < this.MinIdleSpeed)
        value = this.MinIdleSpeed;
      else if (value > 1000)
        value = 1000;
  ...
  private bool CanDecrement
  {
    ...
    {
      int idleSpeed = this.IdleSpeed;
      return this.Online && (idleSpeed > this.MinIdleSpeed || idleSpeed == -1);
    }
  }
  ...
  private bool CanTurnCylinderOnOrOff
  {
    get
    {
      return this.Online && this.stopTm5Mode && this.digitalReadoutInstrumentTmMode.RepresentedState == 1;
    }
  }

  private bool CanTurnAllCylindersOn => this.Online;

  private bool CanSetTm5Mode => this.Online && this.setTmMode != (Service) null && this.setTm5Mode;

  private bool CanStopTm5Mode
  {
    get => this.Online && this.setTmMode != (Service) null && this.stopTm5Mode;
  }
  ...
  private void UpdateConnectedEquipmentType()
  {
    ...
    if (cylinderCount != this.CylinderCount)
    {
      ...
      ((Control) this.label7).Visible = this.cylinder5Off.Visible = this.cylinder5On.Visible = this.CylinderCount == 6;
      ((Control) this.label8).Visible = this.cylinder6Off.Visible = this.cylinder6On.Visible = this.CylinderCount == 6;
    }
    this.idleSpeedText.Text = this.MinIdleSpeed.ToString();
  }
  ...
  private void InitializeComponent()
  {
    ...
    this.tableLayoutPanelTMMode = new TableLayoutPanel();
    this.buttonSetTM5Mode = new Button();
    this.buttonStopTM5Mode = new Button();
    this.digitalReadoutInstrumentTmMode = new DigitalReadoutInstrument();
    ...
    ((Control) this.tableLayoutPanelTMMode).SuspendLayout();
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.digitalReadoutInstrumentTmMode, 4, 1);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.tableLayoutPanelTMMode, 0, 2);
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_DS019_Vehicle_Check_Status");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS013_Coolant_Temperature");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS010_Engine_Speed");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS003_Actual_Torque");
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).SetColumnSpan((Control) this.chartInstrument, 5);
    componentResourceManager.ApplyResources((object) this.chartInstrument, "chartInstrument");
    ((Collection<Qualifier>) this.chartInstrument.Instruments).Add(new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS003_Actual_Torque"));
    ...
    ((TableLayoutPanel) this.tableLayoutPanel2).Controls.Add((Control) this.buttonIdleSpeedReset, 6, 1);
    ...
    this.idleSpeedText.ReadOnly = true;
    ...
    ((TableLayoutPanel) this.tableLayoutPanel2).SetColumnSpan((Control) this.buttonIdleSpeedReset, 2);
    ...
    componentResourceManager.ApplyResources((object) this.tableLayoutPanelTMMode, "tableLayoutPanelTMMode");
    ((TableLayoutPanel) this.tableLayoutPanel1).SetColumnSpan((Control) this.tableLayoutPanelTMMode, 5);
    ((TableLayoutPanel) this.tableLayoutPanelTMMode).Controls.Add((Control) this.buttonSetTM5Mode, 0, 0);
    ((TableLayoutPanel) this.tableLayoutPanelTMMode).Controls.Add((Control) this.buttonStopTM5Mode, 1, 0);
    ((TableLayoutPanel) this.tableLayoutPanelTMMode).Controls.Add((Control) this.label9, 2, 0);
    ((Control) this.tableLayoutPanelTMMode).Name = "tableLayoutPanelTMMode";
    componentResourceManager.ApplyResources((object) this.buttonSetTM5Mode, "buttonSetTM5Mode");
    this.buttonSetTM5Mode.Name = "buttonSetTM5Mode";
    this.buttonSetTM5Mode.UseCompatibleTextRendering = true;
    this.buttonSetTM5Mode.UseVisualStyleBackColor = true;
    componentResourceManager.ApplyResources((object) this.buttonStopTM5Mode, "buttonStopTM5Mode");
    this.buttonStopTM5Mode.Name = "buttonStopTM5Mode";
    this.buttonStopTM5Mode.UseCompatibleTextRendering = true;
    this.buttonStopTM5Mode.UseVisualStyleBackColor = true;
    componentResourceManager.ApplyResources((object) this.digitalReadoutInstrumentTmMode, "digitalReadoutInstrumentTmMode");
    this.digitalReadoutInstrumentTmMode.FontGroup = (string) null;
    ((SingleInstrumentBase) this.digitalReadoutInstrumentTmMode).FreezeValue = false;
    this.digitalReadoutInstrumentTmMode.Gradient.Initialize((ValueState) 2, 2);
    this.digitalReadoutInstrumentTmMode.Gradient.Modify(1, 5.0, (ValueState) 1);
    this.digitalReadoutInstrumentTmMode.Gradient.Modify(2, 6.0, (ValueState) 2);
    ((SingleInstrumentBase) this.digitalReadoutInstrumentTmMode).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS190_Thermomanagement_status");
    ((Control) this.digitalReadoutInstrumentTmMode).Name = "digitalReadoutInstrumentTmMode";
    ((SingleInstrumentBase) this.digitalReadoutInstrumentTmMode).UnitAlignment = StringAlignment.Near;
    this.digitalReadoutInstrumentTmMode.RepresentedStateChanged += new EventHandler(this.digitalReadoutInstrumentTmMode_RepresentedStateChanged);
    ...
    ((Control) this.tableLayoutPanelTMMode).ResumeLayout(false);
