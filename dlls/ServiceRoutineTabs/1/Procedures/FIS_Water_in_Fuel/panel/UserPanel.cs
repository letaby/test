...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.FIS_Water_in_Fuel.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  public virtual void OnChannelsChanged() => this.SetChannel(this.GetActiveChannel("MCM02T"));
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentFuelDensity).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS087_Actual_Fuel_Mass");
    ...
    ((SingleInstrumentBase) this.digitalReadoutIgnitionCycle).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS047_Ignition_Cycle_Counter");
    ...
    ((SingleInstrumentBase) this.digitalReadoutEngineHours).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS045_Engine_Operating_Hours");
    ...
    ((SingleInstrumentBase) this.digitalReadoutWaterLifetimeCountInstrument).Instrument = new Qualifier((QualifierTypes) 4, "MCM02T", "e2p_l_water_raised_eng_hours");
    ...
    ((SingleInstrumentBase) this.digitalReadoutWaterLifetimeCountParameter).Instrument = new Qualifier((QualifierTypes) 4, "MCM02T", "e2p_l_water_raised_eng_starts");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 32 /*0x20*/, "MCM02T", "61000F");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes) 32 /*0x20*/, "MCM02T", "610010");
