...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.FIS_Fuel_Filter.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void OnFuelFilterResetServiceCompleteEvent(object sender, ResultEventArgs e)
  {
    ...
    if (service != (Service) null)
    {
      ...
      this.DisplayMessage(string.Format((IFormatProvider) CultureInfo.CurrentCulture, $"{Resources.MessageFormat_ValuesReset}\r\n{Resources.FuelFilterCalculationIs0Active0}", outputValue.Value == (object) outputValue.Choices.GetItemFromRawValue((object) 1) ? (object) string.Empty : (object) Resources.Message_Not));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentPFuelFilterAct).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS124_LPPO_Fuel_Pressure");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentFuelFilterState).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS125_Fuel_Filter_State");
