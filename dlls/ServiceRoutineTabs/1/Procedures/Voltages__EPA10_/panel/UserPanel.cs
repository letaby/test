...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.Voltages__EPA10_.panel.UserPanel
...
#nullable disable
namespace DetroitDiesel.ServiceRoutineTabs.Procedures.Voltages__EPA10_.panel;
...
public class UserPanel : CustomPanel
{
  ...
  {
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value0", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value1", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value4", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value5", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value6", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value7", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value8", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value2", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value4", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value5", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value8", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value9", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value10", set);
    this.SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value12", set);
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument10).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value12");
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.DigitalReadoutInstrument10, 1, 6);
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument23a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value0");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument20a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value8");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument17a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value6");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument7).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value5");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument53a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value7");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value2");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument14a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value5");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value8");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument2a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value4");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument43).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value1");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument11a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value4");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument5a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value9");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument8a).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value10");
