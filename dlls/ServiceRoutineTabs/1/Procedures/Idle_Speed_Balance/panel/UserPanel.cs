...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.Idle_Speed_Balance.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void UpdateTemperatureCheck()
  {
    ...
    else
    {
      ...
      if (!this.FuelTemperatureIsInRange)
        str += string.Format(Resources.MessageFormat_FuelTemperatureMustBeAtLeast0, (object) this.GetOkMinimumString(((AxisSingleInstrumentBase) this.fuelTemperatureInstrument).Gradient));
  ...
  private void HighlightValues()
  {
    ...
    for (int index1 = 0; index1 < keyValuePairList.Count; ++index1)
    {
      ...
      if (num1 > 99.5 || num1 < -99.5)
      {
        ...
        valueState = num2 <= 99.5 && num2 >= -99.5 ? (ValueState) 3 : (ValueState) 2;
      }
      keyValuePair = keyValuePairList[index1];
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).SetColumnSpan((Control) this.title, 5);
