...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.FIS_Fuel_Filter__Tier4_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentPFuelFilterAct).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS124_EU_Low_Fuel_Pressure");
