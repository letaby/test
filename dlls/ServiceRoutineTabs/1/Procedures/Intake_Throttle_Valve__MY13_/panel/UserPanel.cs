...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.Intake_Throttle_Valve__MY13_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private bool SetMCM(Channel mcm)
  {
    ...
    if (this.mcm != mcm)
    {
      ...
      {
        this.mcm.CommunicationsStateUpdateEvent += new CommunicationsStateUpdateEventHandler(this.OnChannelStateUpdate);
        this.engineSpeedInstrument = this.GetInstrument("MCM21T", "DT_AS010_Engine_Speed");
        if (this.engineSpeedInstrument != (Instrument) null)
          this.engineSpeedInstrument.InstrumentUpdateEvent += new InstrumentUpdateEventHandler(this.OnEngineSpeedUpdate);
      }
    }
  ...
  private void CommandValue()
  {
    if (!this.CanManipulate || !this.ValidCommandedValue)
      return;
    Service service = this.GetService("MCM21T", "RT_SR068_Control_IAT_Start_status");
  ...
  private void StopManipulation()
  {
    if (!this.CanStop)
      return;
    Service service = this.GetService("MCM21T", "RT_SR068_Control_IAT_Stop");
    if (service != (Service) null)
    {
      service.ServiceCompleteEvent += new ServiceCompleteEventHandler(this.OnServiceCompleteEvent);
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.itvActualInstrument).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS034_Throttle_Valve_Actual_Position");
    ...
    ((SingleInstrumentBase) this.vehicleCheckInstrument).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS010_Engine_Speed");
