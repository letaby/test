...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.Voltages___MBE4000.panel.UserPanel
...
#nullable disable
namespace DetroitDiesel.ServiceRoutineTabs.Procedures.Voltages___MBE4000.panel;
...
public class UserPanel : CustomPanel
{
  ...
  private void SetMarkedState(bool set)
  {
    ...
    this.SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value3", set);
    ...
    this.SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_ValueMBE", set);
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.digitalReadoutInstrument5, 0, 6);
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument10).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value3");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value1");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_ValueMBE");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value1");
