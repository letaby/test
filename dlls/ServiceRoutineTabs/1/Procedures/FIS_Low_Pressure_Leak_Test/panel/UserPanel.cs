...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.FIS_Low_Pressure_Leak_Test.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void SetPwmRoutineStart(
    ...
    int controlTime)
  {
    Service service = this.GetService("MCM02T", "RT_SR003_PWM_Routine_by_Function_for_Production_Start_Control_Value");
  ...
  {
    Service service = this.GetService("MCM02T", "RT_SR003_PWM_Routine_by_Function_for_Production_Stop_Function_Name");
  ...
  private void InitializeComponent()
  {
    ...
    this.seekTimeListView.RequiredUserLabelPrefix = "FIS Low Pressure Leak";
    ...
    ((Collection<Qualifier>) this.chartInstrument.Instruments).Add(new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS024_Fuel_Compensation_Pressure"));
    ...
    ((SingleInstrumentBase) this.fuelCompensationPressureInstrument).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS024_Fuel_Compensation_Pressure");
