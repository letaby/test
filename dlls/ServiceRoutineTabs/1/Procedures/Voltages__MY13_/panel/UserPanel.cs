...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.Voltages__MY13_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument10).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value12");
