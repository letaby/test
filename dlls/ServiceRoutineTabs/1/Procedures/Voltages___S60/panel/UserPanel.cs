...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.Voltages___S60.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private DigitalReadoutInstrument DigitalReadoutInstrument53;
  private DigitalReadoutInstrument DigitalReadoutInstrument22;
  ...
  private void SetMarkedState(bool set)
  {
    ...
    this.SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value2", set);
    this.SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value3", set);
    ...
    this.SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value1", set);
  ...
  private void InitializeComponent()
  {
    ...
    this.DigitalReadoutInstrument22 = new DigitalReadoutInstrument();
    this.DigitalReadoutInstrument53 = new DigitalReadoutInstrument();
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value3");
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.DigitalReadoutInstrument22, 0, 6);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.DigitalReadoutInstrument53, 1, 4);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.DigitalReadoutInstrument2, 1, 7);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.DigitalReadoutInstrument5, 1, 8);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.stop, 1, 9);
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value5");
    ...
    componentResourceManager.ApplyResources((object) this.DigitalReadoutInstrument22, "DigitalReadoutInstrument22");
    this.DigitalReadoutInstrument22.FontGroup = (string) null;
    ((SingleInstrumentBase) this.DigitalReadoutInstrument22).FreezeValue = false;
    ((SingleInstrumentBase) this.DigitalReadoutInstrument22).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value2");
    ((Control) this.DigitalReadoutInstrument22).Name = "DigitalReadoutInstrument22";
    ((SingleInstrumentBase) this.DigitalReadoutInstrument22).UnitAlignment = StringAlignment.Near;
    componentResourceManager.ApplyResources((object) this.DigitalReadoutInstrument53, "DigitalReadoutInstrument53");
    this.DigitalReadoutInstrument53.FontGroup = (string) null;
    ((SingleInstrumentBase) this.DigitalReadoutInstrument53).FreezeValue = false;
    ((SingleInstrumentBase) this.DigitalReadoutInstrument53).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value1");
    ((Control) this.DigitalReadoutInstrument53).Name = "DigitalReadoutInstrument53";
    ((SingleInstrumentBase) this.DigitalReadoutInstrument53).UnitAlignment = StringAlignment.Near;
