...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.FIS_Fuel_Quantity_Control_Valve.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private const string Fuel_Metering_Unit_FMU_Desired_Current_Qualifier = "DT_AS121_Quantity_Control_Valve_Desired_Current";
  private const string Quantity_Control_Valve_Current_Qualifier = "DT_AS100_Quantity_Control_Valve_Current";
  private const string Quantity_Control_Valve_Adaptation_Positive_Qualifier = "Quantity_Control_Valve_Adaptation_Positive";
  private const string Quantity_Control_Valve_Adaptation_Negative_Qualifier = "Quantity_Control_Valve_Adaptation_Negative";
  private const string CoolantTemperature_Qualifier = "DT_ASL005_Coolant_Temperature";
  private const string RailPressure_Qualifier = "DT_ASL001_Rail_Pressure";
  ...
  private void InitQualifiers()
  {
    ...
    {
      new Qualifier((QualifierTypes) 1, "MCM02T", "DT_ASL001_Rail_Pressure"),
      new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS122_Fuel_Metering_Unit_Stick_Diagnosis_State"),
      new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS123_Fuel_Metering_Unit_Diagnosis_Error_State")
    };
  }
  ...
  private void FmuStickTestPollStatusServiceCompleteEvent(object sender, ResultEventArgs e)
  {
    ...
    if (e.Succeeded)
    {
      ...
      {
        this.fmuTestRunning = true;
        this.FmuStickTestDisplayMessage(Resources.Message_TheFMUStickTestHasStarted0);
      }
      else if (outputValue.Value == (object) outputValue.Choices.GetItemFromRawValue((object) 2))
      {
        this.fmuTestRunning = true;
    ...
    ResultEventArgs e)
  {
    ...
    {
      this.scalingLabelFmuStickTestResult.RepresentedState = (ValueState) 2;
      ((Control) this.scalingLabelFmuStickTestResult).Text = string.Format(Resources.MessageFormat_FMUStickTestError02, (object) e.Exception.Message);
      this.FmuStickTestDisplayMessage(string.Format(Resources.MessageFormat_FMUStickTestError03, (object) e.Exception.Message));
    }
  }
  ...
  private void OnReadFMUAdaptationClick(object sender, EventArgs e) => this.ReadParameters();
  ...
  private void SetChannel(Channel channel)
  {
    ...
    if (this.channel != null)
    {
      ...
      this.instrumentEngineState = UserPanel.ConnectInstrument(this.channel.Instruments, "DT_ASL004_Engine_State", new InstrumentUpdateEventHandler(this.OnIgnitionUpdateEvent));
      this.instrumentEngineSpeed = UserPanel.ConnectInstrument(this.channel.Instruments, "DT_ASL002_Engine_Speed", new InstrumentUpdateEventHandler(this.OnIgnitionUpdateEvent));
      ...
      this.instrumentCoolantTemperature = UserPanel.ConnectInstrument(this.channel.Instruments, "DT_ASL005_Coolant_Temperature", new InstrumentUpdateEventHandler(this.OnInstrumentUpdateEvent));
      this.instrumentFuelTemperature = UserPanel.ConnectInstrument(this.channel.Instruments, "DT_ASL005_Fuel_Temperature", new InstrumentUpdateEventHandler(this.OnInstrumentUpdateEvent));
      this.instrumentRailPressure = UserPanel.ConnectInstrument(this.channel.Instruments, "DT_ASL001_Rail_Pressure", new InstrumentUpdateEventHandler(this.OnInstrumentUpdateEvent));
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentQuantity_Control_Valve_Adaptation_Positive).Instrument = new Qualifier((QualifierTypes) 4, "MCM02T", "Quantity_Control_Valve_Adaptation_Positive");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentQuantity_Control_Valve_Adaptation_Negative).Instrument = new Qualifier((QualifierTypes) 4, "MCM02T", "Quantity_Control_Valve_Adaptation_Negative");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentRailPressure).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS043_Rail_Pressure");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentFuelMass).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS087_Actual_Fuel_Mass");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentFuel_Metering_Unit_FMU_desired_current).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS121_Quantity_Control_Valve_Desired_Current");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentQuantity_Control_Valve_Current).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS100_Quantity_Control_Valve_Current");
