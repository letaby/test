...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.FIS_Fuel_Quantity_Control_Valve__MY13_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
    ...
    ResultEventArgs e)
  {
    ...
    if (e.Succeeded)
    {
      ...
      if (outputValue.Value == (object) outputValue.Choices.GetItemFromRawValue((object) 0))
      {
        ...
        ((Control) this.scalingLabelFmuStickTestResult).Text = Resources.Message_FMUIsNOTSticking;
      ...
      else if (outputValue.Value == (object) outputValue.Choices.GetItemFromRawValue((object) 1))
      {
        ...
        ((Control) this.scalingLabelFmuStickTestResult).Text = Resources.Message_FMUISSticking;
      ...
      else if (outputValue.Value == (object) outputValue.Choices.GetItemFromRawValue((object) (int) byte.MaxValue))
      {
        ...
        ((Control) this.scalingLabelFmuStickTestResult).Text = Resources.Message_FMUSignalIsNotAvailable;
        this.FmuStickTestDisplayMessage(Resources.Message_FMUSignalIsNotAvailable);
      }
      else
      {
        this.scalingLabelFmuStickTestResult.RepresentedState = (ValueState) 2;
        ((Control) this.scalingLabelFmuStickTestResult).Text = Resources.Message_FMUValueUnknown;
  ...
  private void FmuStickTestUpdateEngineStatus()
  {
    ...
    if (this.Online)
    {
      ...
      {
        stringBuilder1.Append("Ignition: ");
  ...
  private void FmuStickTestUpdateFaultConditions()
  {
    ...
    {
      ((Control) this.labelFmuStickTestFaultCodesStatus).Text = Resources.Message_Offline;
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentFuel_Metering_Unit_FMU_desired_current).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS121_Quantity_Control_Valve_Desired_Current");
