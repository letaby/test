...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.DPF_System__EPA10_.panel.Properties
...
{
  public virtual int FileVersion => 71;

  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Procedures\\DPF System (EPA10).panel";
    }
  }
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      return (IEnumerable<Qualifier>) new Qualifier[43]
      {
        ...
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_OverTheRoadRegen_EPA10"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_ParkedRegen_EPA10"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_DisableHcDoserParkedRegen_EPA10")
      };
    }
  }
