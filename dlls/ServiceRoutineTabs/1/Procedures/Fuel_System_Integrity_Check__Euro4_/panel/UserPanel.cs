...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.Fuel_System_Integrity_Check__Euro4_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private string AutomaticFsicTestInstrumentsReadyToStartTest(ref bool testCanStart)
  {
    ...
    else if (this.digitalReadoutInstrumentCoolantTemperature.RepresentedState == 3)
    {
      ...
      stringBuilder.AppendFormat((IFormatProvider) CultureInfo.CurrentCulture, Resources.MessageFormat_CannotStartBecauseTheCoolantTemperatureIs0, string.IsNullOrEmpty(minimumOkValueString) ? (object) Resources.Message_TooLow : (object) (Resources.Message_LessThan1 + minimumOkValueString));
    }
    else if (this.digitalReadoutInstrumentFuelTemperature.RepresentedState == 3)
    {
      ...
      stringBuilder.AppendFormat((IFormatProvider) CultureInfo.CurrentCulture, Resources.MessageFormat_CannotStartBecauseTheFuelTemperatureIs0, string.IsNullOrEmpty(minimumOkValueString) ? (object) Resources.Message_TooLow1 : (object) (Resources.Message_LessThan + minimumOkValueString));
    }
    else
    {
      testCanStart = true;
  ...
  private void WaitForEngineToStart()
  {
    switch (this.EngineStatus)
    {
      ...
      case UserPanel.EngineState.Idle:
        ...
        break;
      default:
        throw new InvalidOperationException(string.Format((IFormatProvider) CultureInfo.CurrentCulture, "Engine state not possible {0}.", (object) this.EngineStatus));
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentEngineSpeed).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS010_Engine_Speed");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentFuelCompensationPressure).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS124_Low_Pressure_Pump_Outlet_Pressure");
    ...
    this.comboBoxSelectTest.Items.AddRange(new object[2]
    {
