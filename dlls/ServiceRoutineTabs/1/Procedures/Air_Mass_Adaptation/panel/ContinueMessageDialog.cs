...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.Air_Mass_Adaptation.panel.ContinueMessageDialog
...
internal class ContinueMessageDialog
{
  ...
  public string LabelYes => this.labelYes;

  public string LabelNo => this.labelNo;
