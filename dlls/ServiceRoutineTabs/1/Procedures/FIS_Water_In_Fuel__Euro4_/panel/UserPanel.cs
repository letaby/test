...
// Type: DetroitDiesel.ServiceRoutineTabs.Procedures.FIS_Water_In_Fuel__Euro4_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  {
    this.ReadParameter(this.channel.Parameters["e2p_l_water_raised_eng_hours"]);
    this.ReadParameter(this.channel.Parameters["e2p_l_water_raised_eng_starts"]);
  }
  ...
  public virtual void OnChannelsChanged() => this.SetChannel(this.GetActiveChannel("MCM"));
  ...
  private void WaterInFuelReset()
  {
    ...
    if (service != (Service) null)
    {
      ...
      this.DisplayMessage(Resources.Message_ErrorCouldNotFindTheServiceRoutineRT_SR0AB_Reset_Water_In_Fuel_Values_Start);
  }
  ...
  private void OnResetServiceCompleteEvent(object sender, ResultEventArgs e)
  {
    if (this.channel != null)
    {
      ...
      {
        service.ServiceCompleteEvent -= new ServiceCompleteEventHandler(this.OnResetServiceCompleteEvent);
        this.DisplayMessage(Resources.Message_WaterInFuelRegistersHaveBeenReset0);
      }
    }
    this.ReadParameters();
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).Controls.Add((Control) this.digitalReadoutIgnitionCycle, 0, 2);
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).Controls.Add((Control) this.digitalReadoutEngineHours, 0, 1);
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).Controls.Add((Control) this.chartInstrument1, 2, 1);
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).Controls.Add((Control) this.buttonResetValues, 0, 7);
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).Controls.Add((Control) this.textBoxOutput, 0, 5);
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).Controls.Add((Control) this.digitalReadoutWaterLifetimeCountInstrument, 0, 3);
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).Controls.Add((Control) this.digitalReadoutWaterLifetimeCountParameter, 0, 4);
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentFuelDensity).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS087_Actual_Fuel_Mass");
    ...
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).SetColumnSpan((Control) this.digitalReadoutIgnitionCycle, 2);
    componentResourceManager.ApplyResources((object) this.digitalReadoutIgnitionCycle, "digitalReadoutIgnitionCycle");
    this.digitalReadoutIgnitionCycle.FontGroup = "tableLayoutPanelWholePanel";
    ((SingleInstrumentBase) this.digitalReadoutIgnitionCycle).FreezeValue = false;
    ((SingleInstrumentBase) this.digitalReadoutIgnitionCycle).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS047_Ignition_Cycle_Counter");
    ...
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).SetColumnSpan((Control) this.digitalReadoutEngineHours, 2);
    componentResourceManager.ApplyResources((object) this.digitalReadoutEngineHours, "digitalReadoutEngineHours");
    this.digitalReadoutEngineHours.FontGroup = "tableLayoutPanelWholePanel";
    ((SingleInstrumentBase) this.digitalReadoutEngineHours).FreezeValue = false;
    ((SingleInstrumentBase) this.digitalReadoutEngineHours).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS045_Engine_Operating_Hours");
    ...
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).SetRowSpan((Control) this.chartInstrument1, 7);
    ...
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).SetRowSpan((Control) this.textBoxOutput, 2);
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).SetColumnSpan((Control) this.digitalReadoutWaterLifetimeCountInstrument, 2);
    ...
    this.digitalReadoutWaterLifetimeCountInstrument.FontGroup = "tableLayoutPanelWholePanel";
    ((SingleInstrumentBase) this.digitalReadoutWaterLifetimeCountInstrument).FreezeValue = false;
    ((SingleInstrumentBase) this.digitalReadoutWaterLifetimeCountInstrument).Instrument = new Qualifier((QualifierTypes) 4, "MCM", "e2p_l_water_raised_eng_hours");
    ...
    ((TableLayoutPanel) this.tableLayoutPanelWholePanel).SetColumnSpan((Control) this.digitalReadoutWaterLifetimeCountParameter, 2);
    ...
    this.digitalReadoutWaterLifetimeCountParameter.FontGroup = "tableLayoutPanelWholePanel";
    ((SingleInstrumentBase) this.digitalReadoutWaterLifetimeCountParameter).FreezeValue = false;
    ((SingleInstrumentBase) this.digitalReadoutWaterLifetimeCountParameter).Instrument = new Qualifier((QualifierTypes) 4, "MCM", "e2p_l_water_raised_eng_starts");
