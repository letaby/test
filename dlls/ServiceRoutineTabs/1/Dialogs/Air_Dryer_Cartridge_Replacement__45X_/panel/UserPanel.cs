...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Air_Dryer_Cartridge_Replacement__45X_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void InitializeComponent()
  {
    ...
    this.digitalReadoutInstrumentWetnessState = new DigitalReadoutInstrument();
    ...
    ((TableLayoutPanel) this.tableLayoutPanel).Controls.Add((Control) this.digitalReadoutInstrumentWetnessState, 0, 0);
    ((TableLayoutPanel) this.tableLayoutPanel).Controls.Add((Control) this.runServiceButtonResetWetness, 1, 1);
    ((TableLayoutPanel) this.tableLayoutPanel).Controls.Add((Control) this.label, 0, 1);
    ((Control) this.tableLayoutPanel).Name = "tableLayoutPanel";
    ((TableLayoutPanel) this.tableLayoutPanel).SetColumnSpan((Control) this.digitalReadoutInstrumentWetnessState, 2);
    componentResourceManager.ApplyResources((object) this.digitalReadoutInstrumentWetnessState, "digitalReadoutInstrumentWetnessState");
    this.digitalReadoutInstrumentWetnessState.FontGroup = (string) null;
    ((SingleInstrumentBase) this.digitalReadoutInstrumentWetnessState).FreezeValue = false;
    ((SingleInstrumentBase) this.digitalReadoutInstrumentWetnessState).Instrument = new Qualifier((QualifierTypes) 1, "SATP01T", "DT_Wetness_level_Wetness_level");
    ((Control) this.digitalReadoutInstrumentWetnessState).Name = "digitalReadoutInstrumentWetnessState";
    ((SingleInstrumentBase) this.digitalReadoutInstrumentWetnessState).UnitAlignment = StringAlignment.Near;
    ...
    this.runServiceButtonResetWetness.ServiceCall = new ServiceCall("SATP01T", "RT_Reset_wetness");
