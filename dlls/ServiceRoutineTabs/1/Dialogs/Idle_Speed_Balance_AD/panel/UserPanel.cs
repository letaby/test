...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Idle_Speed_Balance_AD.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private static readonly List<SetupInformation> Setups = new List<SetupInformation>((IEnumerable<SetupInformation>) new SetupInformation[6]
  {
    new SetupInformation("MBE 900 series", "MBE900", true),
    new SetupInformation("MBE 4000 series", "MBE4000", true),
    new SetupInformation("DD15", "DD15", true),
    new SetupInformation("DD15 EURO4", "DD15EURO4", true),
    new SetupInformation("DD13", "DD13", true),
    new SetupInformation("Series 60", "S60", false)
  });
  ...
  {
    get => this.FuelTemperatureIsInRange && this.CoolantTemperatureIsInRange;
  }

  private bool FuelTemperatureIsInRange
  {
    get
    {
      return this.connectedEcuType == null || !this.connectedEcuType.UseFuelTemperature || this.fuelTemperatureInstrument.RepresentedState == 1;
    }
  }

  private bool CoolantTemperatureIsInRange
  {
    get => this.coolantTemperatureInstrument.RepresentedState == 1;
  }
  ...
  private void UpdateTemperatureCheck()
  {
    ...
    {
      this.temperatureCheck.CheckState = CheckState.Checked;
      str = Resources.Message_FuelAndCoolantTemperaturesAreInRange;
    }
    else
    {
      this.temperatureCheck.CheckState = CheckState.Unchecked;
      if (!this.FuelTemperatureIsInRange)
        str += string.Format(Resources.MessageFormat_FuelTemperatureMustBeAtLeast, (object) this.GetOkMinimumString(((AxisSingleInstrumentBase) this.fuelTemperatureInstrument).Gradient));
      if (!this.CoolantTemperatureIsInRange)
        str += string.Format(Resources.MessageFormat_CoolantTemperatureMustBeAtLeast0, (object) this.GetOkMinimumString(((AxisSingleInstrumentBase) this.coolantTemperatureInstrument).Gradient));
    }
    ((Control) this.temperatureStatus).Text = str;
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.buttonClose, 5, 8);
    ...
    this.vehicleCheckInstrument.FontGroup = "idleSpeedBalancePreconditionsEPA07";
    ...
    ((SingleInstrumentBase) this.vehicleCheckInstrument).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_DS019_Vehicle_Check_Status");
    ...
    ((Control) this.vehicleStatusCheck).BackColor = Color.Transparent;
    ...
    ((Control) this.temperatureCheck).BackColor = Color.Transparent;
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).SetColumnSpan((Control) this.tableLayoutPanel2, 6);
    ...
    this.coolantTemperatureInstrument.FontGroup = "idleSpeedBalancePreconditionsEPA07";
    ...
    ((SingleInstrumentBase) this.coolantTemperatureInstrument).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS013_Coolant_Temperature");
    ...
    this.fuelTemperatureInstrument.FontGroup = "idleSpeedBalancePreconditionsEPA07";
    ...
    ((SingleInstrumentBase) this.fuelTemperatureInstrument).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS014_Fuel_Temperature");
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).SetColumnSpan((Control) this.testStatusLabel, 5);
