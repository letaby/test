...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.DEF_Quantity_Test__MY13_.panel.Properties
...
{
  public virtual int FileVersion => 26;

  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\DEF Quantity Test (MY13).panel";
    }
  }
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      return (IEnumerable<Qualifier>) new Qualifier[9]
      {
        ...
        new Qualifier((QualifierTypes) 64 /*0x40*/, "ACM21T", "RT_SCR_Dosing_Quantity_Check_Request_Results_status_of_service_function"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_DEFQuantityTest_MY13"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_DEFQuantityTest_MY13_MDEG")
      };
    }
  }
