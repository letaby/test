...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.PLV_Change__MY13_.panel.UserPanel
...
{
  private const string plvOpenCounter = "DT_STO_ACC047_OP_Data_4_PLV_Open_Counter";
  ...
  public virtual void OnChannelsChanged()
  {
    ...
    this.channel = this.GetChannel("MCM21T");
    if (this.channel == null)
      return;
    this.channel.CommunicationsStateUpdateEvent += new CommunicationsStateUpdateEventHandler(this.OnCommunicationsStateUpdate);
    this.ReadStoredData();
  ...
  {
    if (this.channel == null || this.channel.EcuInfos["DT_STO_ACC047_OP_Data_4_PLV_Open_Counter"] == null)
      return;
    this.channel.EcuInfos["DT_STO_ACC047_OP_Data_4_PLV_Open_Counter"].Read(false);
  }

  private void OnReadAccumulatorsClick(object sender, EventArgs e) => this.ReadStoredData();
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 8, "MCM21T", "DT_STO_ACC047_OP_Data_4_PLV_Open_Counter");
