...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.SCR_ADS_Self_Check__MY13_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  public virtual void OnChannelsChanged() => this.UpdateConnectedEquipmentType();
  ...
  private void UpdateConnectedEquipmentType()
  {
    ...
    if (!EquipmentType.op_Inequality(equipmentType, EquipmentType.Empty))
      return;
    this.UpdateInstruments(this.IsMediumDuty(((EquipmentType) ref equipmentType).Name));
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentADSDosingValveState).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_DS011_ADS_dosing_valve_state");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentADSPumpSpeed).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS143_ADS_Pump_Speed");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentEngineSpeed).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS001_Engine_Speed");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentVehicleSpeed).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS077_Vehicle_speed_from_ISP100ms");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentResults).Instrument = new Qualifier((QualifierTypes) 64 /*0x40*/, "ACM21T", "RT_SCR_ADS_SelfCheck_Routine_Request_Results_status_of_service_function");
