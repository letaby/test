...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Nox_Sensor_Drift_Verification.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private bool UpdateChannels()
  {
    ...
    bool flag3 = this.SetACM(UserPanel.GetActiveChannel("ACM21T"));
  ...
  private bool SetCPC(Channel cpc)
  {
    ...
    if (this.cpc != null)
    {
      ...
      else if (string.Equals(this.cpc.Ecu.Name, "CPC04T", StringComparison.OrdinalIgnoreCase))
        this.ConnectedCpcVersion = UserPanel.CpcVersion.CPC4;
      else if (string.Equals(this.cpc.Ecu.Name, "CPC501T", StringComparison.OrdinalIgnoreCase))
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentDPFRegenState).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS064_DPF_Regen_State");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentNOxDewpointInlet).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS105_NOx_Sensor_Dewpoint_enabled_Inlet");
    ...
    ((SingleInstrumentBase) this.barInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS019_SCR_Outlet_Temperature");
    ...
    ((SingleInstrumentBase) this.barInstrumentNOxRaw).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS111_NOx_raw_concentration");
    ...
    ((SingleInstrumentBase) this.barInstrumentNOxOut).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS114_NOx_out_concentration");
    ...
    ((SingleInstrumentBase) this.barInstrument1).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS036_SCR_Inlet_NOx_Sensor");
    ...
    ((SingleInstrumentBase) this.barInstrument2).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS035_SCR_Outlet_NOx_Sensor");
    ...
    this.barInstrument3.FontGroup = "ThermometerBar";
    ((SingleInstrumentBase) this.barInstrument3).FreezeValue = false;
    ((SingleInstrumentBase) this.barInstrument3).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS018_SCR_Inlet_Temperature");
    ((Control) this.barInstrument3).Name = "barInstrument3";
    ((SingleInstrumentBase) this.barInstrument3).TitleOrientation = (DetroitDiesel.Windows.Forms.Diagnostics.Panels.Instruments.Label.TextOrientation) 0;
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument_e2p_nox_out_dia_sens_runtime).Instrument = new Qualifier((QualifierTypes) 4, "ACM21T", "e2p_nox_out_dia_sens_runtime");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument_e2p_nox_raw_dia_sens_runtime).Instrument = new Qualifier((QualifierTypes) 4, "ACM21T", "e2p_nox_raw_dia_sens_runtime");
    ...
    ((TableLayoutPanel) this.tableLayoutPanelThermometers).Controls.Add((Control) this.barInstrument3, 0, 0);
    ((TableLayoutPanel) this.tableLayoutPanelThermometers).Controls.Add((Control) this.barInstrument4, 1, 0);
    ((TableLayoutPanel) this.tableLayoutPanelThermometers).Controls.Add((Control) this.barInstrument7, 2, 0);
    ((TableLayoutPanel) this.tableLayoutPanelThermometers).Controls.Add((Control) this.barInstrument8, 3, 0);
    ((TableLayoutPanel) this.tableLayoutPanelThermometers).Controls.Add((Control) this.barInstrument9, 4, 0);
    ...
    ((SingleInstrumentBase) this.barInstrument7).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS007_DOC_Inlet_Temperature");
    ...
    ((SingleInstrumentBase) this.barInstrument8).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS008_DOC_Outlet_Temperature");
    ((Control) this.barInstrument8).Name = "barInstrument8";
    ((AxisSingleInstrumentBase) this.barInstrument8).PreferredAxisRange = new AxisRange(-500.0, 2000.0, (string) null);
    ...
    ((SingleInstrumentBase) this.barInstrument9).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS009_DPF_Outlet_Temperature");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentNOxDewpointOutlet).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS106_NOx_Sensor_Dewpoint_enabled_Outlet");
  ...
  private class NOxSensorDriftTest
  {
    ...
    private void SetDEFValve()
    {
      ...
      Service service = this.ParentUserPanel.GetService("ACM21T", "RT_SCR_Dosing_Quantity_Check_Start_Status");
    ...
    private void StartDPFRegen()
    {
      ...
      switch (this.ParentUserPanel.ConnectedCpcVersion)
      {
        case UserPanel.CpcVersion.CPC3:
          ...
          break;
        case UserPanel.CpcVersion.CPC4:
          str = "RT_DPF_Regeneration_Start";
          break;
      ...
      if (service != (Service) null)
      {
        if (this.ParentUserPanel.ConnectedCpcVersion == UserPanel.CpcVersion.CPC4)
          service.InputValues["PREP_1_Byte_Regen_Request"].Value = (object) service.InputValues["PREP_1_Byte_Regen_Request"].Choices.GetItemFromRawValue((object) 1);
    ...
    private void ResetDEFValve()
    {
      if (this.ParentUserPanel.acm == null || !this.ParentUserPanel.acm.Online)
        return;
      Service service = this.ParentUserPanel.GetService("ACM21T", "RT_SCR_Dosing_Quantity_Check_Stop_status");
      if (service != (Service) null)
      {
        try
        {
