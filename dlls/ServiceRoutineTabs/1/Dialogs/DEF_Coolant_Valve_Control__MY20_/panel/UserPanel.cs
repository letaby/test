...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.DEF_Coolant_Valve_Control__MY20_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  public virtual void OnChannelsChanged()
  {
    ...
    this.SetAcm(this.GetChannel("ACM301T"));
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.barInstrumentCoolantTemperature).Instrument = new Qualifier((QualifierTypes) 1, "ACM301T", "DT_AS002_Coolant_Temperature");
    ...
    ((SingleInstrumentBase) this.barInstrumentDefTankTemperature).Instrument = new Qualifier((QualifierTypes) 1, "ACM301T", "DT_AS022_DEF_tank_Temperature");
    ...
    this.runServiceButtonCoolantValveOpenStart.ServiceCall = new ServiceCall("ACM301T", "RT_Coolant_Valve_Open_Start_Coolant_Valve_Open_Status");
    ...
    this.runServiceButtonCoolantValveOpenStop.ServiceCall = new ServiceCall("ACM301T", "RT_Coolant_Valve_Open_Stop");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentCoolantValve).Instrument = new Qualifier((QualifierTypes) 1, "ACM301T", "DT_DS005_Coolant_Valve");
