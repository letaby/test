...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.APS_Calibration__EMG_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private static string EcpcName = "ECPC01T";
  private static string VrduName = "VRDU02T";
  private static string J19390Name = "J1939-0";
  ...
  private CalibrationStep[] steeringAngleCalibrationSteps = new CalibrationStep[15]
  {
    ...
    new CalibrationStep(Resources.Message_EnsureVehicleIsInPtReadyState, Resources.Message_ClickNextToContinueToCalibration, CalibrationActions.EnsurePtReadyState, true),
  ...
  public virtual void OnChannelsChanged()
  {
    ...
    this.SetChannel(this.GetChannel(UserPanel.EcpcName), ref this.ecpcChannel);
    this.SetChannel(this.GetChannel(UserPanel.J19390Name), ref this.j19390Channel);
  ...
  private void PerformStep()
  {
    ...
    switch (this.currentStep.Action)
    {
      case CalibrationActions.DisplayText:
        this.UpdateUI();
        break;
      case CalibrationActions.EnsurePtReadyState:
        this.CheckIfPtReady();
        break;
  ...
  private void UpdateUI()
  {
    ...
    if (this.currentStep != null)
    {
      ...
      bool flag = this.currentStep.ButtonEnabled && !logFileIsOpen && !this.HasActiveFaults && this.InstrumentsAreInitialized && this.IsChannelConnected(this.channel) && this.IsChannelConnected(this.vrduChannel) && this.IsChannelConnected(this.absChannel) && this.IsChannelConnected(this.ecpcChannel);
      this.buttonNext.Enabled = this.currentStep.Action == CalibrationActions.EnsurePtReadyState ? flag && this.PtReady : flag;
      ...
      this.buttonNext.Enabled = !logFileIsOpen && this.PtReady && !this.HasActiveFaults;
  ...
  private string GetConnectEcusMessage()
  {
    ...
    if (!this.IsChannelConnected(this.ecpcChannel))
      arrayList.Add((object) UserPanel.EcpcName);
    if (!this.IsChannelConnected(this.j19390Channel))
      arrayList.Add((object) UserPanel.J19390Name);
    if (!this.IsChannelConnected(this.vrduChannel))
      arrayList.Add((object) UserPanel.VrduName);
    if (arrayList.Count == 5)
      str = string.Format(Resources.MessageFormat_Connect01234ToBeginTheCalibration, arrayList[0], arrayList[1], arrayList[2], arrayList[3], arrayList[4]);
  ...
  private void CheckIfPtReady()
  {
    this.PtReady = this.digitalReadoutInstrumentEngineState.RepresentedState == 1;
    if (this.PtReady)
      this.PerformNextStep();
    else
      this.UpdateUI();
  ...
  private void digitalReadoutInstrumentEngineState_RepresentedStateChanged(
    ...
    EventArgs e)
  {
    if (this.currentStep == null || this.currentStep.Action != CalibrationActions.EnsurePtReadyState)
      return;
    this.CheckIfPtReady();
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((AxisSingleInstrumentBase) this.dialInstrumentRightEndstop).PreferredAxisRange = new AxisRange(-1200.0, 1.0, "");
    ...
    ((AxisSingleInstrumentBase) this.dialInstrument2).PreferredAxisRange = new AxisRange(-1.0, 1200.0, "");
    ...
    this.digitalReadoutInstrumentEngineState.Gradient.Initialize((ValueState) 0, 4);
    this.digitalReadoutInstrumentEngineState.Gradient.Modify(1, 0.0, (ValueState) 3);
    this.digitalReadoutInstrumentEngineState.Gradient.Modify(2, 1.0, (ValueState) 1);
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentEngineState).Instrument = new Qualifier((QualifierTypes) 1, "J1939-0", "DT_7315");
