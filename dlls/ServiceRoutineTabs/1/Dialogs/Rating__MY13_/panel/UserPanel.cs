...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Rating__MY13_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  {
    if (!(this.SetCPC2(this.GetChannel("CPC04T")) | this.SetMCM(this.GetChannel("MCM21T"))))
      return;
  ...
  private void ReadRating()
  {
    if (!this.CanRead)
      return;
    this.ClearResults();
    this.ReportResult(Resources.Message_ReadingSettingFromCPC4);
  ...
  private void OnWriteRatingClick(object sender, EventArgs e)
  {
    ...
    {
      this.ReportResult(Resources.Message_SendingSettingToCPC4);
