...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.HC_Doser__NGC_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void SetAcm(Channel acm)
  {
    ...
    if (this.Acm != null)
    {
      ((SingleInstrumentBase) this.BarInstrument6).Instrument = new Qualifier((QualifierTypes) 1, this.Acm.Ecu.Name, "DT_AS006_DPF_Outlet_Pressure");
      ((SingleInstrumentBase) this.BarInstrument7).Instrument = new Qualifier((QualifierTypes) 1, this.Acm.Ecu.Name, "DT_AS005_DOC_Inlet_Pressure");
      ((SingleInstrumentBase) this.BarInstrument9).Instrument = new Qualifier((QualifierTypes) 1, this.Acm.Ecu.Name, "DT_AS007_DOC_Inlet_Temperature");
      ((SingleInstrumentBase) this.BarInstrument10).Instrument = new Qualifier((QualifierTypes) 1, this.Acm.Ecu.Name, "DT_AS008_DOC_Outlet_Temperature");
      ((SingleInstrumentBase) this.BarInstrument11).Instrument = new Qualifier((QualifierTypes) 1, this.Acm.Ecu.Name, "DT_AS009_DPF_Outlet_Temperature");
    }
  }
  ...
  {
    if (!UserPanel.UpdateInstrumentReference("MCM21T", "DT_AS077_Fuel_Cut_Off_Valve", ref this.fuelCutOffValve, new InstrumentUpdateEventHandler(this.OnFuelCutOffValveDataChanged)))
      return;
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.BarInstrument11).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS009_DPF_Outlet_Temperature");
    ...
    ((SingleInstrumentBase) this.BarInstrument12).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS013_Coolant_Temperature");
    ...
    ((SingleInstrumentBase) this.BarInstrument13).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS017_Inlet_Manifold_Temperature");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS012_Vehicle_Speed");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument6).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS022_Active_Governor_Type");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS023_Engine_State");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS019_Barometric_Pressure");
    ...
    ((SingleInstrumentBase) this.BarInstrument2).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS018_Inlet_Manifold_Pressure");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument7).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS071_Smoke_Control_Status");
    ...
    ((SingleInstrumentBase) this.BarInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS033_Throttle_Valve_Commanded_Value");
    ...
    ((SingleInstrumentBase) this.BarInstrument7).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS005_DOC_Inlet_Pressure");
    ...
    ((SingleInstrumentBase) this.BarInstrument6).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS006_DPF_Outlet_Pressure");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS077_Fuel_Cut_Off_Valve");
    ...
    ((SingleInstrumentBase) this.BarInstrument16).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS035_Fuel_Doser_Injection_Status");
    ...
    ((SingleInstrumentBase) this.barFuelPressure).Instrument = new Qualifier((QualifierTypes) 1, "MCM21T", "DT_AS024_Fuel_Compensation_Pressure");
    ...
    ((Collection<QualifierGroup>) this.ListInstrument1.Groups).Add(new QualifierGroup("Switches", new Qualifier[12]
    {
    ...
    ((Collection<QualifierGroup>) this.ListInstrument1.Groups).Add(new QualifierGroup("Regeneration", new Qualifier[12]
    {
    ...
    ((Collection<QualifierGroup>) this.ListInstrument1.Groups).Add(new QualifierGroup("Compressor", new Qualifier[2]
    {
    ...
    ((SingleInstrumentBase) this.barInstrument3).Instrument = new Qualifier((QualifierTypes) 16 /*0x10*/, "fake", "FakeBoostPressureMY13");
    ...
    this.hcDoserButton.Qualifier = "SP_HCDoserPurge_MY13";
