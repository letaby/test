...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Relative_Compression_Test.panel.UserPanel
...
public class UserPanel : CustomPanel, IProvideHtml
{
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.engineSpeedDigitalReadoutInstrument).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS010_Engine_Speed");
    ...
    this.DigitalReadoutInstrument1.Gradient.Initialize((ValueState) 0, 3);
