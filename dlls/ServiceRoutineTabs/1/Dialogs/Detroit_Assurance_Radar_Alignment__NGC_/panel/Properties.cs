...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Detroit_Assurance_Radar_Alignment__NGC_.panel.Properties
...
{
  public virtual int FileVersion => 69;

  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Detroit Assurance Radar Alignment (NGC).panel";
    }
  }
  ...
  {
    get => (IEnumerable<string>) new string[1]{ "RDF02T" };
  }
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      return (IEnumerable<Qualifier>) new Qualifier[5]
      {
        ...
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_DrivingRadarAlignment_NGC")
      };
    }
  }
