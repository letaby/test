...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Side_Radar_Left_Calibration__NGC_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  public virtual void OnChannelsChanged() => this.SetChannel(this.GetChannel("SRRL01T"));
  ...
  private void InitializeComponent()
  {
    ...
    this.seekTimeListViewLog.RequiredUserLabelPrefix = "SRRL-Calibration";
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentRequestResultsStatus).Instrument = new Qualifier((QualifierTypes) 64 /*0x40*/, "SRRL01T", "RT_Service_Alignment_Azimuth_Request_Results_Routine_Status");
    ...
    this.sharedProcedureCreatorComponent.MonitorCall = new ServiceCall("SRRL01T", "RT_Service_Alignment_Azimuth_Request_Results_Routine_Status");
    ...
    this.sharedProcedureCreatorComponent.Qualifier = "SP_SRRLCalibration";
    this.sharedProcedureCreatorComponent.StartCall = new ServiceCall("SRRL01T", "RT_Service_Alignment_Azimuth_Start");
    ...
    this.sharedProcedureCreatorComponent.StopCall = new ServiceCall("SRRL01T", "RT_Service_Alignment_Azimuth_Stop");
