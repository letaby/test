...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.EGR_Hysteresis_Measurement.panel.Properties
...
public class Properties(Type runtimeType) : PanelProperties(runtimeType)
{
  ...
  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\EGR Hysteresis Measurement.panel";
    }
  }

  public virtual string Guid => "2e0407ca-6cbf-4210-9950-be1966e8fb27";

  public virtual string DisplayName => "EGR Hysteresis Measurement";
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      ...
      {
        new Qualifier((QualifierTypes) 64 /*0x40*/, "MCM21T", "RT_SR0CB_EGR_hysteresis_measurement_Request_Results_am_egr_current_valve"),
        new Qualifier((QualifierTypes) 64 /*0x40*/, "MCM21T", "RT_SR0CB_EGR_hysteresis_measurement_Request_Results_is05_adc_pos_egr"),
        ...
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_EGR_Hysteresis"),
  ...
  public virtual IEnumerable<string> UserSourceInstrumentQualifierReferences
  {
    get
    {
      ...
      {
        "RT_SR0CB_EGR_hysteresis_measurement_Request_Results_is05_adc_pos_egr"
      };
    }
  }
}
