...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.HC_Doser.panel.Properties
...
public class Properties(Type runtimeType) : PanelProperties(runtimeType)
{
  ...
  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\HC Doser.panel";
    }
  }
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      return (IEnumerable<Qualifier>) new Qualifier[45]
      {
