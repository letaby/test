...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.HC_Doser.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  {
    if (!UserPanel.UpdateInstrumentReference("MCM", "DT_AS077_Fuel_Cut_Off_Valve", ref this.fuelCutOffValve, new InstrumentUpdateEventHandler(this.OnFuelCutOffValveDataChanged)))
      return;
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.barFuelPressureAtDoser).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS038_Doser_Fuel_Line_Pressure");
    ...
    ((SingleInstrumentBase) this.BarInstrument9).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS040_DOC_Inlet_Temperature");
    ...
    ((SingleInstrumentBase) this.BarInstrument10).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS041_DOC_Outlet_Temperature");
    ...
    ((SingleInstrumentBase) this.BarInstrument11).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS053_DPF_Outlet_Temperature");
    ...
    ((SingleInstrumentBase) this.BarInstrument12).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS013_Coolant_Temperature");
    ...
    ((SingleInstrumentBase) this.BarInstrument13).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS017_Inlet_Manifold_Temperature");
    ...
    ((SingleInstrumentBase) this.BarInstrument6).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS037_DPF_Outlet_Pressure");
    ...
    ((SingleInstrumentBase) this.BarInstrument7).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS036_DPF_Inlet_Pressure");
    ...
    ((SingleInstrumentBase) this.BarInstrument5).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS034_Throttle_Valve_Actual_Position");
    ...
    ((SingleInstrumentBase) this.BarInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS033_Throttle_Valve_Commanded_Value");
    ...
    ((SingleInstrumentBase) this.BarInstrument2).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS018_Inlet_Manifold_Pressure");
    ...
    ((SingleInstrumentBase) this.BarInstrument1).Instrument = new Qualifier((QualifierTypes) 1, "CPC2", "DT_AS005_Accelerator_Pedal_Position");
    ...
    ((Collection<QualifierGroup>) this.ListInstrument1.Groups).Add(new QualifierGroup("Regeneration", new Qualifier[8]
    {
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS010_Engine_Speed");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS012_Vehicle_Speed");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument6).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS022_Active_Governor_Type");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS023_Engine_State");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS019_Barometric_Pressure");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument7).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS071_Smoke_Control_Status");
    ...
    ((SingleInstrumentBase) this.DigitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS077_Fuel_Cut_Off_Valve");
    ...
    ((SingleInstrumentBase) this.BarInstrument16).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS035_Fuel_Doser_Injection_Status");
    ...
    ((SingleInstrumentBase) this.barFuelPressure).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS024_Fuel_Compensation_Pressure");
    ...
    ((SingleInstrumentBase) this.barInstrument3).Instrument = new Qualifier((QualifierTypes) 16 /*0x10*/, "fake", "FakeBoostPressure");
    ...
    ((SingleInstrumentBase) this.barFuelCompensationGaugePressure).Instrument = new Qualifier((QualifierTypes) 16 /*0x10*/, "fake", "FakeFuelCompensationGaugePressure");
    ...
    ((SingleInstrumentBase) this.barDoserFuelLineGaugePressure).Instrument = new Qualifier((QualifierTypes) 16 /*0x10*/, "fake", "FakeDoserFuelLineGaugePressure");
    ...
    this.hcDoserButton.Qualifier = "SP_HCDoserPurge_EPA07";
