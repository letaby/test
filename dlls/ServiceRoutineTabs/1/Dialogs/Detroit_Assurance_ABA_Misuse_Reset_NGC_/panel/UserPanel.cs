...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Detroit_Assurance_ABA_Misuse_Reset_NGC_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  public virtual void OnChannelsChanged() => this.SetTcm(this.GetChannel("VRDU02T"));
  ...
  private void InitializeComponent()
  {
    ...
    this.runServicesButton.ServiceCalls.Add(new ServiceCall("VRDU02T", "SES_Extended_P2_CAN_ECU_max_physical"));
    this.runServicesButton.ServiceCalls.Add(new ServiceCall("VRDU02T", "DJ_SecurityAccess_Routines"));
    this.runServicesButton.ServiceCalls.Add(new ServiceCall("VRDU02T", "RT_Delete_permanent_errors_Start"));
    this.runServicesButton.ServiceCalls.Add(new ServiceCall("VRDU02T", "RT_Delete_permanent_errors_Request_Results_Delete_Results"));
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 64 /*0x40*/, "VRDU02T", "RT_Delete_permanent_errors_Request_Results_Delete_Results");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes) 32 /*0x20*/, "VRDU02T", "02FBFF");
