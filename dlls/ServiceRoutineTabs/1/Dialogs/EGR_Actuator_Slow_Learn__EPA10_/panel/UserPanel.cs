...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.EGR_Actuator_Slow_Learn__EPA10_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanel3).Controls.Add((Control) this.labelNote1, 0, 0);
    ...
    this.labelNote1.Alignment = StringAlignment.Near;
    componentResourceManager.ApplyResources((object) this.labelNote1, "labelNote1");
    ((Control) this.labelNote1).Name = "labelNote1";
    this.labelNote1.Orientation = (Label.TextOrientation) 1;
    this.labelNote1.UseSystemColors = true;
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 1, "MCM02T", "DT_AS050_SRA3_Status_Code");
    ...
    this.ContextLink = new Link("Panel_EGRActuatorSlowLearn");
