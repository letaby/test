...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Fuel_System_Integrity_Check__MY17_.panel.Properties
...
public class Properties(Type runtimeType) : PanelProperties(runtimeType)
{
  ...
  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Fuel System Integrity Check (MY17).panel";
    }
  }
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      return (IEnumerable<Qualifier>) new Qualifier[28]
      {
        ...
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_FuelSystemIntegrityCheck_Automatic_MY20"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_FuelSystemIntegrityCheck_Automatic_MY17"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_FuelSystemIntegrityCheck_LeakTest_MY17"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_FuelSystemIntegrityCheck_LeakTest_MY20"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_FuelSystemIntegrityCheck_Manual_MY17"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_FuelSystemIntegrityCheck_Manual_MY20")
      };
    }
  }
  ...
  public virtual IEnumerable<string> UserSourceInstrumentQualifierReferences
  {
    get
    {
      return (IEnumerable<string>) new string[5]
      {
        ...
        "DT_AS124_LPPO_Fuel_Pressure",
        "DT_AAS_LPPO_Fuel_Pressure"
      };
    }
  }
}
