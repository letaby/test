...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.PLV_Change.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 4, "MCM", "PLV_Open_Counter");
