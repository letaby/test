...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.DEF_Coolant_Valve_Control.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.barInstrumentCoolantTemperature).Instrument = new Qualifier((QualifierTypes) 1, "virtual", "coolantTemp");
    ...
    ((SingleInstrumentBase) this.barInstrumentDefTankTemperature).Instrument = new Qualifier((QualifierTypes) 1, "ACM02T", "DT_AS022_DEF_tank_Temperature");
    ...
    this.runServiceButtonCoolantValveOpenStart.ServiceCall = new ServiceCall("ACM02T", "RT_DSR_Coolant_Valve_Open_Start");
    ...
    this.runServiceButtonCoolantValveOpenStop.ServiceCall = new ServiceCall("ACM02T", "RT_DSR_Coolant_Valve_Open_Stop");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentCoolantValve).Instrument = new Qualifier((QualifierTypes) 1, "ACM02T", "DT_DS005_Coolant_Valve");
