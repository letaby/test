...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Set_Odometers__NGC_.panel.Properties
...
public class Properties(Type runtimeType) : PanelProperties(runtimeType)
{
  ...
  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Set Odometers (NGC).panel";
    }
  }

  public virtual string Guid => "bceccbd2-7786-4771-936c-820b9a390cae";

  public virtual string DisplayName => "Set Odometers";
  ...
  public virtual FilterTypes Filters => (FilterTypes) 10;
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      ...
      {
        new Qualifier((QualifierTypes) 16 /*0x10*/, "fake", "fakeIcOdometer"),
