...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Idle_Speed_Balance_AD__MY13_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void FinishTest()
  {
    ...
    this.AppendDisplayMessage(this.success ? (this.adrReturnValue ? this.TestPassedMessage : this.TestFailedMessage) : this.ErrorMessage);
    this.UpdateTestReadiness();
  }
  ...
  {
    Tuple<List<int>, List<Tuple<int, int>>> tuple = this.HighlightValues();
    string str = string.Empty;
    if (!this.testStarted)
      return;
    if (this.success)
    {
      this.adrReturnValue = tuple.Item1.Count == 0;
      if (tuple.Item1.Any<int>())
        str = string.Join(", <br />", tuple.Item1.Select<int, string>((Func<int, string>) (i => string.Format((IFormatProvider) CultureInfo.InvariantCulture, Resources.MessageFormat_Cylinder0MayBeInFaultRN, (object) i))));
      if (tuple.Item2.Any<Tuple<int, int>>())
        str += string.Join(", <br />", tuple.Item2.Select<Tuple<int, int>, string>((Func<Tuple<int, int>, string>) (i => string.Format((IFormatProvider) CultureInfo.InvariantCulture, Resources.MessageFormat_Cylinder0MightBeCompensatingForCylinder1RN, (object) i.Item1, (object) i.Item2))));
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.labelUserNote, 1, 7);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.tableLayoutPanelTimer, 1, 5);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.testStatusLabel, 0, 9);
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.buttonClose, 7, 9);
