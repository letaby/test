...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.DOC_Face_Plug_Cleaning.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  {
    this.UpdateDEFPressureInstrument(UserPanel.IsMediumDutyEquipment(SapiManager.GlobalInstance.ConnectedEquipment.FirstOrDefault<EquipmentType>((Func<EquipmentType, bool>) (et =>
    {
  ...
  {
    if (isMediumDuty)
      ((SingleInstrumentBase) this.barInstrumentDefPressure).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS014_DEF_Pressure");
    else
      ((SingleInstrumentBase) this.barInstrumentDefPressure).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS110_ADS_DEF_Pressure_2");
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.barInstrumentDefPressure, 2, 2);
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.barInstrument5, 7, 2);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.barInstrument6, 6, 2);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.barInstrument7, 5, 2);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.barInstrument8, 4, 2);
    ((TableLayoutPanel) this.tableLayoutPanel1).Controls.Add((Control) this.barInstrument4, 3, 2);
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument6).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS143_ADS_Pump_Speed");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentResults).Instrument = new Qualifier((QualifierTypes) 64 /*0x40*/, "ACM21T", "RT_DOC_Face_Plug_Unclogging_Request_Results_Status");
    ...
    ((SingleInstrumentBase) this.ActualDpfZone).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS065_Actual_DPF_zone");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS036_SCR_Inlet_NOx_Sensor");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS035_SCR_Outlet_NOx_Sensor");
    ...
    ((TableLayoutPanel) this.tableLayoutPanel1).SetRowSpan((Control) this.barInstrumentDefPressure, 3);
    ...
    ((SingleInstrumentBase) this.barInstrument2).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS005_DOC_Inlet_Pressure");
    ...
    ((SingleInstrumentBase) this.barInstrument3).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS006_DPF_Outlet_Pressure");
    ...
    ((SingleInstrumentBase) this.barInstrument5).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS008_DOC_Outlet_Temperature");
    ((Control) this.barInstrument5).Name = "barInstrument5";
    ((TableLayoutPanel) this.tableLayoutPanel1).SetRowSpan((Control) this.barInstrument5, 3);
    ...
    ((SingleInstrumentBase) this.barInstrument6).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS009_DPF_Outlet_Temperature");
    ((Control) this.barInstrument6).Name = "barInstrument6";
    ((TableLayoutPanel) this.tableLayoutPanel1).SetRowSpan((Control) this.barInstrument6, 3);
    ...
    ((SingleInstrumentBase) this.barInstrument7).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS018_SCR_Inlet_Temperature");
    ((Control) this.barInstrument7).Name = "barInstrument7";
    ((TableLayoutPanel) this.tableLayoutPanel1).SetRowSpan((Control) this.barInstrument7, 3);
    ...
    ((SingleInstrumentBase) this.barInstrument8).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS019_SCR_Outlet_Temperature");
    ((Control) this.barInstrument8).Name = "barInstrument8";
    ((TableLayoutPanel) this.tableLayoutPanel1).SetRowSpan((Control) this.barInstrument8, 3);
    ...
    ((SingleInstrumentBase) this.barInstrument4).Instrument = new Qualifier((QualifierTypes) 1, "ACM21T", "DT_AS007_DOC_Inlet_Temperature");
    ((Control) this.barInstrument4).Name = "barInstrument4";
    ((TableLayoutPanel) this.tableLayoutPanel1).SetRowSpan((Control) this.barInstrument4, 3);
    ...
    this.DocFacePlugUnclogging.MonitorCall = new ServiceCall("ACM21T", "RT_DOC_Face_Plug_Unclogging_Request_Results_Status");
    ...
    this.DocFacePlugUnclogging.StartCall = new ServiceCall("ACM21T", "RT_DOC_Face_Plug_Unclogging_Start");
    ...
    this.DocFacePlugUnclogging.StopCall = new ServiceCall("ACM21T", "RT_DOC_Face_Plug_Unclogging_Stop");
