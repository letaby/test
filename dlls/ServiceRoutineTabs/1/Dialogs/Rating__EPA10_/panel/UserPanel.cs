...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Rating__EPA10_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  {
    if (!(this.SetCPC2(this.GetChannel("CPC02T")) | this.SetMCM(this.GetChannel("MCM02T"))))
      return;
  ...
  private void OnParametersWriteComplete(object sender, ResultEventArgs e)
  {
    if (e.Succeeded)
    {
      this.ReportResult(Resources.Message_SettingSuccessfullySent);
