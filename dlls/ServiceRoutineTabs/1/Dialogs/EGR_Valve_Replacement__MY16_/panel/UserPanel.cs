...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.EGR_Valve_Replacement__MY16_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private void InitializeComponent()
  {
    ...
    this.runServiceButton.ServiceCall = new ServiceCall("MCM21T", "RT_SR0C6_Reset_EGR_values_Start", (IEnumerable<string>) new string[1]
    {
      "Reset_Type=255"
    });
