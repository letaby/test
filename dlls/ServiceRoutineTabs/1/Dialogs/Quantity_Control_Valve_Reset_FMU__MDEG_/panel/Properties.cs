...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Quantity_Control_Valve_Reset_FMU__MDEG_.panel.Properties
...
public class Properties(Type runtimeType) : PanelProperties(runtimeType)
{
  ...
  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Quantity Control Valve Reset FMU (MDEG).panel";
    }
  }

  public virtual string Guid => "2e0407ca-6cbf-4210-9950-be1966e8fb27";

  public virtual string DisplayName => "Quantity Control Valve Reset FMU";
  ...
  public virtual IEnumerable<ServiceCall> DesignerServiceCallReferences
  {
    get
    {
      ...
      {
        new ServiceCall("MCM21T", "RT_SR014_SET_EOL_Default_Values_Start", (IEnumerable<string>) new string[1]
        {
