...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.TCM_Replacement__MY13_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  public virtual void OnChannelsChanged() => this.SetTcm(this.GetChannel("TCM01T"));
  ...
  private void SetTcm(Channel tcm)
  {
    ...
    if (this.tcm != null)
    {
      ...
      this.SetTransType = this.tcm.Services["RT_0410_Getriebetyp_setzen_und_Wegwerte_loeschen_Service_Start_Getriebetyp"];
    }
    this.UpdateUserInterface();
  }
  ...
  private void OnCommunicationsStateUpdate(object sender, CommunicationsStateEventArgs e)
  {
    ...
    {
      if (this.tcm == null || this.tcm.CommunicationsState == CommunicationsState.Offline)
      {
    ...
    else if (this.waitingForIgnitionOn && this.tcm != null && this.tcm.CommunicationsState == CommunicationsState.Online)
    {
  ...
  private void SetTransType_ServiceCompleteEvent(object sender, ResultEventArgs e)
  {
    ...
    if (e.Succeeded)
    {
      this.AddLogLabel(string.Format(Resources.MessageFormat_SuccessfullySetTheTransmissionTypeTo0, (object) this.comboTransType.SelectedItem.ToString()));
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableTransControls).Controls.Add((Control) this.comboTransType, 0, 0);
    ((TableLayoutPanel) this.tableTransControls).Controls.Add((Control) this.btnSetTransmissionType, 1, 0);
    ...
    ((Control) this.tableTransControls).PerformLayout();
