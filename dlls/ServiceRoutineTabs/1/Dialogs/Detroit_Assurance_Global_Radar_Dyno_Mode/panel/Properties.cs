...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Detroit_Assurance_Global_Radar_Dyno_Mode.panel.Properties
...
public class Properties(Type runtimeType) : PanelProperties(runtimeType)
{
  ...
  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Detroit Assurance Global Radar Dyno Mode.panel";
    }
  }

  public virtual string Guid => "465c8707-d011-4bdf-b605-1d2cd9f17c89";

  public virtual string DisplayName => "Active Brake Assist - Enable/Disable";
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      ...
      {
        new Qualifier((QualifierTypes) 64 /*0x40*/, "VRDU01T", "RT_ABA_release_Request_Results_release_state"),
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_GlobalRadarDisable")
      };
    }
  }
  ...
  public virtual IEnumerable<string> UserSourceInstrumentQualifierReferences
  {
    get
    {
      ...
      {
        "RT_ABA_release_Request_Results_release_state"
      };
    }
  }
