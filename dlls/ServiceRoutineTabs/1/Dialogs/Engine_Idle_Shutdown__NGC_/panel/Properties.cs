...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Engine_Idle_Shutdown__NGC_.panel.Properties
...
public class Properties(Type runtimeType) : PanelProperties(runtimeType)
{
  ...
  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Engine Idle Shutdown (NGC).panel";
    }
  }
  ...
  {
    get => (IEnumerable<string>) new string[1]{ "CPC302T" };
  }
}
