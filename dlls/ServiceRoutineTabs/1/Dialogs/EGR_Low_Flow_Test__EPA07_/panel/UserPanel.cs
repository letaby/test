...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.EGR_Low_Flow_Test__EPA07_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  public UserPanel()
  {
    ...
    this.setups = new Dictionary<string, SetupInformation>();
    this.setups.Add("DD15", new SetupInformation(20.0, 1600, 1800, 6));
    this.setups.Add("DD15EURO4", new SetupInformation(20.0, 1600, 1800, 6));
    this.setups.Add("DD16", new SetupInformation(20.0, 1600, 1800, 6));
    this.setups.Add("DD13", new SetupInformation(15.0, 1650, 1800, 0));
  }
  ...
  private void SetChannel(Channel channel)
  {
    ...
    {
      this.channel.Instruments["DT_AS060_Temperature_Icooler_Out"].InstrumentUpdateEvent -= new InstrumentUpdateEventHandler(this.OnTemperaturePreconditionChanged);
      ...
      this.setup = (SetupInformation) null;
    }
    ...
    if (this.channel != null)
    {
      ...
      this.channel.Instruments["DT_AS013_Coolant_Temperature"].InstrumentUpdateEvent += new InstrumentUpdateEventHandler(this.OnTemperaturePreconditionChanged);
      this.channel.CommunicationsStateUpdateEvent += new CommunicationsStateUpdateEventHandler(this.OnCommunicationsStateUpdate);
      this.setups.TryGetValue(this.GetEngineTypeName(), out this.setup);
    }
    this.UpdateUserInterface();
  }
      ...
      else
      {
        switch (this.currentWaitState)
        {
          case UserPanel.WaitState.WaitingToInitiateRampUp:
            this.ManipulateIdleSpeed(this.setup.TestIdleSpeed);
          ...
          case UserPanel.WaitState.WaitingForThermalCondition:
            if (DateTime.Now >= this.startTime + this.setup.TestDurationThermalCondition)
            {
          ...
          case UserPanel.WaitState.WaitingToInitiateRunOffRampUp:
            this.ManipulateIdleSpeed(this.setup.RunOffIdleSpeed);
  ...
  private void UpdateUserInterface()
  {
    ...
    if (!this.buttonStart.Enabled)
    {
      if (this.TestRunning)
      {
        switch (this.currentWaitState)
        {
          ...
          case UserPanel.WaitState.WaitingToInitiateRunOffRampUp:
            ...
            break;
          case UserPanel.WaitState.WaitingForRampUp:
            str = string.Format((IFormatProvider) CultureInfo.CurrentCulture, Resources.MessageFormat_WaitingForEngineSpeedToReach0Rpm, (object) this.setup.TestIdleSpeed);
            break;
          case UserPanel.WaitState.WaitingForThermalCondition:
            str = string.Format((IFormatProvider) CultureInfo.CurrentCulture, Resources.MessageFormat_ThermalConditionWait0SecondsRemaining, (object) (int) (this.startTime + this.setup.TestDurationThermalCondition - DateTime.Now).TotalSeconds);
            break;
          case UserPanel.WaitState.WaitingForEGRInRange:
            ...
            break;
          case UserPanel.WaitState.WaitingForRunOffRampUp:
            str = string.Format((IFormatProvider) CultureInfo.CurrentCulture, Resources.MessageFormat_WaitingForEngineSpeedToReach0Rpm1, (object) this.setup.RunOffIdleSpeed);
            break;
          case UserPanel.WaitState.WaitingForRunOffPeriod:
      ...
      else if (!this.HaveSetupInformation)
        str = Resources.Message_CannotStartTheTestAsTheEquipmentTypeIsUnknown;
    }
  ...
  {
    this.Output(Resources.Message_ManipulateEngineSpeedTo + (object) speed + Resources.Message_Rpm0);
  ...
  private bool CanStart
  {
    get
    {
      return this.Online && this.HaveSetupInformation && !this.TestRunning && !this.Busy && this.VehicleCheckStatusOk && this.EngineRunning && this.TemperaturesOk;
    }
  }

  private bool CanStop => this.Online && this.TestRunning;

  private bool HaveSetupInformation => this.setup != null;
  ...
  private bool TestPassed
  {
    get
    {
      ...
      return instrumentValue1 >= this.setup.EGRMinimumPosition && instrumentValue1 <= 40.0 && instrumentValue2 >= 50.0 && instrumentValue2 <= 150.0;
    }
  }
  ...
  private bool EGRValveInTestRange
  {
    get
    {
      return this.GetInstrumentValue((SingleInstrumentBase) this.barInstrumentEGRCommandedValue) >= this.setup.EGRMinimumPosition;
    }
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((AxisSingleInstrumentBase) this.barInstrumentEGRDeltaPressure).Gradient.Modify(1, 50.0, (ValueState) 1);
    ((AxisSingleInstrumentBase) this.barInstrumentEGRDeltaPressure).Gradient.Modify(2, 151.0, (ValueState) 3);
    ((SingleInstrumentBase) this.barInstrumentEGRDeltaPressure).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS025_EGR_Delta_Pressure");
    ((Control) this.barInstrumentEGRDeltaPressure).Name = "barInstrumentEGRDeltaPressure";
    ((AxisSingleInstrumentBase) this.barInstrumentEGRDeltaPressure).PreferredAxisRange = new AxisRange(0.0, 200.0, "mbar");
    ...
    ((SingleInstrumentBase) this.barInstrumentEGRCommandedValue).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS031_EGR_Commanded_Governor_Value");
    ...
    ((SingleInstrumentBase) this.barInstrumentChargeAirCoolerOutTemp).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS060_Temperature_Icooler_Out");
    ((Control) this.barInstrumentChargeAirCoolerOutTemp).Name = "barInstrumentChargeAirCoolerOutTemp";
    ((AxisSingleInstrumentBase) this.barInstrumentChargeAirCoolerOutTemp).PreferredAxisRange = new AxisRange(-50.0, 200.0, "°C");
    ...
    ((SingleInstrumentBase) this.digitalReadoutFault).Instrument = new Qualifier((QualifierTypes) 32 /*0x20*/, "MCM", "826900");
    ...
    ((SingleInstrumentBase) this.digitalReadoutVehicleCheckStatus).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_DS019_Vehicle_Check_Status");
    ...
    ((SingleInstrumentBase) this.digitalReadoutEngineSpeed).Instrument = new Qualifier((QualifierTypes) 1, "MCM", "DT_AS010_Engine_Speed");
