...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.EGR_Low_Flow_Test__EPA07_.panel.Properties
...
{
  public virtual int FileVersion => 183;

  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\EGR Low Flow Test (EPA07).panel";
    }
  }
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      return (IEnumerable<Qualifier>) new Qualifier[7]
      {
        ...
        new Qualifier((QualifierTypes) 1, "MCM", "DT_AS031_EGR_Commanded_Governor_Value"),
        new Qualifier((QualifierTypes) 1, "MCM", "DT_AS060_Temperature_Icooler_Out"),
        new Qualifier((QualifierTypes) 32 /*0x20*/, "MCM", "826900"),
  ...
  public virtual IEnumerable<string> UserSourceInstrumentQualifierReferences
  {
    get
    {
      return (IEnumerable<string>) new string[4]
      {
        ...
        "DT_AS060_Temperature_Icooler_Out",
