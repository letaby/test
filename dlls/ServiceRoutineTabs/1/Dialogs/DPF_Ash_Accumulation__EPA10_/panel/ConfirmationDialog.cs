...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.DPF_Ash_Accumulation__EPA10_.panel.ConfirmationDialog
...
internal static class ConfirmationDialog
{
  ...
  public static bool Show(string vin, AtsType type, string dpfsn1, string dpfsn2, string action)
  {
    ...
    string str = dpfsn1 + (type == AtsType.OneBox ? ", " + dpfsn2 : string.Empty);
    bool flag;
