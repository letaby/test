...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Set_CPC_Odometer__EPA07_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  {
    Channel channel = this.GetChannel("CPC2");
    if (this.cpc == channel)
      return;
...
label_7:
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes) 8, "CPC2", "CO_Odometer");
