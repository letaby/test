...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Predictive_Cruise_Control_diagnostic__EPA10_.panel.Properties
...
public class Properties(Type runtimeType) : PanelProperties(runtimeType)
{
  ...
  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Predictive Cruise Control diagnostic (EPA10).panel";
    }
  }
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      ...
      {
        new Qualifier((QualifierTypes) 4, "CPC02T", "CC_Mode_Selection")
      };
    }
  }
