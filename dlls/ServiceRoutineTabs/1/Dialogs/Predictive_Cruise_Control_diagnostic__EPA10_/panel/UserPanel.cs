...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.Predictive_Cruise_Control_diagnostic__EPA10_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  private bool PccConfigured
  {
    get
    {
      if (this.pccParameter != null && this.pccParameter.HasBeenReadFromEcu)
      {
        ...
        {
          byte num = Convert.ToByte(originalValue.RawValue);
          return num == (byte) 2 || num == (byte) 3;
        }
      }
      return false;
    }
  ...
  private void InitializeComponent()
  {
    ...
    ((TableLayoutPanel) this.tableLayoutPanel3).Controls.Add((Control) this.button1, 1, 2);
    ((Control) this.tableLayoutPanel3).Name = "tableLayoutPanel3";
    ((TableLayoutPanel) this.tableLayoutPanel3).SetColumnSpan((Control) this.parameterEditor, 2);
    ...
    ((SingleInstrumentBase) this.parameterEditor).Instrument = new Qualifier((QualifierTypes) 4, "CPC02T", "CC_Mode_Selection");
    ((Control) this.parameterEditor).Name = "parameterEditor";
    ((TableLayoutPanel) this.tableLayoutPanel3).SetRowSpan((Control) this.parameterEditor, 2);
    ((SingleInstrumentBase) this.parameterEditor).ShowUnits = false;
    ((SingleInstrumentBase) this.parameterEditor).TitleLengthPercentOfControl = 30;
