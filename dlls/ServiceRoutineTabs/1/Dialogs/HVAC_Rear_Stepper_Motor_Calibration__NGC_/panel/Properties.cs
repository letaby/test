...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.HVAC_Rear_Stepper_Motor_Calibration__NGC_.panel.Properties
...
{
  public virtual int FileVersion => 12;

  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\HVAC Rear Stepper Motor Calibration (NGC).panel";
    }
  }

  public virtual string Guid => "7880ccf0-611e-4640-83f4-8b4ba3e800be";

  public virtual string DisplayName => "HVAC Rear Stepper Motor Calibration";
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      ...
      {
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_HVACRStepperCal"),
        new Qualifier((QualifierTypes) 1, "HVAC_R01T", "DT_Mix_Door_Actuator_Position_feedback_Mix_Door_Actuator_Position_feedback"),
        new Qualifier((QualifierTypes) 64 /*0x40*/, "HVAC_R01T", "RT_Stepper_Motor_Calibration_Request_Results_Discharge_Temperature_Control_Motor"),
