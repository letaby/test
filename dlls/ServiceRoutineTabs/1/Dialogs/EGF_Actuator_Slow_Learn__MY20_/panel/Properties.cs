...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.EGF_Actuator_Slow_Learn__MY20_.panel.Properties
...
{
  public virtual int FileVersion => 44;

  public virtual string FilePath
  {
    get
    {
      return "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\EGF Actuator Slow Learn (MY20).panel";
    }
  }

  public virtual string Guid => "1550b8c6-4855-4e57-bcad-7e92a09af8fc";

  public virtual string DisplayName => "Exhaust Gas Flap Actuator Slow Learn";
  ...
  public virtual IEnumerable<Qualifier> DesignerQualifierReferences
  {
    get
    {
      return (IEnumerable<Qualifier>) new Qualifier[2]
      {
        ...
        new Qualifier((QualifierTypes) 256 /*0x0100*/, "Extension", "SP_EGFActuatorSlowLearn_MY20")
      };
    }
  }
}
