...
// Type: DetroitDiesel.ServiceRoutineTabs.Dialogs.DEF_Quantity_Test__MY20_.panel.UserPanel
...
public class UserPanel : CustomPanel
{
  ...
  {
    Channel channel = this.GetChannel("ACM301T");
  ...
  private void UpdateInstruments()
  {
    if (this.channel == null)
      return;
    ((SingleInstrumentBase) this.digitalReadoutInstrumentAirlessDosingUreaPressure).Instrument = new Qualifier((QualifierTypes) 1, "ACM301T", "DT_AS014_DEF_Pressure");
  ...
  private void UpdateConnectedEquipmentType()
  {
    ...
    this.UpdateSharedProcedureSelection();
  }
  ...
  private void InitializeComponent()
  {
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentEnableAds).Instrument = new Qualifier((QualifierTypes) 1, "ACM301T", "DT_DS002_Enable_ADS");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentActualQuantity).Instrument = new Qualifier((QualifierTypes) 1, "ACM301T", "DT_AS160_Real_Time_ADS_DEF_Dosed_Quantity_g_hr");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentDosingQuantity).Instrument = new Qualifier((QualifierTypes) 1, "ACM301T", "DT_AS104_ADS_Doser_PWM");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentAdBluePumpSpeed).Instrument = new Qualifier((QualifierTypes) 1, "ACM301T", "DT_AS143_ADS_Pump_Speed");
    ...
    ((SingleInstrumentBase) this.digitalReadoutInstrumentResults).Instrument = new Qualifier((QualifierTypes) 64 /*0x40*/, "ACM301T", "RT_SCR_Dosing_Quantity_Check_Request_Results_status_of_service_function");
