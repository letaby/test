...
public class UserPanel : CustomPanel
{
	...
	private void InitializeComponent()
	{
		...
		((TableLayoutPanel)(object)tableLayoutPanel3).Controls.Add(button1, 1, 0);
		...
		((SingleInstrumentBase)parameterEditor).Instrument = new Qualifier((QualifierTypes)4, "CPC04T", "PCC_Enable");
		((Control)(object)parameterEditor).Name = "parameterEditor";
		((SingleInstrumentBase)parameterEditor).ShowBorder = false;
		((SingleInstrumentBase)parameterEditor).ShowUnits = false;
		((SingleInstrumentBase)parameterEditor).TitleLengthPercentOfControl = 50;
