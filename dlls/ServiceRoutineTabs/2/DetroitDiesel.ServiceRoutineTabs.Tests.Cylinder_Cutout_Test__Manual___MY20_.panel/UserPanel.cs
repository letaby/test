...
public class UserPanel : CustomPanel
{
	...
	private bool CanTurnCylinderOnOrOff => Online && stopTm5Mode && (int)digitalReadoutInstrumentTmMode.RepresentedState == 1;
	...
	{
		SetTmModeFunction(OriginalTmMode);
	}
	...
	private void SetTmModeFunction(int mode)
	{
		...
		if (setTmMode != null)
		{
			...
			if (mode == 5)
			{
				OriginalTmMode = Convert.ToInt32(mcm.Instruments["DT_AS190_Thermomanagement_status"].InstrumentValues.Current.Value);
	...
	private void InitializeComponent()
	{
		...
		digitalReadoutInstrumentTmMode = new DigitalReadoutInstrument();
		label9 = new Label();
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)digitalReadoutInstrumentTmMode, 4, 1);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)tableLayoutPanelTMMode, 0, 2);
		...
		((TableLayoutPanel)(object)tableLayoutPanelTMMode).Controls.Add(buttonSetTM5Mode, 0, 0);
		((TableLayoutPanel)(object)tableLayoutPanelTMMode).Controls.Add(buttonStopTM5Mode, 1, 0);
		((TableLayoutPanel)(object)tableLayoutPanelTMMode).Controls.Add((Control)(object)label9, 2, 0);
		...
		componentResourceManager.ApplyResources(digitalReadoutInstrumentTmMode, "digitalReadoutInstrumentTmMode");
		digitalReadoutInstrumentTmMode.FontGroup = null;
		((SingleInstrumentBase)digitalReadoutInstrumentTmMode).FreezeValue = false;
		digitalReadoutInstrumentTmMode.Gradient.Initialize((ValueState)2, 2);
		digitalReadoutInstrumentTmMode.Gradient.Modify(1, 5.0, (ValueState)1);
		digitalReadoutInstrumentTmMode.Gradient.Modify(2, 6.0, (ValueState)2);
		((SingleInstrumentBase)digitalReadoutInstrumentTmMode).Instrument = new Qualifier((QualifierTypes)1, "MCM21T", "DT_AS190_Thermomanagement_status");
		((Control)(object)digitalReadoutInstrumentTmMode).Name = "digitalReadoutInstrumentTmMode";
		((SingleInstrumentBase)digitalReadoutInstrumentTmMode).UnitAlignment = StringAlignment.Near;
		digitalReadoutInstrumentTmMode.RepresentedStateChanged += digitalReadoutInstrumentTmMode_RepresentedStateChanged;
