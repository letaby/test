...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Detroit Assurance ABA Misuse Reset(NGC).panel";

	public override string Guid => "e89f325e-33f6-4d9c-b9b5-53359137ee24";

	public override string DisplayName => "ABA Misuse Reset";

	public override IEnumerable<string> SupportedDevices => new string[1] { "VRDU02T" };
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[6]
	{
		...
		new Qualifier((QualifierTypes)2, "VRDU02T", "RT_Delete_permanent_errors_Start"),
		new Qualifier((QualifierTypes)2, "VRDU02T", "RT_Delete_permanent_errors_Request_Results_Delete_Results"),
		new Qualifier((QualifierTypes)64, "VRDU02T", "RT_Delete_permanent_errors_Request_Results_Delete_Results"),
		new Qualifier((QualifierTypes)32, "VRDU02T", "02FBFF")
	};
	...
	public override IEnumerable<string> UserSourceEcuReferences => new string[1] { "VRDU02T" };
