...
public class UserPanel : CustomPanel
{
	...
	{
		SetTcm(((CustomPanel)this).GetChannel("VRDU02T"));
	}
	...
	private void InitializeComponent()
	{
		...
		runServicesButton.ServiceCalls.Add(new ServiceCall("VRDU02T", "SES_Extended_P2_CAN_ECU_max_physical"));
		runServicesButton.ServiceCalls.Add(new ServiceCall("VRDU02T", "DJ_SecurityAccess_Routines"));
		runServicesButton.ServiceCalls.Add(new ServiceCall("VRDU02T", "RT_Delete_permanent_errors_Start"));
		runServicesButton.ServiceCalls.Add(new ServiceCall("VRDU02T", "RT_Delete_permanent_errors_Request_Results_Delete_Results"));
		...
		((SingleInstrumentBase)digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)64, "VRDU02T", "RT_Delete_permanent_errors_Request_Results_Delete_Results");
		...
		((SingleInstrumentBase)digitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes)32, "VRDU02T", "02FBFF");
