...
public class UserPanel : CustomPanel
{
	...
	public override void OnChannelsChanged()
	{
		...
		SetAcm(((CustomPanel)this).GetChannel("ACM301T"));
	}
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)barInstrumentCoolantTemperature).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS002_Coolant_Temperature");
		...
		((SingleInstrumentBase)barInstrumentDefTankTemperature).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS022_DEF_tank_Temperature");
		...
		runServiceButtonCoolantValveOpenStart.ServiceCall = new ServiceCall("ACM301T", "RT_Coolant_Valve_Open_Start_Coolant_Valve_Open_Status");
		...
		runServiceButtonCoolantValveOpenStop.ServiceCall = new ServiceCall("ACM301T", "RT_Coolant_Valve_Open_Stop");
		...
		((SingleInstrumentBase)digitalReadoutInstrumentCoolantValve).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_DS005_Coolant_Valve");
