...
public class UserPanel : CustomPanel
{
	...
	public override void OnChannelsChanged()
	{
		...
		channel = ((CustomPanel)this).GetChannel("MCM21T");
		if (channel != null)
		{
			channel.CommunicationsStateUpdateEvent += OnCommunicationsStateUpdate;
			ReadStoredData();
	...
	{
		if (channel != null && channel.EcuInfos["DT_STO_ACC047_OP_Data_4_PLV_Open_Counter"] != null)
		{
			channel.EcuInfos["DT_STO_ACC047_OP_Data_4_PLV_Open_Counter"].Read(synchronous: false);
		}
	}
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)8, "MCM21T", "DT_STO_ACC047_OP_Data_4_PLV_Open_Counter");
