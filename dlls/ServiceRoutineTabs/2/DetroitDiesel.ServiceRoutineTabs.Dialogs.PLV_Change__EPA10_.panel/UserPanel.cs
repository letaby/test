...
public class UserPanel : CustomPanel
{
	...
	public override void OnChannelsChanged()
	{
		...
		channel = ((CustomPanel)this).GetChannel("MCM02T");
		if (channel != null)
		{
			channel.CommunicationsStateUpdateEvent += OnCommunicationsStateUpdate;
			ReadParameters();
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)4, "MCM02T", "PLV_Open_Counter");
