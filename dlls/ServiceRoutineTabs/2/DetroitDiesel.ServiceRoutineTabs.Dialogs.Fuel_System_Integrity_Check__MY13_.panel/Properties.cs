...
{
	public override int FileVersion => 65;

	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Fuel System Integrity Check (MY13).panel";
	...
	public override IEnumerable<string> SupportedDevices => new string[2] { "MCM21T", "CPC04T" };

	public override IEnumerable<string> SupportedEquipment => new string[3] { "DDEC13-DD13", "DDEC13-DD15", "DDEC13-DD16" };
	...
	public override IEnumerable<Qualifier> RequiredQualifiers => (IEnumerable<Qualifier>)(object)new Qualifier[10]
	{
		new Qualifier((QualifierTypes)2, "MCM21T", "RT_SR015_Idle_Speed_Modification_Start"),
		new Qualifier((QualifierTypes)2, "MCM21T", "RT_SR015_Idle_Speed_Modification_Stop"),
	...
	public override IEnumerable<Qualifier> ProhibitedQualifiers => (IEnumerable<Qualifier>)(object)new Qualifier[5]
	{
		new Qualifier((QualifierTypes)2, "MCM21T", "RT_SR02FA_set_TM_mode_Request_Results_Current_TM_state"),
		...
		new Qualifier((QualifierTypes)2, "CPC04T", "RT_Engine_idle_speed_increase_Start"),
		new Qualifier((QualifierTypes)2, "CPC04T", "RT_Engine_idle_speed_increase_Stop")
	};
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[26]
	{
		...
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_Automatic_MY13"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_LeakTest_MY13"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_Manual_MY13")
	};
