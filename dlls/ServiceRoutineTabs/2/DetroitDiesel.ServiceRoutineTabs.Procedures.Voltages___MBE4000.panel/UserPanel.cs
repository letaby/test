...
public class UserPanel : CustomPanel
{
	...
	private void SetMarkedState(bool set)
	{
		...
		SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value3", set);
		...
		SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_ValueMBE", set);
	...
	private void InitializeComponent()
	{
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)digitalReadoutInstrument5, 0, 6);
		...
		((SingleInstrumentBase)DigitalReadoutInstrument10).Instrument = new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value3");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value1");
		...
		((SingleInstrumentBase)digitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_ValueMBE");
		...
		((SingleInstrumentBase)digitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value1");
