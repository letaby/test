...
public class UserPanel : CustomPanel
{
	...
	private void InitializeComponent()
	{
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).SetColumnSpan((Control)(object)tableStatusIndicators, 7);
		...
		sharedProcedureSelection1.SharedProcedureQualifiers = new SubjectCollection((IEnumerable<string>)new string[1] { "SP_PMSensorInspection_MY20" });
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)BarInstrument10, 5, 0);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)BarInstrument9, 6, 0);
		...
		((SingleInstrumentBase)digitalReadoutInstrument12).Instrument = new Qualifier((QualifierTypes)64, "ACM301T", "RT_SR0D3_PM_Sensor_inspection_Request_Results_End_of_DSR_shutdown_in_case_of_cooled_down_sensor");
		...
		((SingleInstrumentBase)digitalReadoutInstrument10).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_DS013_Soot_Sensor_Data_Prot_tube_monitoring_release");
		...
		((SingleInstrumentBase)digitalReadoutInstrument8).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS195_isp_dps_cid");
		...
		((SingleInstrumentBase)digitalReadoutInstrument6).Instrument = new Qualifier((QualifierTypes)64, "ACM301T", "RT_SR0D3_PM_Sensor_inspection_Request_Results_DPS_short_circuit_failure_value");
		...
		((SingleInstrumentBase)digitalReadoutInstrument7).Instrument = new Qualifier((QualifierTypes)64, "ACM301T", "RT_SR0D3_PM_Sensor_inspection_Request_Results_Measurement_active_value");
		...
		((SingleInstrumentBase)digitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_DS012_PM_sensor_active_status");
		...
		((SingleInstrumentBase)digitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_DS012_PM_sensor_regen_status");
		...
		((SingleInstrumentBase)digitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_DS014_Soot_Sensor_Data_regeneration_cycle_finished");
		...
		((SingleInstrumentBase)digitalReadoutInstrument9).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_DS013_Soot_Sensor_Data_Regeneration_active");
		...
		((SingleInstrumentBase)digitalReadoutInstrument13).Instrument = new Qualifier((QualifierTypes)64, "ACM301T", "RT_SR0D3_PM_Sensor_inspection_Request_Results_DPS_sum_failure");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS189_absolute_current_of_PM_sensor");
		...
		((SingleInstrumentBase)BarInstrument11).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS019_SCR_Outlet_Temperature");
		...
		((SingleInstrumentBase)BarInstrument10).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS190_measured_temp_at_PM_sensor");
		...
		((SingleInstrumentBase)BarInstrument9).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS194_isp_dps_t_mea_iv");
		...
		((SingleInstrumentBase)barInstrument14).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS053_Ambient_Air_Temperature");
		...
		((SingleInstrumentBase)BarInstrument13).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS009_DPF_Outlet_Temperature");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS191_PM_sensor_PWM_control");
