...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\SCR ADS Self Check (MY13).panel";
	...
	public override IEnumerable<string> SupportedEquipment => new string[8] { "DDEC13-DD13", "DDEC13-DD15", "DDEC13-DD16", "DDEC16-DD5", "DDEC16-DD8", "DDEC16-DD13", "DDEC16-DD15", "DDEC16-DD16" };
	...
	{
		new Qualifier((QualifierTypes)2, "ACM21T", "RT_SCR_ADS_SelfCheck_Routine_Request_Results_status_of_service_function"),
		new Qualifier((QualifierTypes)2, "ACM21T", "RT_SCR_ADS_SelfCheck_Routine_Start"),
		new Qualifier((QualifierTypes)2, "ACM21T", "RT_SCR_ADS_SelfCheck_Routine_Stop")
	};
	...
	{
		new Qualifier((QualifierTypes)256, "Extension", "SP_SCR_ADS_Self_Check_MY13"),
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS079_ADS_priming_request"),
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_DS011_ADS_dosing_valve_state"),
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS143_ADS_Pump_Speed"),
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS001_Engine_Speed"),
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS077_Vehicle_speed_from_ISP100ms"),
		new Qualifier((QualifierTypes)64, "ACM21T", "RT_SCR_ADS_SelfCheck_Routine_Request_Results_status_of_service_function"),
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS014_DEF_Pressure")
	};
