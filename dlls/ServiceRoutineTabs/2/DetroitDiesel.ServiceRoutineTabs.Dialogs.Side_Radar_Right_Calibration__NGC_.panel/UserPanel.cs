...
public class UserPanel : CustomPanel
{
	...
	{
		SetChannel(((CustomPanel)this).GetChannel("SRRR01T"));
	}
	...
	private void sharedProcedureCreatorComponent_MonitorServiceComplete(object sender, MonitorServiceResultEventArgs e)
	{
		...
		if (((int)((MonitorResultEventArgs)e).Action != 0 && (int)((MonitorResultEventArgs)e).Action != 1) || !(calibrateRequestResultsProgressService != null))
		{
			return;
		}
		try
	...
	private void InitializeComponent()
	{
		...
		sharedProcedureSelection.SharedProcedureQualifiers = new SubjectCollection((IEnumerable<string>)new string[1] { "SP_SRRRCalibration" });
		...
		seekTimeListViewLog.RequiredUserLabelPrefix = "SRRR-Calibration";
		...
		((SingleInstrumentBase)digitalReadoutInstrumentRequestResultsStatus).Instrument = new Qualifier((QualifierTypes)64, "SRRR01T", "RT_Service_Alignment_Azimuth_Request_Results_Routine_Status");
		...
		sharedProcedureCreatorComponent.MonitorCall = new ServiceCall("SRRR01T", "RT_Service_Alignment_Azimuth_Request_Results_Routine_Status");
		...
		sharedProcedureCreatorComponent.Qualifier = "SP_SRRRCalibration";
		sharedProcedureCreatorComponent.StartCall = new ServiceCall("SRRR01T", "RT_Service_Alignment_Azimuth_Start");
		...
		sharedProcedureCreatorComponent.StopCall = new ServiceCall("SRRR01T", "RT_Service_Alignment_Azimuth_Stop");
