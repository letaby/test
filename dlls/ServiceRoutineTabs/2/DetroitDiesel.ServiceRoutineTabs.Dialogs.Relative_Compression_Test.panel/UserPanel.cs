...
public class UserPanel : CustomPanel, IProvideHtml
{
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)engineSpeedDigitalReadoutInstrument).Instrument = new Qualifier((QualifierTypes)1, "MCM", "DT_AS010_Engine_Speed");
		...
		DigitalReadoutInstrument1.Gradient.Initialize((ValueState)0, 3);
