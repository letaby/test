...
public class UserPanel : CustomPanel
{
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)digitalReadoutInstrumentPFuelFilterAct).Instrument = new Qualifier((QualifierTypes)1, "MCM21T", "DT_AS124_LPPO_Fuel_Pressure");
		...
		((SingleInstrumentBase)digitalReadoutInstrumentFuelFilterState).Instrument = new Qualifier((QualifierTypes)1, "MCM21T", "DT_AS125_Fuel_Filter_State");
