...
public class UserPanel : CustomPanel
{
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)digitalReadoutIgnitionCycle).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "DT_AS047_Ignition_Cycle_Counter");
		...
		((SingleInstrumentBase)digitalReadoutEngineHours).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "DT_AS045_Engine_Operating_Hours");
		...
		((SingleInstrumentBase)digitalReadoutWaterLifetimeCountInstrument).Instrument = new Qualifier((QualifierTypes)4, "MCM02T", "e2p_l_water_raised_eng_hours");
		...
		((SingleInstrumentBase)digitalReadoutWaterLifetimeCountParameter).Instrument = new Qualifier((QualifierTypes)4, "MCM02T", "e2p_l_water_raised_eng_starts");
		...
		((SingleInstrumentBase)digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)32, "MCM02T", "61000F");
		...
		((SingleInstrumentBase)digitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes)32, "MCM02T", "610010");
