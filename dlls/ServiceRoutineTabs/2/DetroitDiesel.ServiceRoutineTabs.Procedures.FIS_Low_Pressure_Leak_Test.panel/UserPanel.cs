...
public class UserPanel : CustomPanel
{
	...
	{
		Service service = ((CustomPanel)this).GetService("MCM02T", "RT_SR003_PWM_Routine_by_Function_for_Production_Start_Control_Value");
	...
	{
		Service service = ((CustomPanel)this).GetService("MCM02T", "RT_SR003_PWM_Routine_by_Function_for_Production_Stop_Function_Name");
	...
	private void InitializeComponent()
	{
		...
		seekTimeListView.RequiredUserLabelPrefix = "FIS Low Pressure Leak";
		...
		((Collection<Qualifier>)(object)chartInstrument.Instruments).Add(new Qualifier((QualifierTypes)1, "MCM02T", "DT_AS024_Fuel_Compensation_Pressure"));
		...
		((SingleInstrumentBase)fuelCompensationPressureInstrument).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "DT_AS024_Fuel_Compensation_Pressure");
