...
{
	public override int FileVersion => 137;

	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Procedures\\SCR System (MY20).panel";
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[44]
	{
		...
		new Qualifier((QualifierTypes)256, "Extension", "SP_ChassisDynoBasicScrConversionCheck_MY20"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_OutputComponentTest_MY20"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_ParkedScrEfficiencyTest_MY20"),
