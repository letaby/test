...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Fuel System Integrity Check (MY17).panel";
	...
	public override IEnumerable<string> SupportedEquipment => new string[9] { "DDEC16-DD13", "DDEC16-DD15", "DDEC16-DD16", "DDEC20-DD13", "DDEC20-DD15", "DDEC20-DD16", "DDEC20-DD11 StageV", "DDEC20-DD13 StageV", "DDEC20-DD16 StageV" };
	...
	public override IEnumerable<Qualifier> RequiredQualifiers => (IEnumerable<Qualifier>)(object)new Qualifier[8]
	{
		...
		new Qualifier((QualifierTypes)2, "MCM21T", "RT_SR018_Disable_HC_Doser_Start"),
		new Qualifier((QualifierTypes)2, "MCM21T", "RT_SR018_Disable_HC_Doser_Stop")
	};

	public override FaultCondition RequiredFaultCondition => new FaultCondition((FaultConditionType)0, (IEnumerable<Qualifier>)(object)new Qualifier[0]);

	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[28]
	{
		...
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_Automatic_MY20"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_Automatic_MY17"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_LeakTest_MY17"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_LeakTest_MY20"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_Manual_MY17"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_Manual_MY20")
	};

	public override IEnumerable<string> UserSourceEcuReferences => new string[1] { "MCM21T" };

	public override IEnumerable<string> UserSourceInstrumentQualifierReferences => new string[5] { "DT_AS115_HP_Leak_Actual_Value", "DT_STO_ACC047_OP_Data_4_HP_Leak_Learned_Counter", "DT_STO_ACC047_OP_Data_4_HP_Leak_Learned_Value", "DT_AS124_LPPO_Fuel_Pressure", "DT_AAS_LPPO_Fuel_Pressure" };
