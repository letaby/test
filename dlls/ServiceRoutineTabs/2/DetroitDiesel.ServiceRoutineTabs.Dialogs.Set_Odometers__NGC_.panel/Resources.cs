...
public class Resources
{
	...
	internal static string Message_CPCServiceNA => ResourceManager.GetString("StringTable.Message_CPCServiceNA");

	internal static string Message_InstrumentClusterOdometer => ResourceManager.GetString("StringTable.Message_InstrumentClusterOdometer");
	...
	internal static string Message_SettingCPC => ResourceManager.GetString("StringTable.Message_SettingCPC");

	internal static string Message_SettingInstrumentCluster => ResourceManager.GetString("StringTable.Message_SettingInstrumentCluster");
}
