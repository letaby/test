...
public class UserPanel : CustomPanel
{
	...
	private class NOxSensorDriftTest
	{
		...
		private void SetDEFValve()
		{
			if (ParentUserPanel.acm != null && ParentUserPanel.acm.Online)
			{
				...
				Service service = ((CustomPanel)ParentUserPanel).GetService("ACM21T", "RT_SCR_Dosing_Quantity_Check_Start_Status");
				if (service != null)
				{
		...
		private void StartDPFRegen()
		{
			...
			case CpcVersion.CPC3:
				...
				break;
			case CpcVersion.CPC4:
				text = "RT_DPF_Regeneration_Start";
				break;
			...
			if (service != null)
			{
				if (ParentUserPanel.ConnectedCpcVersion == CpcVersion.CPC4)
				{
					service.InputValues["PREP_1_Byte_Regen_Request"].Value = service.InputValues["PREP_1_Byte_Regen_Request"].Choices.GetItemFromRawValue(1);
				}
		...
		private void ResetDEFValve()
		{
			...
			Service service = ((CustomPanel)ParentUserPanel).GetService("ACM21T", "RT_SCR_Dosing_Quantity_Check_Stop_status");
			if (!(service != null))
			{
				return;
			}
	...
	private bool UpdateChannels()
	{
		...
		flag3 = SetACM(GetActiveChannel("ACM21T"));
	...
	private bool SetCPC(Channel cpc)
	{
		if (this.cpc != cpc)
		{
			...
			if (this.cpc != null)
			{
				...
				{
					ConnectedCpcVersion = CpcVersion.CPC4;
				}
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)digitalReadoutInstrumentDPFRegenState).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS064_DPF_Regen_State");
		...
		((SingleInstrumentBase)digitalReadoutInstrumentNOxDewpointInlet).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS105_NOx_Sensor_Dewpoint_enabled_Inlet");
		...
		((SingleInstrumentBase)barInstrument4).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS019_SCR_Outlet_Temperature");
		...
		((SingleInstrumentBase)barInstrumentNOxRaw).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS111_NOx_raw_concentration");
		...
		((SingleInstrumentBase)barInstrumentNOxOut).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS114_NOx_out_concentration");
		...
		((SingleInstrumentBase)barInstrument1).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS036_SCR_Inlet_NOx_Sensor");
		...
		((SingleInstrumentBase)barInstrument2).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS035_SCR_Outlet_NOx_Sensor");
		...
		barInstrument3.FontGroup = "ThermometerBar";
		((SingleInstrumentBase)barInstrument3).FreezeValue = false;
		((SingleInstrumentBase)barInstrument3).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS018_SCR_Inlet_Temperature");
		...
		((SingleInstrumentBase)digitalReadoutInstrument_e2p_nox_out_dia_sens_runtime).Instrument = new Qualifier((QualifierTypes)4, "ACM21T", "e2p_nox_out_dia_sens_runtime");
		...
		((SingleInstrumentBase)digitalReadoutInstrument_e2p_nox_raw_dia_sens_runtime).Instrument = new Qualifier((QualifierTypes)4, "ACM21T", "e2p_nox_raw_dia_sens_runtime");
		...
		((TableLayoutPanel)(object)tableLayoutPanelThermometers).Controls.Add((Control)(object)barInstrument3, 0, 0);
		((TableLayoutPanel)(object)tableLayoutPanelThermometers).Controls.Add((Control)(object)barInstrument4, 1, 0);
		((TableLayoutPanel)(object)tableLayoutPanelThermometers).Controls.Add((Control)(object)barInstrument7, 2, 0);
		((TableLayoutPanel)(object)tableLayoutPanelThermometers).Controls.Add((Control)(object)barInstrument8, 3, 0);
		((TableLayoutPanel)(object)tableLayoutPanelThermometers).Controls.Add((Control)(object)barInstrument9, 4, 0);
		...
		((SingleInstrumentBase)barInstrument7).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS007_DOC_Inlet_Temperature");
		...
		((SingleInstrumentBase)barInstrument8).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS008_DOC_Outlet_Temperature");
		((Control)(object)barInstrument8).Name = "barInstrument8";
		((AxisSingleInstrumentBase)barInstrument8).PreferredAxisRange = new AxisRange(-500.0, 2000.0, (string)null);
		...
		((SingleInstrumentBase)barInstrument9).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS009_DPF_Outlet_Temperature");
		...
		((SingleInstrumentBase)digitalReadoutInstrumentNOxDewpointOutlet).Instrument = new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS106_NOx_Sensor_Dewpoint_enabled_Outlet");
