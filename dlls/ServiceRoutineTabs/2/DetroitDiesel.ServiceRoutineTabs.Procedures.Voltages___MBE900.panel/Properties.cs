...
namespace DetroitDiesel.ServiceRoutineTabs.Procedures.Voltages___MBE900.panel;

public class Properties : PanelProperties
{
	public override int FileVersion => 20;

	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Procedures\\Voltages - MBE900.panel";
	...
	public override IEnumerable<string> SupportedEquipment => new string[1] { "MBE900" };
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[19]
	{
		...
		new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value3"),
		new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value4"),
