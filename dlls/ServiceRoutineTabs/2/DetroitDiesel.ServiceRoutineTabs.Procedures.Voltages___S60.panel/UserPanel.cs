...
public class UserPanel : CustomPanel
{
	...
	private void SetMarkedState(bool set)
	{
		...
		SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value2", set);
		SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value3", set);
		...
		SetMarkedState("MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value1", set);
	...
	private void InitializeComponent()
	{
		...
		DigitalReadoutInstrument22 = new DigitalReadoutInstrument();
		DigitalReadoutInstrument53 = new DigitalReadoutInstrument();
		...
		((SingleInstrumentBase)DigitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value3");
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)DigitalReadoutInstrument22, 0, 6);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)DigitalReadoutInstrument53, 1, 4);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)DigitalReadoutInstrument2, 1, 7);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)DigitalReadoutInstrument5, 1, 8);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add(stop, 1, 9);
		...
		((SingleInstrumentBase)DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value5");
		...
		componentResourceManager.ApplyResources(DigitalReadoutInstrument22, "DigitalReadoutInstrument22");
		DigitalReadoutInstrument22.FontGroup = null;
		((SingleInstrumentBase)DigitalReadoutInstrument22).FreezeValue = false;
		((SingleInstrumentBase)DigitalReadoutInstrument22).Instrument = new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value2");
		((Control)(object)DigitalReadoutInstrument22).Name = "DigitalReadoutInstrument22";
		((SingleInstrumentBase)DigitalReadoutInstrument22).UnitAlignment = StringAlignment.Near;
		componentResourceManager.ApplyResources(DigitalReadoutInstrument53, "DigitalReadoutInstrument53");
		DigitalReadoutInstrument53.FontGroup = null;
		((SingleInstrumentBase)DigitalReadoutInstrument53).FreezeValue = false;
		((SingleInstrumentBase)DigitalReadoutInstrument53).Instrument = new Qualifier((QualifierTypes)1, "MCM", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value1");
		((Control)(object)DigitalReadoutInstrument53).Name = "DigitalReadoutInstrument53";
		((SingleInstrumentBase)DigitalReadoutInstrument53).UnitAlignment = StringAlignment.Near;
