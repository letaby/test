...
public class UserPanel : CustomPanel
{
	...
	{
		SetMarkedState("ACM02T", "RT_Sensor_Voltage_DPF_Outlet_Pressure", set);
		SetMarkedState("ACM02T", "RT_Sensor_Voltage_DOC_Inlet_Pressure", set);
		SetMarkedState("ACM02T", "RT_Sensor_Voltage_DOC_Inlet_Temp", set);
		SetMarkedState("ACM02T", "RT_Sensor_Voltage_DOC_Outlet_Temp", set);
		SetMarkedState("ACM02T", "RT_Sensor_Voltage_DPF_Outlet_Temp", set);
	}
	...
	private void InitializeComponent()
	{
		...
		((TableLayoutPanel)(object)tableLayoutPanel2).Controls.Add(progresstextBox, 0, 0);
		((Control)(object)tableLayoutPanel2).Name = "tableLayoutPanel2";
		((TableLayoutPanel)(object)tableLayoutPanel1).SetRowSpan((Control)(object)tableLayoutPanel2, 2);
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)DigitalReadoutInstrument10, 0, 6);
		...
		((SingleInstrumentBase)digitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "DT_AS097_DEF_Temperature_Sensor_Voltage");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument10).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "DT_AS099_DEF_Air_Pressure_Sensor_Voltage");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument7).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "DT_AS098_DEF_Pressure_Sensor_Voltage");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument53a).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "DT_AS093_DEF_Tank_Temperature_Sensor_Voltage");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument2a).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "DT_AS094_DEF_Tank_Level_Sensor_Voltage");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument5a).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "DT_AS095_SCR_Inlet_Temperature_Sensor_Voltage");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument8a).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "DT_AS096_SCR_Oulet_Temperature_Sensor_Voltage");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "RT_Sensor_Voltage_DOC_Inlet_Temp");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument43).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "RT_Sensor_Voltage_DOC_Outlet_Temp");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "RT_Sensor_Voltage_DPF_Outlet_Temp");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument23a).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "RT_Sensor_Voltage_DOC_Inlet_Pressure");
		...
		((SingleInstrumentBase)digitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes)1, "ACM02T", "RT_Sensor_Voltage_DPF_Outlet_Pressure");
