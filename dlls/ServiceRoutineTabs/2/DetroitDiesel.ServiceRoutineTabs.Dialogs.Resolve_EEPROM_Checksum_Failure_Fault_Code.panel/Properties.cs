...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Resolve EEPROM Checksum Failure Fault Code.panel";
	...
	{
		new Qualifier((QualifierTypes)0, "CPC02T", "740202")
	});

	public override IEnumerable<string> UserSourceEcuReferences => new string[1] { "CPC02T" };

	public override IEnumerable<string> UserSourceInstrumentQualifierReferences => new string[2] { "RT_Reload_Original_CPC_Factory_Settings_All_of_EEPROM_minus_SVDO_Block_Start_Routine_Status", "FN_KeyOffOnReset" };
