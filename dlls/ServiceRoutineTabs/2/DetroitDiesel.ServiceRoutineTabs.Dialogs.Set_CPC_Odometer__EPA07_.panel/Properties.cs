...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Set CPC Odometer (EPA07).panel";

	public override string Guid => "bceccbd2-7786-4771-936c-820b9a390cae";

	public override string DisplayName => "Set Odometer";

	public override IEnumerable<string> SupportedDevices => new string[1] { "CPC2" };
	...
	{
		new Qualifier((QualifierTypes)8, "CPC2", "CO_Odometer")
	};

	public override IEnumerable<string> UserSourceEcuReferences => new string[1] { "CPC2" };
