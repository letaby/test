...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\SCR Replacement (MY20).panel";
	...
	{
		new Qualifier((QualifierTypes)4, "ACM301T", "Time_Above_SCR_Inlet_Temp_1_Hour"),
		new Qualifier((QualifierTypes)4, "ACM301T", "Time_Above_SCR_Inlet_Temp_1_Min"),
		new Qualifier((QualifierTypes)4, "ACM301T", "Time_Above_SCR_Inlet_Temp_1_Sec"),
		new Qualifier((QualifierTypes)4, "ACM301T", "Time_Above_SCR_Inlet_Temp_2"),
		new Qualifier((QualifierTypes)4, "ACM301T", "Time_Above_SCR_Outlet_Temp")
	};

	public override IEnumerable<string> UserSourceEcuReferences => new string[2] { "ACM301T", "MCM21T" };
