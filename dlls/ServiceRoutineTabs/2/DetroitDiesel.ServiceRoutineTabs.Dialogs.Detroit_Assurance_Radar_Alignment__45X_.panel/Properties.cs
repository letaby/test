...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Detroit Assurance Radar Alignment (45X).panel";

	public override string Guid => "519cdc0d-804d-438f-afef-f60080743cd3";

	public override string DisplayName => "Radar Alignment";

	public override IEnumerable<string> SupportedDevices => new string[1] { "RDF03T" };
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[5]
	{
		...
		new Qualifier((QualifierTypes)64, "RDF03T", "RT_Service_Alignment_Request_Results_Progress"),
		new Qualifier((QualifierTypes)1, "J1939-0", "DT_70"),
		new Qualifier((QualifierTypes)4, "RDF03T", "VertPos"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_DrivingRadarAlignment_45X")
	};

	public override IEnumerable<string> UserSourceEcuReferences => new string[1] { "RDF03T" };
