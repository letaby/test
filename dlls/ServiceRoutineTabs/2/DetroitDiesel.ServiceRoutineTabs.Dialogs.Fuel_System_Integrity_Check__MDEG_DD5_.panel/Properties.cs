...
{
	public override int FileVersion => 155;

	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Fuel System Integrity Check (MDEG-DD5).panel";
	...
	public override IEnumerable<string> SupportedEquipment => new string[1] { "DDEC16-DD5" };
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[26]
	{
		...
		new Qualifier((QualifierTypes)256, "Extension", "SP_FuelSystemIntegrityCheck_Automatic_MDEG_DD5"),
