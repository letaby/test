...
public class UserPanel : CustomPanel
{
	...
	private void InitializeComponent()
	{
		...
		sharedProcedureSelection.SharedProcedureQualifiers = new SubjectCollection((IEnumerable<string>)new string[1] { "SP_EGFActuatorSlowLearn_MY20" });
		...
		((CustomPanel)this).ContextLink = new Link("_DDDL.chm_Exhaust_Gas_Flap_Actuator_Slow_Learn");
