...
public class UserPanel : CustomPanel
{
	...
	private void InitializeComponent()
	{
		...
		((TableLayoutPanel)(object)tableLayoutPanel3).Controls.Add((Control)(object)labelNote1, 0, 0);
		...
		labelNote1.Alignment = StringAlignment.Near;
		componentResourceManager.ApplyResources(labelNote1, "labelNote1");
		((Control)(object)labelNote1).Name = "labelNote1";
		labelNote1.Orientation = (TextOrientation)1;
		labelNote1.UseSystemColors = true;
		...
		sharedProcedureSelection.SharedProcedureQualifiers = new SubjectCollection((IEnumerable<string>)new string[1] { "SP_EGRActuatorSlowLearn_EPA10" });
		...
		((SingleInstrumentBase)digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "DT_AS050_SRA3_Status_Code");
