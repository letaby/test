...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\MPC1 Calibration for Service (Econic).panel";

	public override string Guid => "882a394f-bc7a-4553-aaec-a129138a9aef";

	public override string DisplayName => "MPC1 Camera Alignment";

	public override IEnumerable<string> SupportedDevices => new string[1] { "MPC01T" };

	public override IEnumerable<string> SupportedEquipment => new string[1] { "Econic-Waste" };
