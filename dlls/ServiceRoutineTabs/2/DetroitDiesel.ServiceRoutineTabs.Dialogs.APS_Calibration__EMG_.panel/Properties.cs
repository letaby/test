...
{
	public override int FileVersion => 89;

	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\APS Calibration (EMG).panel";
	...
	public override IEnumerable<string> SupportedEquipment => new string[2] { "eCascadia-Daycab", "eCascadia-Sleeper" };
	...
	public override IEnumerable<string> UserSourceEcuReferences => new string[5] { "APS301T", "ABS02T", "ECPC01T", "VRDU02T", "J1939-0" };
