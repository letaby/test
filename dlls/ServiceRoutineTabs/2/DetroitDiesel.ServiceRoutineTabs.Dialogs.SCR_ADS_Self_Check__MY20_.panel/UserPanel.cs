...
public class UserPanel : CustomPanel
{
	...
	private void InitializeComponent()
	{
		...
		sharedProcedureSelection.SharedProcedureQualifiers = new SubjectCollection((IEnumerable<string>)new string[1] { "SP_SCR_ADS_Self_Check_MY20" });
		...
		((SingleInstrumentBase)digitalReadoutInstrumentADSDosingValveState).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_DS011_ADS_dosing_valve_state");
		...
		((SingleInstrumentBase)digitalReadoutInstrumentADSPumpSpeed).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS143_ADS_Pump_Speed");
		...
		((SingleInstrumentBase)digitalReadoutInstrumentEngineSpeed).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS001_Engine_Speed");
		...
		((SingleInstrumentBase)digitalReadoutInstrumentVehicleSpeed).Instrument = new Qualifier((QualifierTypes)1, "ACM301T", "DT_AS077_Vehicle_speed_from_ISP100ms");
		...
		((SingleInstrumentBase)digitalReadoutInstrumentResults).Instrument = new Qualifier((QualifierTypes)64, "ACM301T", "RT_SCR_ADS_SelfCheck_Routine_Request_Results_status_of_service_function");
