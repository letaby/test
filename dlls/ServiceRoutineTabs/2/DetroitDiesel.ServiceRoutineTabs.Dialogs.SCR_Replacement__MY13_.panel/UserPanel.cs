...
public class UserPanel : CustomPanel
{
	...
	private static readonly ValidationInformation Euro5SerialNumberValidation = new ValidationInformation(new Regex("(^\\S{14}$)", RegexOptions.Compiled), Resources.Message_Euro5SerialNumberShouldBeOfTheFormatXXXXXXXXXXXXXX);
	...
	public UserPanel()
	{
		...
		serialNumberValidations.Add("DD13EURO5", Euro5SerialNumberValidation);
		serialNumberValidations.Add("DD16EURO5", Euro5SerialNumberValidation);
	...
	{
		if (SetACM(((CustomPanel)this).GetChannel("ACM21T")) && SetMCM2(((CustomPanel)this).GetChannel("MCM21T")))
		{
	...
	private static bool HasUnsentChanges(Channel channel)
	{
		...
		{
			if ((!acmScrAccumulatorQualifiers.Contains(parameter.Name) || channel.Ecu.Name != "ACM21T") && !object.Equals(parameter.Value, parameter.OriginalValue))
			{
				result = true;
				break;
			}
	...
	private void ReadAccumulators(bool synchronous)
	{
		...
		foreach (string acmScrAccumulatorQualifier in acmScrAccumulatorQualifiers)
		{
			DataItem obj = DataItem.Create(new Qualifier((QualifierTypes)4, "ACM21T", acmScrAccumulatorQualifier), (IEnumerable<Channel>)SapiManager.GlobalInstance.ActiveChannels);
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)4, "ACM21T", "Time_Above_SCR_Inlet_Temp_1_Hour");
		...
		((SingleInstrumentBase)digitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes)4, "ACM21T", "Time_Above_SCR_Inlet_Temp_1_Min");
		...
		((SingleInstrumentBase)digitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes)4, "ACM21T", "Time_Above_SCR_Inlet_Temp_1_Sec");
		...
		((SingleInstrumentBase)digitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes)4, "ACM21T", "Time_Above_SCR_Inlet_Temp_2");
		...
		((SingleInstrumentBase)digitalReadoutInstrument5).Instrument = new Qualifier((QualifierTypes)4, "ACM21T", "Time_Above_SCR_Outlet_Temp");
