...
public class UserPanel : CustomPanel
{
	...
	private void UpdateTemperatureCheck()
	{
		...
		else
		{
			...
			{
				text += string.Format(Resources.MessageFormat_FuelTemperatureMustBeAtLeast, GetOkMinimumString(((AxisSingleInstrumentBase)fuelTemperatureInstrument).Gradient));
			}
	...
	private void InitializeComponent()
	{
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add(buttonClose, 5, 8);
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).SetColumnSpan((Control)(object)tableLayoutPanel2, 6);
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).SetColumnSpan((Control)testStatusLabel, 5);
