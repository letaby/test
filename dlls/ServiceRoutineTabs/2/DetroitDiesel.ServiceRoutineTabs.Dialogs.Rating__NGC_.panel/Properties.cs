...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Rating (NGC).panel";

	public override string Guid => "e79a3dfe-9e51-49d3-bf4f-22e01f3a680c";

	public override string DisplayName => "Rating";

	public override IEnumerable<string> SupportedDevices => new string[4] { "CPC302T", "CPC501T", "CPC502T", "MCM21T" };
	...
	public override IEnumerable<string> UserSourceEcuReferences => new string[3] { "CPC302T", "MCM21T", "CPC501T" };
