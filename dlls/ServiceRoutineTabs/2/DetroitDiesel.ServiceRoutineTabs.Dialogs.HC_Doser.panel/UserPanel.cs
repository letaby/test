...
public class UserPanel : CustomPanel
{
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)BarInstrument12).Instrument = new Qualifier((QualifierTypes)1, "MCM", "DT_AS013_Coolant_Temperature");
		...
		((SingleInstrumentBase)BarInstrument13).Instrument = new Qualifier((QualifierTypes)1, "MCM", "DT_AS017_Inlet_Manifold_Temperature");
		...
		((SingleInstrumentBase)BarInstrument2).Instrument = new Qualifier((QualifierTypes)1, "MCM", "DT_AS018_Inlet_Manifold_Pressure");
		...
		((SingleInstrumentBase)BarInstrument1).Instrument = new Qualifier((QualifierTypes)1, "CPC2", "DT_AS005_Accelerator_Pedal_Position");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)1, "MCM", "DT_AS010_Engine_Speed");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument2).Instrument = new Qualifier((QualifierTypes)1, "MCM", "DT_AS012_Vehicle_Speed");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument3).Instrument = new Qualifier((QualifierTypes)1, "MCM", "DT_AS023_Engine_State");
		...
		((SingleInstrumentBase)barFuelPressure).Instrument = new Qualifier((QualifierTypes)1, "MCM", "DT_AS024_Fuel_Compensation_Pressure");
		...
		((SingleInstrumentBase)barInstrument3).Instrument = new Qualifier((QualifierTypes)16, "fake", "FakeBoostPressure");
		...
		hcDoserButton.Qualifier = "SP_HCDoserPurge_EPA07";
