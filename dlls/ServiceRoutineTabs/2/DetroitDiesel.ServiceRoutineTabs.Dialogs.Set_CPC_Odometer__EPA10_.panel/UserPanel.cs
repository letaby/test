...
public class UserPanel : CustomPanel
{
	...
	private void UpdateChannels()
	{
		...
		Channel channel = ((CustomPanel)this).GetChannel("CPC02T");
		if (cpc == channel)
		{
			return;
		}
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)digitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)8, "CPC02T", "CO_Odometer");
