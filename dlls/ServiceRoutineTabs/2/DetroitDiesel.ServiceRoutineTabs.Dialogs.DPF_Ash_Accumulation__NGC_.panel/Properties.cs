...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\DPF Ash Accumulation (NGC).panel";
	...
	public override PanelTargets TargetHosts => (PanelTargets)15;
	...
	public override IEnumerable<Qualifier> RequiredQualifiers => (IEnumerable<Qualifier>)(object)new Qualifier[6]
	{
		...
		new Qualifier((QualifierTypes)4, "ACM21T", "ATD_Hardware_Type"),
	...
	public override IEnumerable<string> UserSourceEcuReferences => new string[3] { "ACM21T", "MCM21T", "CPC04T" };

	public override IEnumerable<string> UserSourceInstrumentQualifierReferences => new string[5] { "DT_AS109_Ash_Filter_Full_Volume", "RT_SR08B_DPF_ash_volume_ratio_update_Start", "RT_SR08B_DPF_ash_volume_ratio_update_Request_Results_E2P_DPF_ASH_VOL_ACM", "RT_Ash_Volume_Ratio_Update_Start_Ash_Ratio_for_dpf_volume_correction", "DT_AS045_Engine_Operating_Hours" };
