...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\DOC Face Plug Cleaning.panel";
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[27]
	{
		...
		new Qualifier((QualifierTypes)64, "ACM21T", "RT_DOC_Face_Plug_Unclogging_Request_Results_Status"),
	...
	public override IEnumerable<string> UserSourceEcuReferences => new string[3] { "CPC04T", "SSAM02T", "ACM21T" };

	public override IEnumerable<string> UserSourceInstrumentQualifierReferences => new string[4] { "DT_DSL_DPF_Regen_Switch_Status", "RT_MSC_GetSwState_Start_Switch_033", "DT_AS014_DEF_Pressure", "DT_AS110_ADS_DEF_Pressure_2" };
