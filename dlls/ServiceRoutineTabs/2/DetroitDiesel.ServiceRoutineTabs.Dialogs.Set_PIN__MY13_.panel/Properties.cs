...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\Set PIN (MY13).panel";

	public override string Guid => "2f8f3c8c-e7d7-47b8-9884-0ef1d480672d";

	public override string DisplayName => "Set Engine Serial Number/Product Identification Number";

	public override IEnumerable<string> SupportedDevices => new string[4] { "ACM21T", "ACM301T", "CPC04T", "MCM21T" };
	...
	public override IEnumerable<string> UserSourceEcuReferences => new string[3] { "MCM21T", "ACM21T", "CPC04T" };
