...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\EGR Valve Replacement (MY16).panel";

	public override string Guid => "a79bea4d-c5a5-4237-b18c-2c749f1f3406";

	public override string DisplayName => "EGR Valve Replacement";
	...
	{
		new ServiceCall("MCM21T", "RT_SR0C6_Reset_EGR_values_Start", (IEnumerable<string>)new string[1] { "Reset_Type=255" })
	};
