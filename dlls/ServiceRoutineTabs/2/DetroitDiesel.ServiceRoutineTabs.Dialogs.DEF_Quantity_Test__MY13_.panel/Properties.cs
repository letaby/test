...
public class Properties : PanelProperties
{
	...
	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\DEF Quantity Test (MY13).panel";
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[9]
	{
		...
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_DS002_Enable_ADS"),
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS160_Real_Time_ADS_DEF_Dosed_Quantity_g_hr"),
		new Qualifier((QualifierTypes)1, "ACM21T", "DT_AS104_ADS_Doser_PWM"),
		...
		new Qualifier((QualifierTypes)64, "ACM21T", "RT_SCR_Dosing_Quantity_Check_Request_Results_status_of_service_function"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_DEFQuantityTest_MY13"),
		new Qualifier((QualifierTypes)256, "Extension", "SP_DEFQuantityTest_MY13_MDEG")
	};
	...
	public override IEnumerable<string> UserSourceSharedProcedureQualifierReferences => new string[2] { "SP_DEFQuantityTest_MY13_MDEG", "SP_DEFQuantityTest_MY13" };
