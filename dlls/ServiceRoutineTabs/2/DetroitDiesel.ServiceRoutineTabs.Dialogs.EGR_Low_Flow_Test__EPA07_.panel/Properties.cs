...
{
	public override int FileVersion => 183;

	public override string FilePath => "C:\\Users\\Public\\Source\\drumroll\\drumroll\\Source\\\\Data\\Service Routine Tabs\\Dialogs\\EGR Low Flow Test (EPA07).panel";
	...
	public override IEnumerable<string> SupportedEquipment => new string[4] { "DD13", "DD15", "DD15EURO4", "DD16" };
	...
	public override IEnumerable<Qualifier> RequiredQualifiers => (IEnumerable<Qualifier>)(object)new Qualifier[6]
	{
		...
		new Qualifier((QualifierTypes)1, "MCM", "DT_AS060_Temperature_Icooler_Out"),
		...
		new Qualifier((QualifierTypes)1, "MCM", "DT_AS025_EGR_Delta_Pressure")
	};
	...
	public override IEnumerable<Qualifier> DesignerQualifierReferences => (IEnumerable<Qualifier>)(object)new Qualifier[7]
	{
		...
		new Qualifier((QualifierTypes)1, "MCM", "DT_AS031_EGR_Commanded_Governor_Value"),
		new Qualifier((QualifierTypes)1, "MCM", "DT_AS060_Temperature_Icooler_Out"),
		new Qualifier((QualifierTypes)32, "MCM", "826900"),
	...
	public override IEnumerable<string> UserSourceInstrumentQualifierReferences => new string[4] { "RT_SR015_Idle_Speed_Modification_Start", "RT_SR015_Idle_Speed_Modification_Stop", "DT_AS060_Temperature_Icooler_Out", "DT_AS013_Coolant_Temperature" };
