...
public class UserPanel : CustomPanel
{
	...
	{
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value0", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value1", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value4", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value5", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value6", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value7", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value8", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value2", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value4", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value5", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value8", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value9", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value10", set);
		SetMarkedState("MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value12", set);
	}
	...
	private void InitializeComponent()
	{
		...
		((SingleInstrumentBase)DigitalReadoutInstrument10).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value12");
		...
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add(start, 0, 7);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)DigitalReadoutInstrument20a, 1, 0);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add(stop, 1, 7);
		((TableLayoutPanel)(object)tableLayoutPanel1).Controls.Add((Control)(object)DigitalReadoutInstrument10, 1, 6);
		...
		((SingleInstrumentBase)DigitalReadoutInstrument23a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value0");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument20a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value8");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument17a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value6");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument7).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value5");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument53a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value7");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument4).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value2");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument14a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value5");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument1).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value8");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument2a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value4");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument43).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value1");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument11a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_3V_Request_Results_Sensor_Value4");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument5a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value9");
		...
		((SingleInstrumentBase)DigitalReadoutInstrument8a).Instrument = new Qualifier((QualifierTypes)1, "MCM02T", "RT_SR001_Sensor_Voltage_5V_Request_Results_Sensor_Value10");
